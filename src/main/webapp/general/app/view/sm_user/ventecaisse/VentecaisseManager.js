...
var url_services_data_balance = '../webservices/sm_user/balance/ws_data.jsp';
//var url_services_data_balancevente_generate_pdf = '../webservices/sm_user/balance/ws_report_pdf.jsp';
var url_services_data_balancevente_generate_pdf = '../webservices/sm_user/balance/ws_generate_pdf.jsp';
...
Ext.define('testextjs.view.sm_user.ventecaisse.VentecaisseManager', {
    ...
    initComponent: function () {
        ...
        var store = new Ext.data.Store({
            ...
            proxy: {
                type: 'ajax',
                url: '../webservices/sm_user/balance/ws_datas.jsp',
                reader: {
                    type: 'json',
                    root: 'data',
                    totalProperty: 'total'
