var url_services_data_facturesubrogatoire_other = '../webservices/sm_user/journalvente/ws_facture_subrogatoire_other.jsp';
var url_services_data_facturesubrogatoire_other_generate_pdf = '../webservices/sm_user/journalvente/ws_generate_facture_subrogatoire_other_pdf.jsp';
...
//    tools: [{type: "pin"}],
    ...
    initComponent: function() {
        ...
        var store = new Ext.data.Store({
            ...
            proxy: {
                type: 'ajax',
                url: url_services_data_facturesubrogatoire_other,
                reader: {
                    type: 'json',
                    root: 'results',
                    totalProperty: 'total'
                    ...
                    listeners: {
                        'change': function(me) {
                            ...
                            /*  dt_Date_Debut = me.getSubmitValue();
                             Ext.getCmp('OGrid').getStore().getProxy().url = url_services_data_facturesubrogatoire_other + "?&dt_Date_Debut=" + dt_Date_Debut;
                             */
                        }
                    }
                }, {
                    ...
                    listeners: {
                        'change': function(me) {
                            /*  dt_Date_Fin = me.getSubmitValue();
                             Ext.getCmp('OGrid').getStore().getProxy().url = url_services_data_facturesubrogatoire_other + "?&dt_Date_Debut=" + dt_Date_Debut + "&dt_Date_Fin=" + dt_Date_Fin;
                             */
...
//                    hidden: true, //a retirer demain
     ...
     onDetailTransactionClick: function (grid, rowIndex) {
       ...
       // alert("rec:-----"+rec.get('lg_FAMILLE_ID'))
        new testextjs.view.sm_user.journalvente.action.detailProduct({
            ...
            titre: "Detail des produits de la vente [" + rec.get('int_CIP') + "]"
        });
    },
    onRechClick: function() {
        ...
        }, url_services_data_facturesubrogatoire_other);
    },
    onPdfListVenteClick: function() {
        ...
        var linkUrl = url_services_data_facturesubrogatoire_other_generate_pdf + '?dt_Date_Debut=' + Ext.getCmp('dt_debut_journal').getSubmitValue() + "&dt_Date_Fin=" + Ext.getCmp('dt_fin_journal').getSubmitValue() + "&search_value=" + search_value + "&lg_TIERS_PAYANT_ID="+ lg_TIERS_PAYANT_ID+ "&h_debut=" + Ext.getCmp('h_debut').getSubmitValue() + "&h_fin=" + Ext.getCmp('h_fin').getSubmitValue() +"&title=RELEVE DES VENTES A CREDIT";
