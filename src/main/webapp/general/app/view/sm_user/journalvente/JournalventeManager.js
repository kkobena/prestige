var url_services_data_journalvente = '../webservices/sm_user/journalvente/ws_data.jsp';
var url_services_pdf_journal_vente = '../webservices/sm_user/journalvente/ws_generate_pdf.jsp';
var url_services_transaction_detailsvente_ventecloturee = '../webservices/sm_user/detailsvente/ws_transaction.jsp?mode=';
var url_services_data_journalvente_generate_pdf = '../webservices/sm_user/journalvente/ws_generate_pdf.jsp';
...
Ext.define('testextjs.view.sm_user.journalvente.JournalventeManager', {
    extend: 'Ext.grid.Panel',
    xtype: 'journalventemanager',
    id: 'journalventemanagerID',
    frame: true,
//    collapsible: true,
    animCollapse: false,
...
//    iconCls: 'icon-grid',
    ...
    initComponent: function() {
        ...
        var store = new Ext.data.Store({
            ...
            proxy: {
                type: 'ajax',
                url: url_services_data_journalvente,
                reader: {
                    type: 'json',
                    root: 'results',
                    totalProperty: 'total'
            ...
            tbar: [
                {
                    ...
                    listeners: {
                        'change': function(me) {
                            ...
                            //   Ext.getCmp('Grid_Prevente_ID').getStore().getProxy().url = url_services_data_journalvente + "?dt_Date_Debut=" + dt_Date_Debut;
                    ...
                    listeners: {
                        'change': function(me) {
                            ...
                            // Ext.getCmp('Grid_Prevente_ID').getStore().getProxy().url = url_services_data_journalvente + "?dt_Date_Debut=" + dt_Date_Debut + "&dt_Date_Fin=" + dt_Date_Fin;
                    ...
                    listeners: {
                        select: function(cmp) {
                            /* str_TYPE_VENTE = cmp.getValue();
                             Ext.getCmp('Grid_Prevente_ID').getStore().getProxy().url = url_services_data_journalvente + "?dt_Date_Debut=" + dt_Date_Debut + "&dt_Date_Fin=" + dt_Date_Fin + "&h_debut=" + h_debut + "&h_fin=" + h_fin + "&str_TYPE_VENTE=" + str_TYPE_VENTE;
                             */ Me.onRechClick();
...
//                 alert(rec.get('VENTE_NET') +" "+ rec.get('int_PRICE_REMISE') +" " + rec.get('int_PRICE'));
    ...
    onPdfClick: function(grid, rowIndex) {
        ...
        var linkUrl = url_services_data_journalvente_generate_pdf + '?dt_Date_Debut=' + dt_Date_Debut_search_val + '&dt_Date_Fin=' + dt_Date_Fin_search_val + '&h_debut=' + h_debut_search_val + '&h_fin=' + h_fin_search_val;
    ...
    onPdfListVenteClick: function() {
         ...
         var search_value = Ext.getCmp('rechecher').getValue(), str_TYPE_TRANSACTION = "", h_debut = "", h_fin = "";
       ...
       var linkUrl = url_services_pdf_journal_vente + '?dt_Date_Debut=' + Ext.getCmp('dt_debut_journal').getSubmitValue() + "&dt_Date_Fin=" + Ext.getCmp('dt_fin_journal').getSubmitValue() + "&search_value=" + search_value + "&h_debut=" + h_debut + "&h_fin=" + h_fin +"&str_TYPE_VENTE=" + str_TYPE_TRANSACTION + "&title=JOURNAL DE VENTE";
    ...
    onRechClick: function() {
       ...
       if (new Date(Ext.getCmp('dt_debut_journal').getSubmitValue()) > new Date(Ext.getCmp('dt_fin_journal').getSubmitValue())) {
        ...
        }, url_services_data_journalvente);
    }
