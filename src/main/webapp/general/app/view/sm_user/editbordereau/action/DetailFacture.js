...
var url_services_data_detail_facture_tierr_payant;
...
Ext.define('testextjs.view.sm_user.editfacture.action.DetailFacture', {
    ...
    initComponent: function () {
        ...
        //alert(ref);
        url_services_data_detail_facture_tierr_payant = '../webservices/sm_user/facturation/ws_data_detail_facture.jsp?lg_FACTURE_ID=' + ref;
        var itemsPerPage = 20;
        var store = new Ext.data.Store({
            ...
            proxy: {
                type: 'ajax',
                url: url_services_data_detail_facture_tierr_payant,
                reader: {
                    type: 'json',
                    root: 'results',
                    totalProperty: 'total'
        ...
        this.on('edit', function (editor, e) {
            ...
            Ext.Ajax.request({
                url: url_services_data_detail_facture_tierr_payant + 'update',
                params: {
        ...
        Ext.MessageBox.confirm('Message',
                ...
                function (btn) {
                    if (btn == 'yes') {
                        ...
                        Ext.Ajax.request({
                            url: url_services_data_detail_facture_tierr_payant + 'delete',
                            params: {
    ...
    onRechClick: function () {
        ...
        }, url_services_data_detail_facture_tierr_payant);
    }
