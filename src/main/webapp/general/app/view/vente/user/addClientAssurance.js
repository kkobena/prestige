Ext.define('testextjs.view.vente.user.addClientAssurance', {
    ...
    initComponent: function () {
        ...
        // Dans la méthode initComponent, après me.callParent(arguments);
me.on('afterrender', function() {
    // Focus initial avec style
    var firstField = me.down('#strFIRSTNAME');
    firstField.focus(false, 100);
    firstField.addCls('highlighted-field');
    
    // Gestion des événements focus/blur pour tous les champs
    var fields = [
        'strFIRSTNAME', 'strLASTNAME', 'strNUMEROSECURITESOCIAL', 
        'tiersvo', 'intPOURCENTAGE', 'btnAddClientAssurance'
    ];
    ...
    fields.forEach(function(fieldId) {
        ...
        if (field) {
            field.on('focus', function() {
                this.addCls('highlighted-field');
                if (this.isXType('combobox')) {
                    this.getEl().down('.x-form-trigger').addCls('highlighted-trigger');
                }
            });
            
            field.on('blur', function() {
                this.removeCls('highlighted-field');
                if (this.isXType('combobox')) {
                    this.getEl().down('.x-form-trigger').removeCls('highlighted-trigger');
                }
            });
        }
    });
