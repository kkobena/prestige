...
Ext.define('testextjs.view.Dashboard.StatistiqRayons', {
    extend: 'Ext.tab.Panel',
    xtype: 'statistiqueRayons',
    frame: true,
    width: '97%',
    height: 600,
    minHeight: 670,
    ...
    initComponent: function () {
        ...
        var data = new Ext.data.Store({
            ...
            proxy: {
                type: 'ajax',
                url: '../api/v1/statfamillearticle/statisticrayons',
                reader: {
                    type: 'json',
                    root: 'data',
                    totalProperty: 'total',
        ...
        Ext.applyIf(me, {
            ...
            items: [
                {
                    xtype: 'gridpanel',
                    title: 'Chiffre d\'affaires par emplacement',
                    border: false,
                     autoScroll: true,
                    itemId: 'rayonStatGrid',
                    store: data,
                    viewConfig: {
                        forceFit: true,
                        columnLines: true
                ...
                },
                {
                    ...
                    animate: true,
                    border: false,
                    title: 'Graphe Statistique emplacement ',
