...
Ext.define('testextjs.view.tierspayantmanagement.balanceagee_detail.action.detailTransactionClient', {
    ...
    initComponent: function () {
        ...
        var store = new Ext.data.Store({
            ...
            proxy: {
                type: 'ajax',
                url: url_services_data_client_detailTransactionClient + "?lg_COMPTE_CLIENT_ID=" + lg_COMPTE_CLIENT_ID + "&lg_TIERS_PAYANT_ID=" + lg_TIERS_PAYANT_ID + "&datedebut=" + valdatedebutDetail + "&datefin=" + valdatefinDetail,
                reader: {
                    type: 'json',
                    root: 'results',
                    totalProperty: 'total'
