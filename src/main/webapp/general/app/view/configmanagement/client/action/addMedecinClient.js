...
Ext.define('testextjs.view.configmanagement.client.action.addMedecinClient', {
    extend: 'Ext.window.Window',
    xtype: 'addMedecinClient',
    id: 'addMedecinClientID',
    ...
    initComponent: function() {
     ...
     //  alert(this.getOdatasource().str_DESIGNATION);
       ...
       ref = this.getOdatasource().lg_CLIENT_ID;
        ...
        var form = new testextjs.view.configmanagement.client.action.addMedecinClientItem({
            odatasource: this.getOdatasource(),
            parentview: this,
            mode: "update",
            titre: "Attribution des medecins au client ["+this.getOdatasource().str_FIRST_LAST_NAME+"]"
            });
        this.callParent();
