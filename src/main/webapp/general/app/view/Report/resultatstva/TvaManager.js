...
Ext.define('testextjs.view.Report.resultatstva.TvaManager', {
    extend: 'Ext.panel.Panel',
    xtype: 'statistiqueTVA',
    id: 'BalanceAgeGeneraleID',
    requires: [
        'testextjs.view.Report.resultatstva.tvaGrid',
                    ...
                    listeners: {
                        click: function() {
                            ...
                            var dt_end_vente = Ext.getCmp('dt_end_tva').getSubmitValue();
                                ...
                                var linkUrl = "../webservices/Report/statistictva/ws_statistiqueTVA_pdf.jsp" + "?dt_start_vente=" + dt_start_vente + "&dt_end_vente=" + dt_end_vente;
                                window.open(linkUrl);
