...
var url_services_data_journaldesventes = '../webservices/Report/journaldesventes/ws_data.jsp';
var url_services_transaction_journaldesventes = '../webservices/Report/journaldesventes/ws_transaction.jsp?mode=';

var Me;
var Periode;
Ext.define('testextjs.view.Report.journaldesventes.journaldesventesmanager', {
    extend: 'Ext.grid.Panel',
    xtype: 'journaldesventesmanager',
    id: 'journaldesventesmanagerID',
    frame: true,
    collapsible: true,
    animCollapse: false,
    ...
    initComponent: function() {
        ...
        var store = new Ext.data.Store({
            model: 'testextjs.model.Journaldesventes',
            pageSize: itemsPerPage,
            autoLoad: false,
            proxy: {
                type: 'ajax',
                url: url_services_data_journaldesventes,
                reader: {
                    type: 'json',
                    root: 'results',
                    totalProperty: 'total'
    ...
    onRechClick: function() {
        ...
        }, url_services_transaction_journaldesventes);
    },
    onImprimeClick: function()
    {
        ...
        var linkUrl = url_services_data_pdf + '?lg_periode='+Periode+'&raport=rp_journal_vente';
