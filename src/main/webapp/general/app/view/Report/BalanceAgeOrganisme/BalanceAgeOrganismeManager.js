...
var url_services_data_BalanceAgeOrganisme = '../webservices/Report/BalanceAgeOrganisme/ws_data.jsp';
var url_services_transaction_BalanceAgeOrganisme = '../webservices/Report/BalanceAgeOrganisme/ws_transaction.jsp?mode=';

var Me;
var Periode;
Ext.define('testextjs.view.Report.BalanceAgeOrganisme.BalanceAgeOrganismeManager', {
    extend: 'Ext.grid.Panel',
    xtype: 'BalanceAgeOrganismeManager',
    id: 'BalanceAgeOrganismeID',
    frame: true,
    collapsible: true,
    animCollapse: false,
    title: 'Balance agée des dus (Recapitulatif par organisme)',
    plain: true,
    maximizable: true,
    tools: [{type: "pin"}],
    closable: true,
    ...
    initComponent: function() {
        ...
        var store = new Ext.data.Store({
            model: 'testextjs.model.BalanceAgeOrganisme',
            pageSize: itemsPerPage,
            autoLoad: false,
            proxy: {
                type: 'ajax',
                url: url_services_data_BalanceAgeOrganisme,
                reader: {
                    type: 'json',
                    root: 'results',
                    totalProperty: 'total'
        ...
        Ext.apply(this, {
            width: 950,
            height: 580,
            id: 'Grid_BalanceAgeOrganisme_ID',
    ...
    onRechClick: function() {
        ...
        }, url_services_transaction_BalanceAgeOrganisme);
    },
    onImprimeClick: function()
    {
        ...
        var linkUrl = url_services_data_pdf + '?lg_periode='+Periode+'&raport=rp_balance_agee_organisme';
