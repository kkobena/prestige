...
var url_services_data_BalanceVenteCaisse = '../webservices/Report/BalanceVenteCaisse/ws_data.jsp';
var url_services_transaction_BalanceVenteCaisse = '../webservices/Report/BalanceVenteCaisse/ws_transaction.jsp?mode=';
var dt_Date_Debut;
var dt_Date_Fin;
var h_debut;
var h_fin;
var Me;
var Periode;
Ext.define('testextjs.view.Report.BalanceVenteCaisse.BalanceVenteCaisseManager', {
    extend: 'Ext.grid.Panel',
    xtype: 'BalanceVenteCaisseManager',
    id: 'BalanceVenteCaisseID',
    frame: true,
    collapsible: true,
    animCollapse: false,
    ...
    initComponent: function() {
        ...
        var store = new Ext.data.Store({
            model: 'testextjs.model.BalanceVenteCaisse',
            pageSize: itemsPerPage,
            autoLoad: false,
            proxy: {
                type: 'ajax',
                url: url_services_data_BalanceVenteCaisse,
                reader: {
                    type: 'json',
                    root: 'results',
                    totalProperty: 'total'
    ...
    onRechClick: function() {
        ...
        }, url_services_transaction_BalanceVenteCaisse);
    },
    onImprimeClick: function()
    {
        ...
        var linkUrl = url_services_data_pdf + '?lg_periode='+Periode+'&raport=rp_balance_vente_caisse';
