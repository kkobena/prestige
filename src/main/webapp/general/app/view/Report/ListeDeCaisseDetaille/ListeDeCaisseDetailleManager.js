...
var url_services_data_ListeDeCaisseDetaille = '../webservices/Report/ListeDeCaisseDetaille/ws_data.jsp';
var url_services_transaction_ListeDeCaisseDetaille = '../webservices/Report/ListeDeCaisseDetaille/ws_transaction.jsp?mode=';

var Me;
var Periode;
Ext.define('testextjs.view.Report.ListeDeCaisseDetaille.ListeDeCaisseDetailleManager', {
    extend: 'Ext.grid.Panel',
    xtype: 'ListeDeCaisseDetailleManager',
    id: 'ListeDeCaisseDetailleID',
    frame: true,
    collapsible: true,
    animCollapse: false,
    title: 'Liste de caisse detaillée',
    plain: true,
    maximizable: true,
    tools: [{type: "pin"}],
    closable: true,
    ...
    initComponent: function() {
        ...
        var store = new Ext.data.Store({
            model: 'testextjs.model.ListeDeCaisseDetaille',
            pageSize: itemsPerPage,
            autoLoad: false,
            proxy: {
                type: 'ajax',
                url: url_services_data_ListeDeCaisseDetaille,
                reader: {
                    type: 'json',
                    root: 'results',
                    totalProperty: 'total'
        ...
        Ext.apply(this, {
            width: 950,
            height: 580,
            id: 'Grid_ListeDeCaisseDetaille_ID',
    ...
    onRechClick: function() {
        ...
        }, url_services_transaction_ListeDeCaisseDetaille);
    },
    onImprimeClick: function()
    {
        ...
        var linkUrl = url_services_data_pdf + '?lg_periode='+Periode+'&raport=rp_liste_caisse_detaillee';
