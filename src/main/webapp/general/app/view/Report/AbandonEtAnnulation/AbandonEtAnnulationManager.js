...
var url_services_data_AbandonEtAnnulation = '../webservices/Report/AbandonEtAnnulation/ws_data.jsp';
var url_services_transaction_AbandonEtAnnulation = '../webservices/Report/AbandonEtAnnulation/ws_transaction.jsp?mode=';

var Me;
var Periode;
Ext.define('testextjs.view.Report.AbandonEtAnnulation.AbandonEtAnnulationManager', {
    extend: 'Ext.grid.Panel',
    xtype: 'AbandonEtAnnulationManager',
    id: 'AbandonEtAnnulationManagerID',
    frame: true,
    collapsible: true,
    animCollapse: false,
    title: 'Liste des abandons et annulation de vente',
    plain: true,
    maximizable: true,
    tools: [{type: "pin"}],
    closable: true,
    ...
    initComponent: function() {
        ...
        var store = new Ext.data.Store({
            model: 'testextjs.model.AbandonEtAnnulation',
            pageSize: itemsPerPage,
            autoLoad: false,
            proxy: {
                type: 'ajax',
                url: url_services_data_AbandonEtAnnulation,
                reader: {
                    type: 'json',
                    root: 'results',
                    totalProperty: 'total'
        ...
        Ext.apply(this, {
            width: 950,
            height: 580,
            id: 'Grid_AbandonEtAnnulation_ID',
    ...
    onRechClick: function() {
        ...
        }, url_services_transaction_AbandonEtAnnulation);
    },
    onImprimeClick: function()
    {
        ...
        var linkUrl = url_services_data_pdf + '?lg_periode='+Periode+'&raport=rp_list_abandonAnnulation';
