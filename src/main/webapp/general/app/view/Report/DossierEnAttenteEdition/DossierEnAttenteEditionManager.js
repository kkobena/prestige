...
var url_services_data_DossierEnAttenteEdition = '../webservices/Report/DossierEnAttenteEdition/ws_data.jsp';
var url_services_transaction_DossierEnAttenteEdition = '../webservices/Report/DossierEnAttenteEdition/ws_transaction.jsp?mode=';

var Me;
var Periode;
Ext.define('testextjs.view.Report.DossierEnAttenteEdition.DossierEnAttenteEditionManager', {
    extend: 'Ext.grid.Panel',
    xtype: 'DossierEnAttenteEditionManager',
    id: 'DossierEnAttenteEditionManagerID',
    frame: true,
    collapsible: true,
    animCollapse: false,
    title: 'Liste des dossiers en attente d edition',
    plain: true,
    maximizable: true,
    tools: [{type: "pin"}],
    closable: true,
    ...
    initComponent: function() {
        ...
        var store = new Ext.data.Store({
            model: 'testextjs.model.DossierEnAttenteEdition',
            pageSize: itemsPerPage,
            autoLoad: false,
            proxy: {
                type: 'ajax',
                url: url_services_data_DossierEnAttenteEdition,
                reader: {
                    type: 'json',
                    root: 'results',
                    totalProperty: 'total'
        ...
        Ext.apply(this, {
            width: 950,
            height: 580,
            id: 'Grid_DossierEnAttenteEdition_ID',
    ...
    onRechClick: function() {
        ...
        }, url_services_transaction_DossierEnAttenteEdition);
    },
    onImprimeClick: function()
    {
        ...
        var linkUrl = url_services_data_pdf + '?lg_periode='+Periode+'&raport=rp_dossier_attente_edition';
