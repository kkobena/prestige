...
Ext.define('testextjs.view.Report.AchatsFournisseurs.AchatFournisseursGrid', {
    extend: 'Ext.grid.Panel',
    alias: 'widget.achatfour-grid',
    initComponent: function () {
        var store = Ext.create('testextjs.store.Statistics.AchatFournisseurs');
