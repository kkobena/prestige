...
Ext.define('testextjs.view.Report.Retrocessions.RetrocessionsGrid', {
    extend: 'Ext.grid.Panel',
    alias: 'widget.retrocessions-grid',
    initComponent: function () {
        var store = Ext.create('testextjs.store.Statistics.Retrocessions');
                    ...
                    items: [
                        {
                            ...
                            handler: function (grid, rowIndex, colIndex) {
                                ...
                                var win = Ext.create("Ext.window.Window", {
                                    title: "Graphe des soldes de r&eacute;trocessions de : [" + rec.get('LIBELLE') + "]",
                                    modal: true,
                                    width: '80%',
                                    height: 550,
                                    maximizable: true,
                                            ...
                                            series: [{
                                                    ...
                                                    tips: {
                                                        ...
                                                        renderer: function (storeItem, item) {
                                                            this.setTitle("Soldes  du " + storeItem.get('MOIS') + " est de : " + amountformat(storeItem.get('MONTANT'))+" F");
