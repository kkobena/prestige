...
var url_services_data_listeDiffereClient = '../webservices/Report/listeDiffereClient/ws_data.jsp';
var url_services_transaction_listeDiffereClient = '../webservices/Report/listeDiffereClient/ws_transaction.jsp?mode=';

var Me;
var Periode;
Ext.define('testextjs.view.Report.listeDiffereClient.listeDiffereClientManager', {
    extend: 'Ext.grid.Panel',
    xtype: 'listeDiffereClientManager',
    id: 'listeDiffereClientManagerID',
    frame: true,
    collapsible: true,
    animCollapse: false,
    title: 'Liste des differes clients',
    plain: true,
    maximizable: true,
    tools: [{type: "pin"}],
    closable: true,
    ...
    initComponent: function() {
        ...
        var store = new Ext.data.Store({
            model: 'testextjs.model.ListeDiffereClient',
            pageSize: itemsPerPage,
            autoLoad: false,
            proxy: {
                type: 'ajax',
                url: url_services_data_listeDiffereClient,
                reader: {
                    type: 'json',
                    root: 'results',
                    totalProperty: 'total'
    ...
    onRechClick: function() {
        ...
        }, url_services_transaction_listeDiffereClient);
    },
    onImprimeClick: function()
    {
        ...
        var linkUrl = url_services_data_pdf + '?lg_periode='+Periode+'&raport=rp_lst_ddiffere_client';
