...
"_"+location.pathname,JSON.stringify(b))}catch(c){}},fnStateSaveParams:null,iStateDuration:7200,iDeferLoading:null,iDisplayLength:10,iDisplayStart:0,iTabIndex:0,oClasses:{},oLanguage:{oAria:{sSortAscending:": activate to sort column ascending",sSortDescending:": activate to sort column descending"},oPaginate:{sFirst:"Premi&egrave;re",sLast:"Derni&egrave;",sNext:"Suivante",sPrevious:"Pr&eacute;c&eacute;dente"},sEmptyTable:"Pas de donn&eacute;es",sInfo:"Showing _START_ to _END_ of _TOTAL_ entries",sInfoEmpty:"Affichage 0 à 0 de 0 entr&eacute;es",
