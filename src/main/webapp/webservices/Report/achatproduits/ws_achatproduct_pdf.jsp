...
<html>
    ...
    <%
        ...
        String scr_report_file = "rp_statisticachatproduit_";
        String report_generate_file = key.GetNumberRandom();
        report_generate_file = report_generate_file + ".pdf";
        OreportManager.setPath_report_src(Ojdom.scr_report_file + scr_report_file + ".jrxml");
        OreportManager.setPath_report_pdf(Ojdom.scr_report_pdf + "rp_statisticachatproduit_" + report_generate_file);
        ...
        parameters.put("P_H_CLT_INFOS", "Evolution mensuelle des achats \n selon l’année et le produit " + P_PERIODE);
        ...
        response.sendRedirect("../../../data/reports/pdf/" + "rp_statisticachatproduit_" + report_generate_file);
