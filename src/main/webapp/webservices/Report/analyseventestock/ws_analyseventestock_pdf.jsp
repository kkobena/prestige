...
<html>
    ...
    <%
        ...
        String scr_report_file = "rp_statistic_vente_stock_";
        String report_generate_file = key.GetNumberRandom();
        report_generate_file = report_generate_file + ".pdf";
        OreportManager.setPath_report_src(Ojdom.scr_report_file + scr_report_file + ".jrxml");
        OreportManager.setPath_report_pdf(Ojdom.scr_report_pdf + "rp_statistic_vente_stock_" + report_generate_file);
        ...
        if (!"".equals(dt_end) && !dt_end.equals(dt_start)) {
            P_PERIODE = " \nDU " + periode + " AU " + date.formatterShort.format(java.sql.Date.valueOf(dt_end));
        }

        parameters.put("P_DATE_END", dt_end);

        parameters.put("P_DATE_START", dt_start);
        parameters.put("P_H_CLT_INFOS", "Analyse Vente/Stock d'une famille" + P_PERIODE);
        ...
        response.sendRedirect("../../../data/reports/pdf/" + "rp_statistic_vente_stock_" + report_generate_file);
