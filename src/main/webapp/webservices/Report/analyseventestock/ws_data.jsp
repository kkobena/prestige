...
<%    if (request.getParameter("dt_start_vente") != null && !"".equals(request.getParameter("dt_start_vente"))) {
    ...
    lstdetails = familleArticle.getAnalyseVenteStockData(dt_start, dt_end, search_value);
...
<%    JSONArray arrayObj = new JSONArray();
    ...
    for (int i = pgInt; i < pgInt_Last; i++) {
        ...
        json.put("id", i);
        json.put("str_FAmille", lstdetails.get(i).getStr_value1());
        json.put("str_CODE_FAMILLE", lstdetails.get(i).getStr_value2());
        json.put("QTE VENDUE", lstdetails.get(i).getStr_value4());
        json.put("NBRE SORTIE", lstdetails.get(i).getStr_value5());
        json.put("int_SEUIL_ACTUEL", lstdetails.get(i).getStr_value8());
        json.put("int_SEUIL_REAPP", lstdetails.get(i).getStr_value7());
        json.put("UNITE MOY VENTE", Math.round(Double.valueOf(lstdetails.get(i).getStr_value6())) );
        json.put("int_QTE_REAPP", lstdetails.get(i).getStr_value9().equals("null")?"0":lstdetails.get(i).getStr_value9());
        json.put("NB VENTES VNO", lstdetails.get(i).getStr_value13()); 
        json.put("MONTANT VENTES", lstdetails.get(i).getStr_value3());
        json.put("NB VENTES VO", lstdetails.get(i).getStr_value11());
        json.put("Pourcentage", Math.round(Double.valueOf(lstdetails.get(i).getStr_value12())));
        json.put("QTY", lstdetails.get(i).getStr_value10());
