...
<html>
    ...
    <%
        ...
        String scr_report_file = "rp_statisticventeavoirclient_";
        String report_generate_file = key.GetNumberRandom();
        report_generate_file = report_generate_file + ".pdf";
        OreportManager.setPath_report_src(Ojdom.scr_report_file + scr_report_file + ".jrxml");
        OreportManager.setPath_report_pdf(Ojdom.scr_report_pdf + "rp_statisticventeavoirclient_" + report_generate_file);
        ...
        response.sendRedirect("../../../data/reports/pdf/" + "rp_statisticventeavoirclient_" + report_generate_file);
