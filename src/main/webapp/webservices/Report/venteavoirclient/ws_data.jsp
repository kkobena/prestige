...
int    start = Integer.valueOf(request.getParameter("start")); 
     ...
     long count=familleArticle.getVenteClientCount(dt_start, dt_end, search_value); 
    lstdetails = familleArticle.getVenteAvoirClientData(dt_start, dt_end, search_value,start, limit);
