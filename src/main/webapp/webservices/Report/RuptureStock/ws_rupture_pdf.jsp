...
<html>
    ...
    <%
        ...
        String dt_end = dt_start, search_value = "%%";
        ...
        String scr_report_file = "rp_rupture_stoc_";
        String report_generate_file = key.GetNumberRandom();
        report_generate_file = report_generate_file + ".pdf";
        OreportManager.setPath_report_src(Ojdom.scr_report_file + scr_report_file + ".jrxml");
        OreportManager.setPath_report_pdf(Ojdom.scr_report_pdf + "rp_rupture_stoc_" + report_generate_file);
        ...
        parameters.put("P_H_CLT_INFOS", "Statistiques sur \nLes Ruptures de Stock \n" + P_PERIODE);
        ...
        parameters.put("P_TOTALSTRING",  "TOTAL des Ruptures  "+P_PERIODE);
        ...
        response.sendRedirect("../../../data/reports/pdf/" + "rp_rupture_stoc_" + report_generate_file);
