...
<html>
    ...
    <%
        ...
        String scr_report_file = "rp_analyse_frequentationbis";
        ...
        OreportManager.setPath_report_pdf(Ojdom.scr_report_pdf + "rp_analyse_frequentation" + report_generate_file);
        ...
        if (!"".equals(dt_end) && !dt_end.equals(dt_start)) {
             P_PERIODE=  periode + " AU " + date.formatterShort.format(java.sql.Date.valueOf(dt_end));
            parameters.put("P_DATE_END", dt_end+" 23:59:59");
        }
        
        parameters.put("P_DATE_END", dt_end);
         parameters.put("P_DATE_START", dt_start);
          parameters.put("P_H_CLT_INFOS", "Analyse de la fréquentation\n par plage horaire \n "+P_PERIODE);
        ...
        response.sendRedirect("../../../data/reports/pdf/" + "rp_analyse_frequentation" + report_generate_file);
