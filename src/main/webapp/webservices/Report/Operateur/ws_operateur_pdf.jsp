...
<html>
   ...
   if (request.getParameter("search_value") != null && !"".equals(request.getParameter("search_value"))) {
        ...
        //String scr_report_file = "rp_activte_operateur_chart";
        ...
        OreportManager.setPath_report_pdf(Ojdom.scr_report_pdf + "rp_activte_operateur_" + report_generate_file);
...
// parameters.put("P_TOTAL_DEVIS", conversion.GetNumberTowords(Double.parseDouble(total_devis + "")) + " -- (" + conversion.AmountFormat(total_devis) +")");
        ...
        if (!"".equals(dt_end) && !dt_end.equals(dt_start)) {
         ...
         parameters.put("P_DATE_START", dt_start);
          parameters.put("P_H_CLT_INFOS", "Statistiques d'Activité\n par Opérateur\n"+P_PERIODE);
        ...
        response.sendRedirect("../../../data/reports/pdf/" + "rp_activte_operateur_" + report_generate_file);
