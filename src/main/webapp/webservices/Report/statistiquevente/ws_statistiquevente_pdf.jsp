...
// parameters.put("P_TOTAL_DEVIS", conversion.GetNumberTowords(Double.parseDouble(total_devis + "")) + " -- (" + conversion.AmountFormat(total_devis) +")");
 ...
 /*decem*/
    ...
    if (begin.getYear() == end.getYear()) {
        ...
        String janv = "", fev = "", mars = "", avri = "", mai = "", juin = "", juil = "", aout = "", sept = "", oct = "", nov = "", dec = "";
        String janv_ = "", fev_ = "", mars_ = "", avri_ = "", mai_ = "", juin_ = "", juil_ = "", aout_ = "", sept_ = "", oct_ = "", nov_ = "", dec_ = "";
        DateTimeFormatter formatter = DateTimeFormatter.ofPattern("MM/YYYY");
        Period p = Period.between(begin, end);
        for (int i = 0; i < p.getMonths(); i++) {
            janv = begin.plusMonths(i).getMonthValue() + "";
            System.out.println("*******************  " + janv + "  -------------   " + i);
            switch (i) {
                case 0:
                    janv = begin.plusMonths(i).getMonthValue() + "";
                    janv_ = begin.plusMonths(i).format(formatter);
                    break;
                case 1:
                    fev = begin.plusMonths(i).getMonthValue() + "";
                    fev_ = begin.plusMonths(i).format(formatter);
                    break;
                case 2:
                    mars = begin.plusMonths(i).getMonthValue() + "";
                    mars_ = begin.plusMonths(i).format(formatter);
                    break;
                case 3:
                    avri = begin.plusMonths(i).getMonthValue() + "";
                    avri_ = begin.plusMonths(i).format(formatter);
                    break;
                case 4:
                    mai = begin.plusMonths(i).getMonthValue() + "";
                    mai_ = begin.plusMonths(i).format(formatter);
                    break;
                case 5:
                    juin = begin.plusMonths(i).getMonthValue() + "";
                    juin_ = begin.plusMonths(i).format(formatter);
                    break;
                case 6:
                    juil = begin.plusMonths(i).getMonthValue() + "";
                    juil_ = begin.plusMonths(i).format(formatter);
                    break;
                case 7:
                    aout = begin.plusMonths(i).getMonthValue() + "";
                    aout_ = begin.plusMonths(i).format(formatter);
                    break;
                case 8:
                    sept = begin.plusMonths(i).getMonthValue() + "";
                    sept_ = begin.plusMonths(i).format(formatter);
                    break;
                case 9:
                    oct = begin.plusMonths(i).getMonthValue() + "";
                    oct_ = begin.plusMonths(i).format(formatter);
                    break;
                case 10:
                    nov = begin.plusMonths(i).getMonthValue() + "";
                    nov_ = begin.plusMonths(i).format(formatter);
                    break;
                case 11:
                    dec = begin.plusMonths(i).getMonthValue() + "";
                    dec_ = begin.plusMonths(i).format(formatter);
                    break;
            }
        }

        Period p2 = Period.between(end, LocalDate.of(end.getYear(), Month.DECEMBER, 31));

        switch ((12 - p.getMonths())) {
            case 2:
                for (int i = 0; i < (12 - p.getMonths()); i++) {
                    switch (i) {
                        case 0:
                            nov = end.plusMonths(i).getMonthValue() + "";
                            nov_ = end.plusMonths(i).format(formatter);
                            break;
                        case 1:
                            dec = end.plusMonths(i).getMonthValue() + "";
                            dec_ = end.plusMonths(i).format(formatter);
                            break;
                    }
            ...
            case 3:
                for (int i = 0; i < (12 - p.getMonths()); i++) {
                    switch (i) {
                        case 0:
                            oct = end.plusMonths(i).getMonthValue() + "";
                            oct_ = end.plusMonths(i).format(formatter);
                            break;
                        case 1:
                            nov = end.plusMonths(i).getMonthValue() + "";
                            nov_ = end.plusMonths(i).format(formatter);
            ...
            case 4:
                for (int i = 0; i < (12 - p.getMonths()); i++) {
                    switch (i) {
                        case 0:
                            sept = end.plusMonths(i).getMonthValue() + "";
                            sept_ = end.plusMonths(i).format(formatter);
                            break;
                        case 1:
                            oct = end.plusMonths(i).getMonthValue() + "";
                            oct_ = end.plusMonths(i).format(formatter);
            ...
            case 5:
                for (int i = 0; i < (12 - p.getMonths()); i++) {
                    switch (i) {
                        case 0:
                            aout = end.plusMonths(i).getMonthValue() + "";
                            aout_ = end.plusMonths(i).format(formatter);
                            break;
                        case 1:
                            sept = end.plusMonths(i).getMonthValue() + "";
                            sept_ = end.plusMonths(i).format(formatter);
            ...
            case 6:
                for (int i = 0; i < (12 - p.getMonths()); i++) {
                    switch (i) {
                        case 0:
                            juil = end.plusMonths(i).getMonthValue() + "";
                            juil_ = end.plusMonths(i).format(formatter);
                            break;
                        case 1:
                            aout = end.plusMonths(i).getMonthValue() + "";
                            aout_ = end.plusMonths(i).format(formatter);
            ...
            case 7:
                for (int i = 0; i < (12 - p.getMonths()); i++) {
                    switch (i) {
                        case 0:
                            juin = end.plusMonths(i).getMonthValue() + "";
                            juin_ = end.plusMonths(i).format(formatter);
                            break;
                        case 1:
                            juil = end.plusMonths(i).getMonthValue() + "";
                            juil_ = end.plusMonths(i).format(formatter);
            ...
            case 8:
                for (int i = 0; i < (12 - p.getMonths()); i++) {
                    switch (i) {
                        case 0:
                            mai = end.plusMonths(i).getMonthValue() + "";
                            mai_ = end.plusMonths(i).format(formatter);
                            break;
                        case 1:
                            juin = end.plusMonths(i).getMonthValue() + "";
                            juin_ = end.plusMonths(i).format(formatter);
            ...
            case 9:
                for (int i = 0; i < (12 - p.getMonths()); i++) {
                    switch (i) {
                        case 0:
                            avri = end.plusMonths(i).getMonthValue() + "";
                            avri_ = end.plusMonths(i).format(formatter);
                            break;
                        case 1:
                            mai = end.plusMonths(i).getMonthValue() + "";
                            mai_ = end.plusMonths(i).format(formatter);
            ...
            case 10:
                for (int i = 0; i < (12 - p.getMonths()); i++) {
                    switch (i) {
                        case 0:
                            mars = end.plusMonths(i).getMonthValue() + "";
                            mars_ = end.plusMonths(i).format(formatter);
                            break;
                        case 1:
                            avri = end.plusMonths(i).getMonthValue() + "";
                            avri_ = end.plusMonths(i).format(formatter);
            ...
            case 11:
                for (int i = 0; i < (12 - p.getMonths()); i++) {
                    switch (i) {
                        case 0:
                            fev = end.plusMonths(i).getMonthValue() + "";
                            fev_ = end.plusMonths(i).format(formatter);
                            break;
                        case 1:
                            mars = end.plusMonths(i).getMonthValue() + "";
                            mars_ = end.plusMonths(i).format(formatter);
        ...
        /*  for (int i = 0; i < (12 - p.getMonths()); i++) {
            switch (i) {
                case 0:
                    ...
                    System.out.println("juil_juil_juil_  ****    " + juil_);
                    break;
                case 1:
                    switch ((12 - p.getMonths())) {
                        case 2:
        ...
        for (TPreenregistrement OPreenregistrement : list) {
            ...
            if (!"".equals(janv) && (Integer.valueOf(janv) >= Integer.valueOf(date.FORMATTERMOUNTH.format(OPreenregistrement.getDtCREATED())))) {
                count_1_cumul++;
                brut_1_cumul += OPreenregistrement.getIntPRICE();
                remise_1_cumul += OPreenregistrement.getIntPRICEREMISE();
                if (Parameter.KEY_VENTE_NON_ORDONNANCEE.equals(OPreenregistrement.getStrTYPEVENTE())) {
            ...
            if (!"".equals(fev) && (Integer.valueOf(fev) >= Integer.valueOf(date.FORMATTERMOUNTH.format(OPreenregistrement.getDtCREATED())))) {
                count_2_cumul++;
                brut_2_cumul += OPreenregistrement.getIntPRICE();
                remise_2_cumul += OPreenregistrement.getIntPRICEREMISE();
                if (Parameter.KEY_VENTE_NON_ORDONNANCEE.equals(OPreenregistrement.getStrTYPEVENTE())) {
            ...
            if (!"".equals(mars) && (Integer.valueOf(mars) >= Integer.valueOf(date.FORMATTERMOUNTH.format(OPreenregistrement.getDtCREATED())))) {
                count_3_cumul++;
                brut_3_cumul += OPreenregistrement.getIntPRICE();
                remise_3_cumul += OPreenregistrement.getIntPRICEREMISE();
                if (Parameter.KEY_VENTE_NON_ORDONNANCEE.equals(OPreenregistrement.getStrTYPEVENTE())) {
            ...
            if (!"".equals(avri) && (Integer.valueOf(avri) >= Integer.valueOf(date.FORMATTERMOUNTH.format(OPreenregistrement.getDtCREATED())))) {
                count_4_cumul++;
                brut_4_cumul += OPreenregistrement.getIntPRICE();
                remise_4_cumul += OPreenregistrement.getIntPRICEREMISE();
                if (Parameter.KEY_VENTE_NON_ORDONNANCEE.equals(OPreenregistrement.getStrTYPEVENTE())) {
            ...
            if (!"".equals(mai) && (Integer.valueOf(mai) >= Integer.valueOf(date.FORMATTERMOUNTH.format(OPreenregistrement.getDtCREATED())))) {
                count_5_cumul++;
                brut_5_cumul += OPreenregistrement.getIntPRICE();
                remise_5_cumul += OPreenregistrement.getIntPRICEREMISE();
                if (Parameter.KEY_VENTE_NON_ORDONNANCEE.equals(OPreenregistrement.getStrTYPEVENTE())) {
            ...
            if (!"".equals(dec) && (Integer.valueOf(dec) >= Integer.valueOf(date.FORMATTERMOUNTH.format(OPreenregistrement.getDtCREATED())))) {
                count_12_cumul++;
                brut_12_cumul += OPreenregistrement.getIntPRICE();
                remise_12_cumul += OPreenregistrement.getIntPRICEREMISE();
                if (Parameter.KEY_VENTE_NON_ORDONNANCEE.equals(OPreenregistrement.getStrTYPEVENTE())) {
            ...
            if (!"".equals(nov) && (Integer.valueOf(nov) >= Integer.valueOf(date.FORMATTERMOUNTH.format(OPreenregistrement.getDtCREATED())))) {
                count_11_cumul++;
                brut_11_cumul += OPreenregistrement.getIntPRICE();
                remise_11_cumul += OPreenregistrement.getIntPRICEREMISE();
                if (Parameter.KEY_VENTE_NON_ORDONNANCEE.equals(OPreenregistrement.getStrTYPEVENTE())) {
            ...
            if (!"".equals(oct) && (Integer.valueOf(oct) >= Integer.valueOf(date.FORMATTERMOUNTH.format(OPreenregistrement.getDtCREATED())))) {
                count_10_cumul++;
                brut_10_cumul += OPreenregistrement.getIntPRICE();
                remise_10_cumul += OPreenregistrement.getIntPRICEREMISE();
                if (Parameter.KEY_VENTE_NON_ORDONNANCEE.equals(OPreenregistrement.getStrTYPEVENTE())) {
            ...
            if (!"".equals(juin) && (Integer.valueOf(juin) >= Integer.valueOf(date.FORMATTERMOUNTH.format(OPreenregistrement.getDtCREATED())))) {
                count_6_cumul++;
                brut_6_cumul += OPreenregistrement.getIntPRICE();
                remise_6_cumul += OPreenregistrement.getIntPRICEREMISE();
                if (Parameter.KEY_VENTE_NON_ORDONNANCEE.equals(OPreenregistrement.getStrTYPEVENTE())) {
            ...
            if (!"".equals(juil) && (Integer.valueOf(juil) >= Integer.valueOf(date.FORMATTERMOUNTH.format(OPreenregistrement.getDtCREATED())))) {
                count_7_cumul++;
                brut_7_cumul += OPreenregistrement.getIntPRICE();
                remise_7_cumul += OPreenregistrement.getIntPRICEREMISE();
                if (Parameter.KEY_VENTE_NON_ORDONNANCEE.equals(OPreenregistrement.getStrTYPEVENTE())) {
            ...
            if (!"".equals(aout) && (Integer.valueOf(aout) >= Integer.valueOf(date.FORMATTERMOUNTH.format(OPreenregistrement.getDtCREATED())))) {
                count_8_cumul++;
                brut_8_cumul += OPreenregistrement.getIntPRICE();
                remise_8_cumul += OPreenregistrement.getIntPRICEREMISE();
                if (Parameter.KEY_VENTE_NON_ORDONNANCEE.equals(OPreenregistrement.getStrTYPEVENTE())) {
            ...
            if (!"".equals(sept) && (Integer.valueOf(sept) >= Integer.valueOf(date.FORMATTERMOUNTH.format(OPreenregistrement.getDtCREATED())))) {
                count_9_cumul++;
                brut_9_cumul += OPreenregistrement.getIntPRICE();
                remise_9_cumul += OPreenregistrement.getIntPRICEREMISE();
                if (Parameter.KEY_VENTE_NON_ORDONNANCEE.equals(OPreenregistrement.getStrTYPEVENTE())) {
        ...
        parameters.put("P_MONTH_12", dec_);
        parameters.put("P_MONTH_11", nov_);
        parameters.put("P_MONTH_10", oct_);
        parameters.put("P_MONTH_9", sept_);
        parameters.put("P_MONTH_8", aout_);
        parameters.put("P_MONTH_7", juil_);
        parameters.put("P_MONTH_6", juin_);
        parameters.put("P_MONTH_5", mai_);
        parameters.put("P_MONTH_4", avri_);
        parameters.put("P_MONTH_3", mars_);
        parameters.put("P_MONTH_2", fev_);
        parameters.put("P_MONTH_1", janv_);
        parameters.put("P_MONTH_1_NCLIENT", P_MONTH_1_NCLIENT);
        parameters.put("P_MONTH_1_NCLIENT_CUMUL", P_MONTH_1_NCLIENT_CUMUL);
        parameters.put("P_MONTH_1_BRUTTTC", P_MONTH_1_BRUTTTC);
        parameters.put("P_MONTH_1_BRUTTTC_CUMUL", P_MONTH_1_BRUTTTC_CUMUL);
