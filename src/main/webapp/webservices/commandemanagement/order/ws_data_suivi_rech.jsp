...
<%! Translate oTranslate = new Translate();
    ...
    String lg_ORDER_ID = "%%", str_REF_ORDER = "%%", lg_GROSSISTE_ID = "%%",search_value = "", str_STATUT = commonparameter.statut_is_Process;
    int int_LINE;
...
<%
    ...
    new logger().OCategory.info("dans webservices.commandemanagement.order.ws_data_suivi_rech");
%>
...
<%    TUser OTUser = (TUser) session.getAttribute(commonparameter.AIRTIME_USER);
    ...
    lstTOrder = OdataManager.getEm().createQuery("SELECT t FROM TOrder t WHERE (t.strSTATUT LIKE ?2 OR t.strSTATUT LIKE ?3 OR t.strSTATUT LIKE ?4) ORDER BY t.dtCREATED DESC").
