...
<%! Translate oTranslate = new Translate();
    ...
    String lg_ORDER_ID = "%%", str_REF_ORDER = "%%", lg_GROSSISTE_ID = "%%", str_STATUT = commonparameter.statut_is_Process;
    int int_LINE;
...
<%
    ...
    new logger().OCategory.info("dans webservices.commandemanagement.order.ws_data_suivi_grossiste");
%>
...
<%    TUser OTUser = (TUser) session.getAttribute(commonparameter.AIRTIME_USER);
    ...
    OdataManager.initEntityManager();
    lstTOrder = OdataManager.getEm().createQuery("SELECT t FROM TOrder t WHERE t.lgGROSSISTEID.lgGROSSISTEID LIKE ?2 AND (t.strSTATUT LIKE ?3 OR t.strSTATUT LIKE ?4 OR t.strSTATUT LIKE ?5) ORDER BY t.dtCREATED DESC").
