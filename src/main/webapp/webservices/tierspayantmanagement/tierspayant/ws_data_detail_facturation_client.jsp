...
<%
    ...
    try {
        ...
        lstTPreenregistrementCompteClientTiersPayent = OPreenregistrement.listTPreenregistrementTiersPayent(search_value, dt_DEBUT, dt_FIN, lg_USER_ID, lg_PREENREGISTREMENT_ID, lg_EMPLACEMENT_ID, lg_COMPTE_CLIENT_ID, lg_TIERS_PAYANT_ID,"");
    } catch (Exception e) {
...
<%    JSONArray arrayObj = new JSONArray();
    for (int i = pgInt; i < pgInt_Last; i++) {
        ...
        //  int_PRICE_TOTAL = int_PRICE_CLIENT + lstTPreenregistrementCompteClientTiersPayent.get(i).getIntPRICE();
        /*
      commente le 08/10/2016 a decommenter en cas de probleme
      json.put("int_PRICE_TOTAL", OPreenregistrement.GetVenteTotalwithRemise(lstTPreenregistrementCompteClientTiersPayent.get(i).getLgPREENREGISTREMENTID().getLgPREENREGISTREMENTID(), commonparameter.statut_is_Closed));
         */
...
// new logger().OCategory.info(lstTPreenregistrementCompteClientTiersPayent.get(i).getLgCOMPTECLIENTTIERSPAYANTID().getLgCOMPTECLIENTID().getLgCLIENTID().getStrFIRSTNAME() + " " + lstTPreenregistrementCompteClientTiersPayent.get(i).getLgCOMPTECLIENTTIERSPAYANTID().getLgCOMPTECLIENTID().getLgCLIENTID().getStrLASTNAME());
        /* json.put("str_FIRST_NAME", lstTPreenregistrementCompteClientTiersPayent.get(i).getLgCOMPTECLIENTTIERSPAYANTID().getLgCOMPTECLIENTID().getLgCLIENTID().getStrFIRSTNAME());
         json.put("str_LAST_NAME", lstTPreenregistrementCompteClientTiersPayent.get(i).getLgCOMPTECLIENTTIERSPAYANTID().getLgCOMPTECLIENTID().getLgCLIENTID().getStrLASTNAME());
         json.put("lg_CLIENT_ID", lstTPreenregistrementCompteClientTiersPayent.get(i).getLgCOMPTECLIENTTIERSPAYANTID().getLgCOMPTECLIENTID().getLgCLIENTID().getLgCLIENTID());
         json.put("lg_TIERS_PAYANT_ID", lstTPreenregistrementCompteClientTiersPayent.get(i).getLgCOMPTECLIENTTIERSPAYANTID().getLgTIERSPAYANTID().getLgTIERSPAYANTID());
         json.put("str_FULLNAME", lstTPreenregistrementCompteClientTiersPayent.get(i).getLgCOMPTECLIENTTIERSPAYANTID().getLgTIERSPAYANTID().getStrFULLNAME());
         json.put("dt_CREATED", date.DateToString(lstTPreenregistrementCompteClientTiersPayent.get(i).getDtCREATED(), date.formatterShort));
         json.put("dt_UPDATED", date.DateToString(lstTPreenregistrementCompteClientTiersPayent.get(i).getDtUPDATED(), date.formatterShort));
         */
        arrayObj.put(json);
