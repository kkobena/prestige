...
<%    String str_Date_Debut = "", str_Date_Fin = "", OdateDebut = "", lg_FAMILLE_ID = "%%", str_ACTION = "%%", OdateFin = "", 
    ...
    String scr_report_file = "rp_liste_article_prixmodifie";
    String report_generate_file = date.GetNumberRandom();

    report_generate_file = report_generate_file + ".pdf";
    OreportManager.setPath_report_src(Ojdom.scr_report_file + scr_report_file + ".jrxml");
    OreportManager.setPath_report_pdf(Ojdom.scr_report_pdf + "liste_article_prixmodifie_" + report_generate_file);
    ...
    String P_H_CLT_INFOS = "Mouchard de prix de vente du "+ date.DateToString(date.stringToDate(str_Date_Debut, date.formatterMysqlShort), date.formatterShort)+ " AU "+ date.DateToString(date.stringToDate(str_Date_Fin, date.formatterMysqlShort), date.formatterShort);
    ...
    /*PrinterManager OPrinterManager = new PrinterManager(OdataManager, OTUser);
     ...
     String str_final_file = Ojdom.scr_report_pdf + "liste_article_prixmodifie_" + report_generate_file;
    ...
    response.sendRedirect("../../../data/reports/pdf/" + "liste_article_prixmodifie_" + report_generate_file);
    /* String result;
