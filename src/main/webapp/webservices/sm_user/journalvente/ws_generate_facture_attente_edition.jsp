...
<%    Date today = new Date();
    String str_Date_Debut = date.DateToString(today, date.formatterMysqlShort), str_Date_Fin = date.DateToString(today, date.formatterMysqlShort), OdateDebut = "", lg_FAMILLE_ID = "%%", str_ACTION = "%%", OdateFin = "",
            h_debut = "00:00", h_fin = "23:59", search_value = "%%", title = "RELEVE DES DOSSIERS EN ATTENTE D'EDITION", lg_EMPLACEMENT_ID = "", lg_TIERS_PAYANT_ID = "%%";
    ...
    String scr_report_file = "rp_facture_attente_edition";
    String report_generate_file = date.GetNumberRandom();

    report_generate_file = report_generate_file + ".pdf";
    OreportManager.setPath_report_src(Ojdom.scr_report_file + scr_report_file + ".jrxml");
    OreportManager.setPath_report_pdf(Ojdom.scr_report_pdf + "facture_attente_edition_" + report_generate_file);
   ...
   String finalphonestring = oTOfficine.getStrPHONE() != null ? "Tel: " + conversion.PhoneNumberFormat("+225", oTOfficine.getStrPHONE()) : "";
    ...
    new logger().OCategory.info("str_Date_Debut:"+str_Date_Debut+"|str_Date_Fin:"+str_Date_Fin);
...
parameters.put("P_TIERS_PAYANT", lg_TIERS_PAYANT_ID);
    ...
    response.sendRedirect("../../../data/reports/pdf/" + "facture_attente_edition_" + report_generate_file);
