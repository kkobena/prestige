...
<html>
    ...
    <%
        ...
        String dt_end = date.formatterMysqlShort.format(new Date()), lg_CLIENT_ID = "%%";
        ...
        String scr_report_file = "rp_defferedpayment";
        String report_generate_file = key.GetNumberRandom();
        report_generate_file = report_generate_file + ".pdf";
        OreportManager.setPath_report_src(Ojdom.scr_report_file + scr_report_file + ".jrxml");
        OreportManager.setPath_report_pdf(Ojdom.scr_report_pdf + "rp_defferedpayment" + report_generate_file);
        ...
        parameters.put("P_H_CLT_INFOS", "RELEVE REGLEMENTS DIFFERES\n" + P_PERIODE);
        ...
        parameters.put("P_LG_EMPLACEMENT_ID", OTUser.getLgEMPLACEMENTID().getLgEMPLACEMENTID());
        ...
        parameters.put("P_SEARCH", lg_CLIENT_ID + "%");
        ...
        response.sendRedirect("../../../data/reports/pdf/" + "rp_defferedpayment" + report_generate_file);
