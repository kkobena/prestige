...
String lg_PREENREGISTREMENT_ID = "%%", lg_PREENREGISTREMENT_DETAIL_ID = "%%";
    ...
    new logger().OCategory.info("dans ws data details vente AVOIR");
    ...
    if (request.getParameter("str_STATUT") != null) {
     ...
     new logger().OCategory.info("lg_PREENREGISTREMENT_ID****" + lg_PREENREGISTREMENT_ID+"fin");
    
    lstTPreenregistrementDetail = OdataManager.getEm().createQuery("SELECT t FROM TPreenregistrementDetail t WHERE t.lgPREENREGISTREMENTID.lgPREENREGISTREMENTID LIKE ?1 AND t.lgFAMILLEID.strNAME LIKE ?2 AND t.strSTATUT LIKE ?3 AND t.intAVOIR > 0 ORDER BY t.dtCREATED DESC")
