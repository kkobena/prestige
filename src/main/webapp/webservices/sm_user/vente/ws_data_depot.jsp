...
<%
    ...
    JSONArray data = OPreenregistrement.listTPreenregistrementDepot(false, search_value, str_Date_Debut, str_Date_Fin, h_debut, h_fin, str_TYPE_VENTE, start, limit);

    total = OPreenregistrement.listPreenregistrementCountDepot(search_value, str_Date_Debut, str_Date_Fin, h_debut, h_fin, str_TYPE_VENTE);
