...
<%    Date today = new Date();
    String str_Date_Debut = date.DateToString(today, date.formatterMysqlShort), str_Date_Fin = date.DateToString(today, date.formatterMysqlShort), OdateDebut = "", lg_FAMILLE_ID = "%%", str_ACTION = "%%", OdateFin = "",
            h_debut = "00:00", h_fin = "23:59", search_value = "%%", title = "LISTE DES VENTES SANS NUMERO DE BONS",
            lg_EMPLACEMENT_ID = "", lg_TIERS_PAYANT_ID= "%%";
 ...
 String scr_report_file = "rp_liste_vente_withoutbon";
    String report_generate_file = date.GetNumberRandom();

    report_generate_file = report_generate_file + ".pdf";
    OreportManager.setPath_report_src(Ojdom.scr_report_file + scr_report_file + ".jrxml");
    OreportManager.setPath_report_pdf(Ojdom.scr_report_pdf + "liste_vente_withoutbon_" + report_generate_file);
    ...
    response.sendRedirect("../../../data/reports/pdf/" + "liste_vente_withoutbon_" + report_generate_file);
