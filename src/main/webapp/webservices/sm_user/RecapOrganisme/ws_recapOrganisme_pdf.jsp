...
<html>
    ...
    <%
        ...
        String dt_end = date.formatterMysqlShort.format(new Date()), search_value = "%%",lg_TIERS_PAYANT_ID="%%";
        ...
        String scr_report_file = "rp_recpareglement";
        String report_generate_file = key.GetNumberRandom();
        report_generate_file = report_generate_file + ".pdf";
        OreportManager.setPath_report_src(Ojdom.scr_report_file + scr_report_file + ".jrxml");
        OreportManager.setPath_report_pdf(Ojdom.scr_report_pdf + "rp_recpareglement" + report_generate_file);
        ...
        String P_PERIODE = "Période DU " + periode;
        ...
        parameters.put("P_H_CLT_INFOS", "Le récapitulatif par compte d’organisme " + P_PERIODE);
        ...
        parameters.put("P_lg_TIERS_PAYANT_ID", lg_TIERS_PAYANT_ID + "%");
       ...
       // parameters.put("P_H_PHONE", (oTOfficine.getStrPHONE() != null ? "Tel: " + conversion.PhoneNumberFormat("+225", oTOfficine.getStrPHONE()) : ""));
        ...
        response.sendRedirect("../../../data/reports/pdf/" + "rp_recpareglement" + report_generate_file);
