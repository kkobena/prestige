...
<html>
    ...
    <%
     ...
     System.out.println("*********************  "+search_value);
        ...
        String scr_report_file = "rp_gestioncaisse_";
        String report_generate_file = key.GetNumberRandom();
        report_generate_file = report_generate_file + ".pdf";
        OreportManager.setPath_report_src(Ojdom.scr_report_file + scr_report_file + ".jrxml");
        OreportManager.setPath_report_pdf(Ojdom.scr_report_pdf + "rp_gestioncaisse_" + report_generate_file);
        ...
        parameters.put("P_H_CLT_INFOS", "GESTION DES CAISSES \n " + P_PERIODE);
      ...
      String finalphonestring = oTOfficine.getStrPHONE() != null ? "Tel: " + conversion.PhoneNumberFormat("+225", oTOfficine.getStrPHONE()) : "";
        ...
        response.sendRedirect("../../../data/reports/pdf/" + "rp_gestioncaisse_" + report_generate_file);
