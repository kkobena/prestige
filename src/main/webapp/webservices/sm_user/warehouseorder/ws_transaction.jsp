...
<%!
    ...
    Date dt_BUTOIR_ARTICLE, dt_LIMITE_EXTRAPOLATION;
...
<%
    ...
    if (request.getParameter("dt_BUTOIR_ARTICLE") != null) {
        dt_BUTOIR_ARTICLE = date.stringToDate(request.getParameter("dt_BUTOIR_ARTICLE"));
    }
    if (request.getParameter("dt_LIMITE_EXTRAPOLATION") != null) {
        dt_LIMITE_EXTRAPOLATION = date.stringToDate(request.getParameter("dt_LIMITE_EXTRAPOLATION"));
    }
 ...
 TUser user = OdataManager.getEm().find(TUser.class, OTUser.getLgUSERID());
    ...
    if (request.getParameter("mode") != null) {
        ...
        if (request.getParameter("mode").toString().equals("create")) {
           ...
           // OTCodeGestion.setDtBUTOIRARTICLE(dt_BUTOIR_ARTICLE);
          //  OTCodeGestion.setDtLIMITEEXTRAPOLATION(dt_LIMITE_EXTRAPOLATION);
