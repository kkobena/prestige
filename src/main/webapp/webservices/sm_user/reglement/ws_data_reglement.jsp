...
<%
    ...
    new logger().OCategory.info("dans ws data detail facture tiers payant");
%>
...
<%    TUser OTUser = (TUser) session.getAttribute(commonparameter.AIRTIME_USER);
    ...
    for (int i = pgInt; i < pgInt_Last; i++) {
       ...
       // new logger().OCategory.info("iciiiiiiiiiiiiiii" + lstTFactureDetail.get(i).getStrREF());
      ...
      //  new logger().OCategory.info("154");
        ...
        json.put("str_NOM", OTPreenregistrementCompteClientTiersPayent.getLgCOMPTECLIENTTIERSPAYANTID().getLgCOMPTECLIENTID().getLgCLIENTID().getStrFIRSTNAME());
        ...
        json.put("dbl_MONTANT", OTPreenregistrementCompteClientTiersPayent.getIntPRICE());
