...
<%    new logger().OCategory.info("dans ws data liste des articles vendus groupé");
...
<%    json = OPreenregistrement.getArticlesVendusGroup(search_value, false, str_Date_Debut,
            str_Date_Fin, h_debut, h_fin,
            str_TYPE_TRANSACTION,
            int_NUMBER, start, limit, prixachatFiltre, stock, stockFiltre);
    total = OPreenregistrement.getArticlesVendusGroup(search_value,
            str_Date_Debut, str_Date_Fin,
            h_debut, h_fin,
            str_TYPE_TRANSACTION,
            int_NUMBER, prixachatFiltre, stock, stockFiltre);
