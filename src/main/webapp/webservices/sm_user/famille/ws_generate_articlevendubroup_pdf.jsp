...
<html>
 ...
 if (request.getParameter("prixachatFiltre") != null) {
    ...
    if (request.getParameter("stock") != null) {
        ...
        JSONObject arrayObj = p.getArticlesVendusGroup(search_value, true, str_Date_Debut,
                str_Date_Fin, h_debut, h_fin,
               str_TYPE_TRANSACTION,
                int_NUMBER, 0, 0,prixachatFiltre, stock, stockFiltre);
        //JSONObject data = new JSONObject();
       // data.put("root", arrayObj.getJSONArray("data"));
        JsonDataSourceApp app = new JsonDataSourceApp();
        DateFormat DATEFORMAT = new SimpleDateFormat("HH_mm_ss");
        String fileName = "rp_articlesvendusgroup_" + DATEFORMAT.format(new Date()) + ".pdf";
        app.fill(parameters, arrayObj, jdom.scr_report_file + "rp_articlesvendusgroup.jrxml", fileName);
