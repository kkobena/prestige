...
<%
    ...
    new logger().OCategory.info("dans ws data famille order");
%>
...
<%    String lg_BON_LIVRAISON_ID = "%%", search_value = "";
    ...
    lstTFamille = ObonLivraisonManagement.findFamilleBLDetail(lg_BON_LIVRAISON_ID);
...
<%    JSONArray arrayObj = new JSONArray();
    ...
    for (int i = pgInt; i < pgInt_Last; i++) {
        ...
        String lg_GROSSISTE_ID = lstTFamille.get(i).getLgGROSSISTEID().getLgGROSSISTEID();
