    ...
    if (request.getParameter("mode") != null) {
        ...
        if (request.getParameter("mode").equals("create") && !bCanCreateArticle) {
            ...
            if (OfamilleManagement.delete(lg_FAMILLE_ID)) {
                ...
                ObllBase.setDetailmessage("Impossible de supprimer un article qui a d�j� �t� utilis� dans le syst�me");
            }
