...
<%
   ...
   // }
    ...
    date key = new date();
        ...
        parameters.put("P_H_TITLE", "CODES GESTION");
    ...
    //OreportManager.BuildReport(parameters, Ojconnexion);
        ...
        scr_report_file = "rp_code_gestions";

        report_tittle = report_tittle + ".xlsx";
        OreportManager.setPath_report_src(Ojdom.scr_report_file  + scr_report_file + ".jrxml");
        //OreportManager.setPath_report_pdf(Ojdom.scr_report_pdf + report_tittle);
        OreportManager.setPath_report_pdf("D://PROJECTS//JAVA//LABOREX//laborex//web//data//reports//pdf//configmanagement//codegestion//" + report_tittle);
        OreportManager.BuildReportXLS(parameters);
...
<p>
<p>
    Repertoire de stockage: D:\PROJECTS\JAVA\LABOREX\laborex\web\data\reports\pdf\configmanagement\codegestion
<p>