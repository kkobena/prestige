...
<%    String search_value = "%%", lg_AYANTS_DROITS_ID = "%%", lg_CLIENT_ID = "%%";
    ...
    String scr_report_file = "rp_liste_ayantdroit";
    String report_generate_file = key.GetNumberRandom();

    report_generate_file = report_generate_file + ".pdf";
    OreportManager.setPath_report_src(Ojdom.scr_report_file + scr_report_file + ".jrxml");
    OreportManager.setPath_report_pdf(Ojdom.scr_report_pdf + "liste_ayantdroit_" + report_generate_file);
    ...
    String P_H_CLT_INFOS = "Liste des clients";
    ...
    parameters.put("P_REFERENCE", lg_AYANTS_DROITS_ID);
    parameters.put("P_TYPE_TIERS_PAYANT", lg_CLIENT_ID);
    ...
    response.sendRedirect("../../../data/reports/pdf/" + "liste_ayantdroit_" + report_generate_file);
