...
<%    JSONArray arrayObj = new JSONArray();
    for (int i = pgInt; i < pgInt_Last; i++) {
        ...
        json.put("lg_TYPEDEPOT_ID", (lstTEmplacement.get(i).getLgTYPEDEPOTID() != null ? lstTEmplacement.get(i).getLgTYPEDEPOTID().getLgTYPEDEPOTID() : ""));
    ...
    if (lstTEmplacement.size() == 0) {
        JSONObject json = new JSONObject();

        json.put("lg_EMPLACEMENT_ID", "0");
        json.put("str_NAME", "AJOUTER UN NOUVEAU DEPOT");
        json.put("str_DESCRIPTION", "AJOUTER UN NOUVEAU DEPOT");
        arrayObj.put(json);
