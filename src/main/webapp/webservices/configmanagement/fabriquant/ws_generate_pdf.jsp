...
<%    String search_value = "%%", lg_GROSSISTE_ID = "%%";
    ...
    String scr_report_file = "rp_liste_fabriquant";
    String report_generate_file = key.GetNumberRandom();

    report_generate_file = report_generate_file + ".pdf";
    OreportManager.setPath_report_src(Ojdom.scr_report_file + scr_report_file + ".jrxml");
    OreportManager.setPath_report_pdf(Ojdom.scr_report_pdf + "liste_fabriquant_" + report_generate_file);
    ...
    String P_H_CLT_INFOS = "Liste des fabriquants";
    ...
    response.sendRedirect("../../../data/reports/pdf/" + "liste_fabriquant_" + report_generate_file);
