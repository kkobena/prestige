...
<%    String lg_REMISE_ID = "%%", lg_TYPE_REMISE_ID = "54291528198233221411", search_value = "";
    ...
    if (OTUser.getStrIDS() != null) {
        int_ids = OTUser.getStrIDS();
    }
    new logger().OCategory.info("search_value "+search_value+" lg_REMISE_ID "+lg_REMISE_ID+" lg_TYPE_REMISE_ID "+lg_TYPE_REMISE_ID + " int_ids "+int_ids);
    lstTRemise = OremiseManagement.getListeTRemise(search_value, lg_REMISE_ID, lg_TYPE_REMISE_ID, int_ids);
