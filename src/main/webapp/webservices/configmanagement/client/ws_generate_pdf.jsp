...
<%    String search_value = "%%", lg_TIERS_PAYANT_ID = "%%", lg_TYPE_CLIENT_ID = "%%", str_STATUT = commonparameter.statut_enable;
    ...
    String scr_report_file = "rp_liste_client";
    String report_generate_file = key.GetNumberRandom();

    report_generate_file = report_generate_file + ".pdf";
    OreportManager.setPath_report_src(Ojdom.scr_report_file + scr_report_file + ".jrxml");
    OreportManager.setPath_report_pdf(Ojdom.scr_report_pdf + "liste_client_" + report_generate_file);
    ...
    String P_H_CLT_INFOS = "Liste des clients " + (str_STATUT.equalsIgnoreCase(commonparameter.statut_enable) ? "" : "Désativés");
    ...
    parameters.put("P_TYPE_TIERS_PAYANT", lg_TYPE_CLIENT_ID);
    ...
    response.sendRedirect("../../../data/reports/pdf/" + "liste_client_" + report_generate_file);
