...
<%
    ...
    if (request.getParameter("str_CODE_COMPTE_CLIENT") != null) {
        str_CODE_COMPTE_CLIENT = request.getParameter("str_CODE_COMPTE_CLIENT");
    }
    ...
    if (request.getParameter("dbl_SOLDE") != null) {
        dbl_SOLDE = Double.parseDouble(request.getParameter("dbl_SOLDE"));
    }
