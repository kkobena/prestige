...
<%    String lg_TYPE_TIERS_PAYANT_ID = "%%", lg_TYPE_CLIENT_ID = "%%", search_value = "", lg_TIERS_PAYANT_ID = "%%";
    ...
    if (request.getParameter("lg_TYPE_TIERS_PAYANT_ID") != null && !request.getParameter("lg_TYPE_TIERS_PAYANT_ID").equalsIgnoreCase("1")) {
    ...
    if (request.getParameter("lg_TIERS_PAYANT_ID") != null) {
        lg_TYPE_CLIENT_ID = request.getParameter("lg_TIERS_PAYANT_ID").toString();
