...
<%
    ...
    JSONArray arrayObj = groupeCtl.getGoupBons(false, dt_start, dt_end, lg_GROUPE_ID, search_value, start, limit); 
    int count = groupeCtl.getGoupBons(dt_start, dt_end, lg_GROUPE_ID, search_value);
