...
<%
    ...
    List<TFacture> tps = groupeCtl.getGroupeInvoiceDetails(false, search_value, lgTP, CODEFACTURE, start, limit);
    int count = groupeCtl.getGroupeInvoiceDetails(search_value, lgTP, CODEFACTURE);
    for (TFacture f : tps) {
