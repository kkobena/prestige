...
<%
    ...
    List<TTiersPayant> lis = groupeCtl.findTGroupeTierspayantNOTINTierspayant(false, limit, start, lg_GROUPE_ID, search_value);
    int count = groupeCtl.findTGroupeTierspayantNOTINTierspayantcount(lg_GROUPE_ID, search_value);
    for (TTiersPayant obj : lis) {
        JSONObject json = new JSONObject();
        json.put("lg_GROUPE_ID", lg_GROUPE_ID);
        json.put("str_GROUPE_LIB", (obj.getLgGROUPEID()!=null)?obj.getLgGROUPEID().getStrLIBELLE():""); 
