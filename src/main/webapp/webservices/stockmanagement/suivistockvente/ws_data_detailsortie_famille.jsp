...
<%  
    String lg_FAMILLE_ID = "%%", lg_USER_ID = "%%", search_value = "";
    ...
    lstTPreenregistrementDetail = OStockManager.listVenteDateAndByFamille(search_value, dtDEBUT, dtFin, lg_FAMILLE_ID, lg_USER_ID);
...
<%    JSONArray arrayObj = new JSONArray();
    for (int i = pgInt; i < pgInt_Last; i++) {
        ...
        json.put("int_NUMBER", lstTPreenregistrementDetail.get(i).getIntQUANTITYSERVED());
        json.put("str_CODE_TVA", lstTPreenregistrementDetail.get(i).getLgPREENREGISTREMENTID().getStrREF());
        json.put("int_VALUE1", conversion.AmountFormat(lstTPreenregistrementDetail.get(i).getIntPRICE(), '.'));
        
        // json.put("dt_CREATED", date.DateToString(lstTPreenregistrementDetail.get(i).getDtCREATED(), date.formatterShort));
