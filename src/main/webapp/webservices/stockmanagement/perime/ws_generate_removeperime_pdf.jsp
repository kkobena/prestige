...
<%
    ...
    if (request.getParameter("datefin") != null && !request.getParameter("datefin").equalsIgnoreCase("")) {
        str_Date_Fin = request.getParameter("datefin");
        new logger().OCategory.info("str_Date_Fin :" + str_Date_Fin);
    }

    if (request.getParameter("datedebut") != null && !request.getParameter("datedebut").equalsIgnoreCase("")) {
    ...
    String P_H_CLT_INFOS = "LISTE DES PERIMES RETIRES DU STOCK DU "+ date.formatterShort.format(java.sql.Date.valueOf(str_Date_Debut))+ " AU "+  date.formatterShort.format(java.sql.Date.valueOf(str_Date_Fin));
    
    String scr_report_file = "rp_product_remove_perime";
    ...
    OreportManager.setPath_report_pdf(Ojdom.scr_report_pdf + "product_remove_perime_" + report_generate_file);
    ...
    response.sendRedirect("../../../data/reports/pdf/" + "product_remove_perime_" + report_generate_file);
