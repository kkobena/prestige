...
<%
    ...
    //String scr_report_file = "rp_liste_reassort";
    String scr_report_file = "rp_liste_reassort";
    ...
    OreportManager.setPath_report_pdf(Ojdom.scr_report_pdf + "liste_reassort_" + report_generate_file);
    ...
    String P_H_CLT_INFOS = "Liste des articles à réassortir";
    ...
    parameters.put("P_PRINTED_BY", " Gestionnaire stock :: " + " " + OTUser.getStrFIRSTNAME() + "  " + OTUser.getStrLASTNAME());
    ...
    response.sendRedirect("../../../data/reports/pdf/" + "liste_reassort_" + report_generate_file);
