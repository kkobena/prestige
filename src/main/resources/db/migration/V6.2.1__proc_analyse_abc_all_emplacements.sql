-- =====================================================================
-- Procedures ABC - support "tous emplacements"
-- ---------------------------------------------------------------------
-- Identique a V6.2.0 (tri deterministe inclus), mais le filtre emplacement
-- devient optionnel : si p_emplacement_id est NULL ou vide, on agrege la
-- pharmacie ENTIERE (utilise par la reclassification automatique globale).
-- Le menu ABC passe toujours un emplacement reel -> comportement inchange.
-- =====================================================================
