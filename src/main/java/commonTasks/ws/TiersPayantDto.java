...
public class TiersPayantDto {
    ...
    public void setNbreBons(Integer nbreBons) {
    ...
    public void setMontantMaxParFcture(Long montantMaxParFcture) {
    ...
    public void setConsoMensuelle(Long consoMensuelle) {
    ...
    public void setRemiseForfaitaire(Long remiseForfaitaire) {
    ...
    public void setGroupeTiersPayantName(String groupeTiersPayantName) {
