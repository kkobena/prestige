...
public class ClientLambdaDTO implements Serializable {
    ...
    private String lgCLIENTID, strFIRSTNAME, strLASTNAME, strADRESSE, lgTYPECLIENTID, strSEXE;
    ...
    public ClientLambdaDTO(String lgCLIENTID, String strFIRSTNAME, String strLASTNAME, String strADRESSE, String lgTYPECLIENTID, String strSEXE) {
        this.lgCLIENTID = lgCLIENTID;
        this.strFIRSTNAME = strFIRSTNAME;
        this.strLASTNAME = strLASTNAME;
        this.strADRESSE = strADRESSE;
