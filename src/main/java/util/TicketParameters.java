...
public class TicketParameters {
    ...
    public String email = "dici.servtech@gmail.com", password = "Dici@2020",
            ...
            pathsmsapisendmessageurl = "https://api.orange.com/smsmessaging/v1/outbound/tel%3A%2B225000000/requests", senderAddress = "tel:+225000000";

    public String pathWindow = System.getProperty("user.home") + File.separator + "Documents" + File.separator + "config.properties";
    public String pathUnix = System.getProperty("user.home") + File.separator + "Home" + File.separator + "config.properties";
...
//            titleFontSize = Integer.valueOf(prop.getProperty("titlefontsize"));
        ...
        try {
            ...
            String propFileName = System.getProperty("user.home") + File.separator + "config.properties";
