...
public class Grossiste extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            JSONObject json = createProduct(request.getParameter("lg_GROSSISTE_ID"), request.getParameter("lg_FAMILLE_ID"), request.getParameter("str_CODE_ARTICLE"), entityManager);
...
//                 e.printStackTrace();
    ...
    private TGrossiste getGrossiste(String lg_GROSSISTE_ID, EntityManager entityManager) {
        ...
        try {
            TypedQuery<TGrossiste> OTGrossiste = entityManager.createQuery("SELECT t FROM TGrossiste t WHERE (t.lgGROSSISTEID = ?1 OR t.strLIBELLE = ?1 OR t.strCODE = ?1) AND t.strSTATUT = ?2", TGrossiste.class)
    ...
    private JSONObject createProduct(String lg_GROSSISTE_ID, String lg_FAMILLE_ID, String str_CODE_ARTICLE, EntityManager entityManager) {
