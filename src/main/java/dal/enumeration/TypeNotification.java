...
public enum TypeNotification {
    ...
    DESACTIVATION_DE_PRODUIT("Desactivation de produit"),
    SUPPRESSION_DE_PRODUIT("Suppression de produit"),
    ACTIVATION_DE_PRODUIT("Activation de produit"),
    AJUSTEMENT_DE_PRODUIT("Ajustement de produit"),
    VALIDATION_DE_CAISSE("Validation de caisse"),
    ANNULATION_DE_CAISSE("Annulation de caisse"),
    MVT_DE_CAISSE("Mouvement de caisse"),
    ENTREE_EN_STOCK("Entree en stock de BL"),
    CLOTURE_DE_CAISSE("Cloture de caisse"),
    ANNULATION_CLOTURE_DE_CAISSE("Annulation de cloture de caisse"),
    AVOIR_PRODUIT("Reception avoir"),
