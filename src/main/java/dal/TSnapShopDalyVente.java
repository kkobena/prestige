...
public class TSnapShopDalyVente implements Serializable {
    ...
    public TSnapShopDalyVente() {
    }

    public TSnapShopDalyVente(String lgID) {
        this.lgID = lgID;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof TSnapShopDalyVente)) {
            return false;
        }
        TSnapShopDalyVente other = (TSnapShopDalyVente) object;
