...
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "TMvtCaisse.findAll", query = "SELECT t FROM TMvtCaisse t"),
...
public class TMvtCaisse implements Serializable {
    ...
    public boolean equals(Object object) {
        ...
        if ((this.lgMVTCAISSEID == null && other.lgMVTCAISSEID != null) || (this.lgMVTCAISSEID != null && !this.lgMVTCAISSEID.equals(other.lgMVTCAISSEID))) {
            return false;
        }
        return true;
    }
