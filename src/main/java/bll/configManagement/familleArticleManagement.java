...
public class familleArticleManagement extends bllBase {
    ...
    public void create(String str_CODE_FAMILLE, String str_LIBELLE, String str_COMMENTAIRE, String lg_GROUPE_FAMILLE_ID) {
        ...
        try {
            ...
            dal.TGroupeFamille OTGroupeFamille = getOdataManager().getEm().find(dal.TGroupeFamille.class, lg_GROUPE_FAMILLE_ID);
    ...
    public void update(String lg_FAMILLEARTICLE_ID, String str_CODE_FAMILLE, String str_LIBELLE, String str_COMMENTAIRE, String lg_GROUPE_FAMILLE_ID) {
        ...
        try {
            ...
            this.do_event_log(Ojconnexion, commonparameter.ALL, Description, this.getOTUser().getStrLOGIN(), commonparameter.statut_enable, "TFamillearticle", "Donnee de ref", "");
    ...
    public List<TFamillearticle> getAllFamilleArticle(String search_value, String lg_FAMILLEARTICLE_ID) {
        ...
        try {
            lstTFamillearticle = this.getOdataManager().getEm().createQuery("SELECT t FROM TFamillearticle t WHERE t.lgFAMILLEARTICLEID LIKE ?1 AND t.strLIBELLE LIKE ?2 AND t.strSTATUT LIKE ?3 ").
   ...
   //supprimer famille article 
    ...
    public List<TFamillearticle> getListFamilleFromInventaire(String search_value, String lg_INVENTAIRE_ID) {
        ...
        try {
            ...
            String qry = "SELECT DISTINCT(t.lg_FAMILLEARTICLE_ID), t.str_LIBELLE FROM t_famillearticle t, t_inventaire_famille i, t_famille f WHERE f.lg_FAMILLEARTICLE_ID = t.lg_FAMILLEARTICLE_ID AND f.lg_FAMILLE_ID = i.lg_FAMILLE_ID AND (t.str_LIBELLE LIKE '"+search_value+"%' OR t.str_CODE_FAMILLE LIKE '"+search_value+"%') AND i.lg_INVENTAIRE_ID = '"+lg_INVENTAIRE_ID+"' ORDER BY t.str_LIBELLE";
