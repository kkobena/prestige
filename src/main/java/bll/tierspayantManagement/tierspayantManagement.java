...
public class tierspayantManagement extends bllBase {
    ...
    public boolean create(
            ...
            double dbl_PLAFOND_CREDIT, double dbl_TAUX_REMBOURSEMENT, String str_NUMERO_CAISSE_OFFICIEL,
            String str_CENTRE_PAYEUR, String str_CODE_REGROUPEMENT, double dbl_SEUIL_MINIMUM,
            boolean bool_INTERDICTION, String str_CODE_COMPTABLE, boolean bool_PRENUM_FACT_SUBROGATOIRE,
            int int_NUMERO_DECOMPTE, String str_CODE_PAIEMENT, int dt_DELAI_PAIEMENT, double dbl_POURCENTAGE_REMISE,
...
//            OTTiersPayant.setDtDELAIPAIEMENT(dt_DELAI_PAIEMENT);
            ...
            if (OModelFacture == null) {
                OModelFacture = this.getOdataManager().getEm().find(TModelFacture.class, commonparameter.PROCESS_SUCCESS);
            }
            ...
            if (this.persiste(OTTiersPayant)) {
                if (OcompteClientManagement.createCompteClient("", dbl_QUOTA_CONSO_MENSUELLE, dbl_CAUTION, dbl_SOLDE, commonparameter.clt_TIERSPAYANT, OTTiersPayant.getLgTIERSPAYANTID()) != null) {
                    ...
                    this.do_event_log(this.getOdataManager(), "", "Création du Tiers-payant " + OTTiersPayant.getStrFULLNAME(), this.getOTUser().getStrFIRSTNAME(), commonparameter.statut_enable, "t_tiers_payant", "t_tiers_payant", "Mouvement Tiers-payant", this.getOTUser().getLgUSERID());
                }
            }
        } catch (Exception e) {
            e.printStackTrace();
    ...
    public void update(
        ...
        try {
            ...
            try {
                ...
                dal.TTypeTiersPayant OTTypeTiersPayant = getOdataManager().getEm().find(dal.TTypeTiersPayant.class, lg_TYPE_TIERS_PAYANT_ID);
                if (OTTypeTiersPayant != null) {
                    OTTiersPayant.setLgTYPETIERSPAYANTID(OTTypeTiersPayant);
                ...
                //lg_TYPE_CONTRAT_ID
                dal.TTypeContrat OTTypeContrat = getOdataManager().getEm().find(dal.TTypeContrat.class, lg_TYPE_CONTRAT_ID);
                if (OTTypeContrat != null) {
                    OTTiersPayant.setLgTYPECONTRATID(OTTypeContrat);
                ...
                // lg_REGIMECAISSE_ID
                dal.TRegimeCaisse OTRegimeCaisse = getOdataManager().getEm().find(dal.TRegimeCaisse.class, lg_REGIMECAISSE_ID);
                if (OTRegimeCaisse != null) {
                    OTTiersPayant.setLgREGIMECAISSEID(OTRegimeCaisse);
            ...
            OTTiersPayant.setStrCODEOFFICINE(str_CODE_OFFICINE);
            OTTiersPayant.setStrREGISTRECOMMERCE(str_REGISTRE_COMMERCE);
            if (OTTiersPayant.getDblPLAFONDCREDIT() > 0 && OTTiersPayant.getDbCONSOMMATIONMENSUELLE() > dbl_PLAFOND_CREDIT) {
                this.buildErrorTraceMessage("Echec de mise à jour. La consommation en cours est supérieure au plafond.");
                return;
            }
            OTTiersPayant.setDblPLAFONDCREDIT(dbl_PLAFOND_CREDIT);
            OTTiersPayant.setBIsAbsolute(b_IsAbsolute);
    ...
    public TTiersPayant createTTiersPayant(
            String str_NAME, String str_FULLNAME, String str_CODE_ORGANISME,
            String str_ADRESSE, String str_MAIL, String str_TELEPHONE, String lg_VILLE_ID,
            double dbl_PLAFOND_CREDIT, double dbl_TAUX_REMBOURSEMENT, double dbl_POURCENTAGE_REMISE,
            double dbl_REMISE_FORFETAIRE, String lg_TYPE_TIERS_PAYANT_ID, String lg_REGIMECAISSE_ID,
            String lg_RISQUE_ID, String lg_TYPE_CONTRAT_ID/*, String str_NUMERO_CAISSE_OFFICIEL,
     String str_CENTRE_PAYEUR, double dbl_SEUIL_MINIMUM,String str_CODE_REGROUPEMENT,
     boolean bool_INTERDICTION, String str_CODE_COMPTABLE, boolean bool_PRENUM_FACT_SUBROGATOIRE,
     int int_NUMERO_DECOMPTE, String str_CODE_PAIEMENT, Date dt_DELAI_PAIEMENT,
     String str_CODE_EDIT_BORDEREAU, int int_NBRE_EXEMPLAIRE_BORD,
     int int_PERIODICITE_EDIT_BORD, Date int_DATE_DERNIERE_EDITION, String str_NUMERO_IDF_ORGANISME,
     double dbl_MONTANT_F_CLIENT, double dbl_BASE_REMISE, String str_CODE_DOC_COMPTOIRE, boolean bool_ENABLED
     */
    ) {
    ...
    // Karno
    public TCompteClientTiersPayant create_compteclt_tierspayant(String lg_COMPTE_CLIENT_ID, String lg_TIERS_PAYANT_ID, int int_POURCENTAGE, int int_PRIORITY, double dbl_PLAFOND, double dbl_QUOTA_CONSO_VENTE, String str_NUMERO_SECURITE_SOCIAL, Integer dbPLAFONDENCOURS, boolean b_IsAbsolute) {
        ...
        try {
            ...
            try {
                ...
                if (OTCompteClientTiersPayantBis.getLgTIERSPAYANTID() != OTTiersPayant) {
                    ...
                    result = true;
                    //this.buildErrorTraceMessage("Désolé! Un autre tiers payant a déjà le régime séléctionné pour le client");
                } else {
    ...
    public List<TPreenregistrementCompteClientTiersPayent> getAllPreenregistrement(String search_value) {
        ...
        try {
            lstTPreenregistrementCompteClientTiersPayent = this.getOdataManager().getEm().createQuery("SELECT t FROM TPreenregistrementCompteClientTiersPayent t WHERE t.lgCOMPTECLIENTTIERSPAYANTID.lgTIERSPAYANTID.strNAME LIKE ?1")
    ...
    public boolean createsnapshotVente(String lg_COMPTE_CLIENT_TIERS_PAYANT_ID, int int_MONTANT) {
        ...
        try {
            OTSnapshotPreenregistrementCompteClientTiersPayent = (TSnapshotPreenregistrementCompteClientTiersPayent) this.getOdataManager().getEm().createQuery("SELECT t FROM TSnapshotPreenregistrementCompteClientTiersPayent t WHERE t.lgCOMPTECLIENTTIERSPAYANTID.lgCOMPTECLIENTTIERSPAYANTID = ?1 AND t.strSTATUT = ?2")
                    .setParameter(1, lg_COMPTE_CLIENT_TIERS_PAYANT_ID).setParameter(2, commonparameter.statut_is_Waiting).getSingleResult();
            new logger().OCategory.info("Ref id " + OTSnapshotPreenregistrementCompteClientTiersPayent.getLgSNAPSHOTPREENREGISTREMENTCOMPTECLIENTTIERSPAENTID() + " Solde " + OTSnapshotPreenregistrementCompteClientTiersPayent.getIntPRICE());
            OTSnapshotPreenregistrementCompteClientTiersPayent.setIntPRICE(OTSnapshotPreenregistrementCompteClientTiersPayent.getIntPRICE() + int_MONTANT);
            OTSnapshotPreenregistrementCompteClientTiersPayent.setDtUPDATED(new Date());
            OTSnapshotPreenregistrementCompteClientTiersPayent.setIntNUMBERTRANSACTION(OTSnapshotPreenregistrementCompteClientTiersPayent.getIntNUMBERTRANSACTION() + 1);
            OTSnapshotPreenregistrementCompteClientTiersPayent.setLgCOMPTECLIENTTIERSPAYANTID(OTSnapshotPreenregistrementCompteClientTiersPayent.getLgCOMPTECLIENTTIERSPAYANTID());
    ...
    public TSnapshotPreenregistrementCompteClientTiersPayent createSnapShopPreenregistrementCompteCltTp(String lg_COMPTE_CLIENT_TIERS_PAYANT_ID, int int_MONTANT) {
//        boolean result = false;
        try {
            TCompteClientTiersPayant OTCompteClientTiersPayant = (TCompteClientTiersPayant) this.getOdataManager().getEm().createQuery("SELECT t FROM TCompteClientTiersPayant t WHERE t.lgCOMPTECLIENTTIERSPAYANTID = ?1 AND t.strSTATUT = ?2")
                    .setParameter(1, lg_COMPTE_CLIENT_TIERS_PAYANT_ID).setParameter(2, commonparameter.statut_enable).getSingleResult();
            new logger().OCategory.info("Client " + OTCompteClientTiersPayant.getLgCOMPTECLIENTID().getLgCLIENTID().getStrFIRSTNAME());
            ...
            OTSnapshotPreenregistrementCompteClientTiersPayent.setLgSNAPSHOTPREENREGISTREMENTCOMPTECLIENTTIERSPAENTID(this.getKey().getComplexId());
            new logger().OCategory.info("Ref id " + OTSnapshotPreenregistrementCompteClientTiersPayent.getLgSNAPSHOTPREENREGISTREMENTCOMPTECLIENTTIERSPAENTID() + " Solde " + OTSnapshotPreenregistrementCompteClientTiersPayent.getIntPRICE());
            ...
            OTSnapshotPreenregistrementCompteClientTiersPayent.setLgCOMPTECLIENTTIERSPAYANTID(OTCompteClientTiersPayant);
            this.persiste(OTSnapshotPreenregistrementCompteClientTiersPayent);
...
//        return result;
    ...
    public int getAllDossierNoSold(String lg_TIERS_PAYANT_ID, String str_STATUT, String dt_DEBUT, String dt_FIN) {
        ...
        try {
            ...
            for (TSnapshotPreenregistrementCompteClientTiersPayent OTSnapshotPreenregistrementCompteClientTiersPayent : lst) {
                new logger().OCategory.info("Reference dossier " + OTSnapshotPreenregistrementCompteClientTiersPayent.getStrREF() + " Nombre transaction " + OTSnapshotPreenregistrementCompteClientTiersPayent.getIntNUMBERTRANSACTION());
    ...
    public int getAllAmountforDossierNoSold(String lg_TIERS_PAYANT_ID, String str_STATUT, String dt_DEBUT, String dt_FIN) {
        int result = 0;
        Date dtFin;
        List<TSnapshotPreenregistrementCompteClientTiersPayent> lst = new ArrayList<TSnapshotPreenregistrementCompteClientTiersPayent>();
        try {
            ...
            for (TSnapshotPreenregistrementCompteClientTiersPayent OTSnapshotPreenregistrementCompteClientTiersPayent : lst) {
                new logger().OCategory.info("Reference dossier " + OTSnapshotPreenregistrementCompteClientTiersPayent.getStrREF() + " montant " + OTSnapshotPreenregistrementCompteClientTiersPayent.getIntPRICE());
    ...
    public List<TTiersPayant> getAllTierspayant(String str_STATUT, String dt_DEBUT, String dt_FIN, String lg_TIERS_PAYANT_ID) {
        ...
        try {
            ...
            for (TTiersPayant OTTiersPayant : lstTiersPayants) {
                List<TSnapshotPreenregistrementCompteClientTiersPayent> lst = new ArrayList<TSnapshotPreenregistrementCompteClientTiersPayent>();
                lst = this.getOdataManager().getEm().createQuery("SELECT t FROM TSnapshotPreenregistrementCompteClientTiersPayent t WHERE t.lgCOMPTECLIENTTIERSPAYANTID.lgTIERSPAYANTID.lgTIERSPAYANTID LIKE ?1 AND t.strSTATUT = ?2 AND (t.dtCREATED BETWEEN ?4 AND ?5) ORDER BY t.lgCOMPTECLIENTTIERSPAYANTID.lgTIERSPAYANTID.strFULLNAME ASC")
                        .setParameter(1, OTTiersPayant.getLgTIERSPAYANTID()).setParameter(2, str_STATUT).setParameter(4, dtDEBUT).setParameter(5, dtFin).getResultList();
    ...
    public boolean create_compteclt_tierspayant(String lg_COMPTE_CLIENT_ID, String lg_TIERS_PAYANT_ID, int int_POURCENTAGE, int int_PRIORITY, String bool_REGIME_add, Integer db_PLAFOND_ENCOURS, boolean b_IsAbsolute, double plafond) {
    ...
    //liste des tiers payants qui doivent sur une periode
    public List<TTiersPayant> ShowAllOrOneTierspayantDette(String search_value, String lg_TYPE_TIERS_PAYANT_ID, Date dtDEBUT, Date dtFin, String lg_PREENREGISTREMENT_ID, String lg_COMPTE_CLIENT_ID, String lg_TIERS_PAYANT_ID, String lg_USER_ID, String lg_EMPLACEMENT_ID) {
        List<TTiersPayant> lstTTiersPayant = new ArrayList<TTiersPayant>();
        ...
        try {
            ...
            for (TTiersPayant OTTiersPayant : lstTTiersPayant) {
                List<TPreenregistrementCompteClientTiersPayent> lstTPreenregistrementCompteClientTiersPayent = new ArrayList<TPreenregistrementCompteClientTiersPayent>();
                lstTPreenregistrementCompteClientTiersPayent = OPreenregistrement.listTPreenregistrementCompteClientTiersPayent(search_value, dtDEBUT, dtFin, lg_USER_ID, lg_PREENREGISTREMENT_ID, lg_EMPLACEMENT_ID, lg_COMPTE_CLIENT_ID, OTTiersPayant.getLgTIERSPAYANTID());
    ...
    public List<TTiersPayant> ShowAllOrOneTierspayant(String search_value, String lg_TIERS_PAYANT_ID, String lg_TYPE_TIERS_PAYANT_ID, String str_STATUT) {
    ...
    public List<TPreenregistrementCompteClientTiersPayent> ShowAllOrOneTierspayantByVente(String search_value, String lg_TIERS_PAYANT_ID, String lg_TYPE_TIERS_PAYANT_ID, String lg_PREENREGISTREMENT_ID, String str_STATUT) {
        List<TPreenregistrementCompteClientTiersPayent> lstTPreenregistrementCompteClientTiersPayent = new ArrayList<TPreenregistrementCompteClientTiersPayent>();
        try {
            if (search_value.equalsIgnoreCase("") || search_value == null) {
                search_value = "%%";
            ...
            lstTPreenregistrementCompteClientTiersPayent = this.getOdataManager().getEm().createQuery("SELECT t FROM TPreenregistrementCompteClientTiersPayent t WHERE t.lgCOMPTECLIENTTIERSPAYANTID.lgTIERSPAYANTID.lgTIERSPAYANTID LIKE ?1 AND (t.lgCOMPTECLIENTTIERSPAYANTID.lgTIERSPAYANTID.strCODEORGANISME LIKE ?2 OR t.lgCOMPTECLIENTTIERSPAYANTID.lgTIERSPAYANTID.strFULLNAME LIKE ?2) AND t.lgCOMPTECLIENTTIERSPAYANTID.lgTIERSPAYANTID.strSTATUT = ?3 AND t.lgCOMPTECLIENTTIERSPAYANTID.lgTIERSPAYANTID.lgTYPETIERSPAYANTID.lgTYPETIERSPAYANTID LIKE ?4 AND t.lgPREENREGISTREMENTID.lgPREENREGISTREMENTID LIKE ?5 AND t.lgPREENREGISTREMENTID.strSTATUT LIKE ?6").
                    ...
                    .setParameter(4, lg_TYPE_TIERS_PAYANT_ID).setParameter(5, lg_PREENREGISTREMENT_ID).setParameter(6, str_STATUT)
                    .getResultList();
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    public TTiersPayant getTTiersPayant(String lg_TIERS_PAYANT_ID) {
        TTiersPayant OTTiersPayant = null;
        try {
            OTTiersPayant = (TTiersPayant) this.getOdataManager().getEm().createQuery("SELECT t FROM TTiersPayant t WHERE (t.lgTIERSPAYANTID LIKE ?1 OR t.strFULLNAME LIKE ?1 OR t.strCODEORGANISME LIKE ?1 OR t.strNAME LIKE ?1) AND t.strSTATUT = ?2")
                    .setParameter(1, lg_TIERS_PAYANT_ID).setParameter(2, commonparameter.statut_enable).setMaxResults(1).getSingleResult();
            //  new logger().OCategory.info("Type tiers payant " + OTTiersPayant.getLgTYPETIERSPAYANTID().getStrLIBELLETYPETIERSPAYANT());
        } catch (Exception e) {
            e.printStackTrace();
        }
        return OTTiersPayant;
...
//            e.printStackTrace();
    ...
    /*public TCompteClientTiersPayant createcompteclttierspayant(String lg_COMPTE_CLIENT_ID, String lg_TIERS_PAYANT_ID, int int_POURCENTAGE, int int_PRIORITY) {
     TCompteClientTiersPayant OTCompteClientTiersPayant = null;
     try {
     TTiersPayant OTTiersPayant = this.getTTiersPayant(lg_TIERS_PAYANT_ID);
     TCompteClient OTCompteClient = new clientManagement(this.getOdataManager()).getTCompteClient(lg_COMPTE_CLIENT_ID);
     ...
     //                if (!this.isTiersPayantExistForCptltTiersP(OTCompteClient.getLgCOMPTECLIENTID(), OTTiersPayant.getLgTIERSPAYANTID())) {
     // if (!this.isRegimeExistForCptltTiersP(OTCompteClient.getLgCOMPTECLIENTID(), int_PRIORITY)) {
     OTCompteClientTiersPayant = this.createTCompteClientTiersPayant(OTCompteClient, OTTiersPayant, int_POURCENTAGE, int_PRIORITY);
     //result = true;
 ...
 /*  } else {
     OTCompteClientTiersPayant = this.updateComptecltTierspayantLigth(OTCompteClient.getLgCOMPTECLIENTID(), OTTiersPayant.getLgTIERSPAYANTID(), int_POURCENTAGE);
     //result = true;
     return OTCompteClientTiersPayant;
     }
     } else {
     ...
     // new logger().OCategory.info("result " + OTCompteClientTiersPayant.getLgCOMPTECLIENTTIERSPAYANTID() + " Message " + this.getDetailmessage());
     //return OTCompteClientTiersPayant;
     }*/
    ...
    public List<TCompteClientTiersPayant> getListCompteClientTiersPayants(String search_value, String lg_COMPTE_CLIENT_ID, String lg_TIERS_PAYANT_ID) {
        ...
        try {
            ...
            lst = this.getOdataManager().getEm().createQuery("SELECT t FROM TCompteClientTiersPayant t WHERE t.lgTIERSPAYANTID.strNAME LIKE ?1 AND t.lgCOMPTECLIENTID.lgCOMPTECLIENTID LIKE ?2 AND t.lgTIERSPAYANTID.lgTIERSPAYANTID LIKE ?3 AND t.strSTATUT = ?4")
                    .setParameter(1, search_value + "%").setParameter(2, lg_COMPTE_CLIENT_ID).setParameter(3, lg_TIERS_PAYANT_ID).setParameter(4, commonparameter.statut_enable).getResultList();
    ...
    public List<TModelFacture> getTModelFacture(String search_value) {
        ...
        try {
            ...
            lstTModelFactures = this.getOdataManager().getEm().createQuery("SELECT t FROM TModelFacture t WHERE (t.strDESCRIPTION LIKE ?1 OR t.strVALUE LIKE ?1) AND t.strSTATUT = ?2")
    ...
    public List<String> generateDataToExport() {
        ...
        try {
            ...
            for (TTiersPayant OTTiersPayant : lstTTiersPayant) {
                ...
                row += (OTTiersPayant.getLgTYPETIERSPAYANTID() != null ? OTTiersPayant.getLgTYPETIERSPAYANTID().getStrLIBELLETYPETIERSPAYANT() : " ") + ";";
...
//            e.printStackTrace();
    ...
    public TTiersPayant checkTiersPayantIsExitst(String str_CODE_ORGANISME, String lg_TYPE_TIERS_PAYANT_ID) {
        TTiersPayant OTTiersPayant = null;
        try {
            OTTiersPayant = (TTiersPayant) this.getOdataManager().getEm().createQuery("SELECT t FROM TTiersPayant t WHERE t.strCODEORGANISME LIKE ?1 AND t.strSTATUT = ?2 AND (t.lgTYPETIERSPAYANTID.lgTYPETIERSPAYANTID = ?3 OR t.lgTYPETIERSPAYANTID.strLIBELLETYPETIERSPAYANT = ?3)")
                    .setParameter(1, str_CODE_ORGANISME).setParameter(2, commonparameter.statut_enable).setParameter(3, lg_TYPE_TIERS_PAYANT_ID).getSingleResult();
        } catch (Exception e) {
            e.printStackTrace();
        }
        return OTTiersPayant;
    ...
    private boolean isRegisteredClient(String str_PHONE) {
        ...
        try {
            list = this.getOdataManager().getEm().createQuery("SELECT o FROM TClient o WHERE o.lgTYPECLIENTID.lgTYPECLIENTID=?1 AND o.strADRESSE =?2")
                    .setParameter(1, commonparameter.STANDART_CLIENT_ID)
                    .setParameter(2, str_PHONE).getResultList();
            if (!list.isEmpty()) {
                isRegistered = true;
            }
        } catch (Exception e) {
            ...
            if (OTTiersPayant != null) {
                ...
                for (TCompteClientTiersPayant OTCompteClientTiersPayant1 : lstTCompteClientTiersPayant) {
                    ...
                    if (str_STATUT.equalsIgnoreCase(commonparameter.statut_disable)) {
                        ...
                        if (this.isRegimeExistForCptltTiersPBis(OTCompteClientTiersPayant1.getLgCOMPTECLIENTID().getLgCOMPTECLIENTID(), OTCompteClientTiersPayant1.getIntPRIORITY(), commonparameter.statut_disable) == null) {
                            if (lstTCompteCTP.size() >= 1) {
                                OTCompteClientTiersPayant1.setStrSTATUT(str_STATUT);
                                OTCompteClientTiersPayant1.setDtUPDATED(new Date());
                            }
    ...
    //A NE PAS SUPPRIMER
    public List<TTiersPayant> ShowAllOrOneTierspayant(String search_value, String lg_TIERS_PAYANT_ID, String lg_TYPE_TIERS_PAYANT_ID) {
        List<TTiersPayant> lstTTiersPayant = new ArrayList<>();
        try {
            if (search_value.equalsIgnoreCase("")) {
                search_value = "%%";
    ...
    public long verifieComptClientTierspayantVente(String lg_COMPTE_CLIENT_TIERS_PAYANT_ID) {
        ...
        try {
            typedQuery = this.getOdataManager().getEm().createQuery("SELECT COUNT(o) FROM TPreenregistrementCompteClientTiersPayent o WHERE o.lgCOMPTECLIENTTIERSPAYANTID.lgCOMPTECLIENTTIERSPAYANTID=?1 AND o.lgPREENREGISTREMENTID.bISCANCEL=FALSE AND o.strSTATUTFACTURE <> ?2 AND o.intPRICE >0  ", Long.class)
                    .setParameter(1, lg_COMPTE_CLIENT_TIERS_PAYANT_ID).setParameter(2, commonparameter.statut_paid);
        } catch (Exception e) {
            e.printStackTrace();
        }
...
public void deleteComptecltTierspayant(String lg_COMPTE_CLIENT_TIERS_PAYANT_ID) {
    ...
    public TCompteClientTiersPayant createCompteClientTiersPayant(String lg_COMPTE_CLIENT_ID, String lg_TIERS_PAYANT_ID, int int_POURCENTAGE, int int_PRIORITY, String lg_TYPE_CLIENT_ID) {
        TCompteClientTiersPayant OTCompteClientTiersPayant = null;
        try {
            if (!this.getOdataManager().getEm().getTransaction().isActive()) {
                this.getOdataManager().getEm().getTransaction().begin();
    ...
    public JSONArray getByTiersPayant(String lgID, String dt_start, String dt_end, String search, int start, int limit) {
        ...
        try {
            data = this.getOdataManager().getEm().createQuery("SELECT  COUNT(o) AS NB,SUM(o.intPRICE) AS MONTANT,o.lgCOMPTECLIENTTIERSPAYANTID.lgTIERSPAYANTID.strCODEORGANISME,o.lgCOMPTECLIENTTIERSPAYANTID.lgTIERSPAYANTID.strFULLNAME,o.lgCOMPTECLIENTTIERSPAYANTID.lgTIERSPAYANTID.lgTIERSPAYANTID  FROM TPreenregistrementCompteClientTiersPayent o WHERE o.lgCOMPTECLIENTTIERSPAYANTID.lgTIERSPAYANTID.lgTIERSPAYANTID LIKE ?1 AND (o.lgCOMPTECLIENTTIERSPAYANTID.lgTIERSPAYANTID.strFULLNAME LIKE ?2 OR o.lgCOMPTECLIENTTIERSPAYANTID.lgTIERSPAYANTID.strCODEORGANISME LIKE ?2 ) AND  FUNCTION('DATE', o.lgPREENREGISTREMENTID.dtUPDATED) BETWEEN ?3 AND ?4 AND o.lgPREENREGISTREMENTID.strSTATUT='is_Closed' AND o.intPRICE >0 AND o.lgPREENREGISTREMENTID.bISCANCEL=FALSE AND o.lgPREENREGISTREMENTID.intPRICE >0  GROUP BY o.lgCOMPTECLIENTTIERSPAYANTID.lgTIERSPAYANTID.lgTIERSPAYANTID,o.lgCOMPTECLIENTTIERSPAYANTID.lgTIERSPAYANTID.strCODEORGANISME,o.lgCOMPTECLIENTTIERSPAYANTID.lgTIERSPAYANTID.strFULLNAME ORDER BY o.lgCOMPTECLIENTTIERSPAYANTID.lgTIERSPAYANTID.lgTYPETIERSPAYANTID.strLIBELLETYPETIERSPAYANT,o.lgCOMPTECLIENTTIERSPAYANTID.lgTIERSPAYANTID.strFULLNAME")
                    ...
                    setParameter(3, java.sql.Date.valueOf(dt_start))
    ...
    public int countTP(String lgID, String dt_start, String dt_end, String search) {
        ...
        int count = 0;
        try {
            data = this.getOdataManager().getEm().createQuery("SELECT  COUNT(o) AS NB FROM TPreenregistrementCompteClientTiersPayent o WHERE o.lgCOMPTECLIENTTIERSPAYANTID.lgTIERSPAYANTID.lgTIERSPAYANTID LIKE ?1 AND (o.lgCOMPTECLIENTTIERSPAYANTID.lgTIERSPAYANTID.strFULLNAME LIKE ?2 OR o.lgCOMPTECLIENTTIERSPAYANTID.lgTIERSPAYANTID.strCODEORGANISME LIKE ?2 ) AND  FUNCTION('DATE', o.lgPREENREGISTREMENTID.dtUPDATED) BETWEEN ?3 AND ?4 AND o.lgPREENREGISTREMENTID.strSTATUT='is_Closed' AND o.intPRICE >0 AND o.lgPREENREGISTREMENTID.bISCANCEL=FALSE AND o.lgPREENREGISTREMENTID.intPRICE >0 GROUP BY o.lgCOMPTECLIENTTIERSPAYANTID.lgTIERSPAYANTID.lgTIERSPAYANTID ")
                    .setParameter(1, lgID + "%")
                    .setParameter(2, search + "%").
                    setParameter(3, java.sql.Date.valueOf(dt_start))
                    .setParameter(4, java.sql.Date.valueOf(dt_end)).
