...
public class StatisticsFamilleArticle extends bll.bllBase {
    ...
    public List<TPreenregistrementDetail> getUniteVendueData(String dt_start, String dt_end, String lg_ARTICLE_ID, String search_value) {
        ...
        if (!"".equals(dt_start)) {
            ...
            try {
                if (!"".equals(dt_end) && !dt_start.equals(dt_end)) {
                    ...
                    listprePreenregistrements = this.getOdataManager().getEm().createQuery("SELECT o FROM  TPreenregistrementDetail o WHERE o.dtCREATED BETWEEN ?1 AND ?2  AND  o.lgPREENREGISTREMENTID.intPRICE >0 AND o.lgPREENREGISTREMENTID.strSTATUT =?3 AND o.lgPREENREGISTREMENTID.bISCANCEL=FALSE  AND o.lgFAMILLEID.lgFAMILLEID LIKE ?4  AND (o.lgFAMILLEID.strNAME LIKE ?5 OR o.lgFAMILLEID.intCIP LIKE ?5) AND o.lgPREENREGISTREMENTID.lgTYPEVENTEID.lgTYPEVENTEID NOT LIKE ?6 ORDER BY o.lgFAMILLEID.lgFAMILLEARTICLEID.lgFAMILLEARTICLEID")
                            .setParameter(1, dtstart)
                            .setParameter(2, dtend)
                            .setParameter(3, commonparameter.statut_is_Closed)
                            .setParameter(4, "%" + lg_ARTICLE_ID + "%")
                            .setParameter(5, search_value + "%")
                            .setParameter(6, Parameter.VENTE_DEPOT_EXTENSION)
                            .getResultList();
                } else {

                    listprePreenregistrements = this.getOdataManager().getEm().createQuery("SELECT o FROM  TPreenregistrementDetail o WHERE o.dtCREATED >= ?1   AND o.lgPREENREGISTREMENTID.intPRICE >0 AND o.lgPREENREGISTREMENTID.strSTATUT =?2  AND o.lgPREENREGISTREMENTID.bISCANCEL=FALSE   AND o.lgFAMILLEID.lgFAMILLEID LIKE ?3 AND (o.lgFAMILLEID.strNAME LIKE ?4 OR o.lgFAMILLEID.intCIP LIKE ?4) AND o.lgPREENREGISTREMENTID.lgTYPEVENTEID.lgTYPEVENTEID NOT LIKE ?6 ORDER BY o.lgFAMILLEID.lgFAMILLEARTICLEID.lgFAMILLEARTICLEID ")
                            .setParameter(1, dtstart)
                            .setParameter(2, commonparameter.statut_is_Closed)
                            .setParameter(3, "%" + lg_ARTICLE_ID + "%")
    ...
    public List<EntityData> getFamillesUniteVendu(String dt_start, String dt_end, String lg_ARTICLE_ID, String search_value) {
        Set<TFamille> familles = new HashSet<>();
        List<EntityData> datas = new ArrayList<>();
        try {
            List<TPreenregistrementDetail> listprePreenregistrements = this.getUniteVendueData(dt_start, dt_end, lg_ARTICLE_ID, search_value);
            ...
            for (TFamille OFamille : familles) {
                montantfamille = getAmountFamilleArticle(OFamille.getLgFAMILLEARTICLEID().getLgFAMILLEARTICLEID(), dt_start, dt_end);
...
//int_QTY
                ...
                double int_QTE_VENDUE = 0, PERCENT = 0, int_NBRE_SORTIE = 0, int_UNITE_MOY_VENTE = 0, NB_VENTES_VNO = 0, NB_VENTES_VO = 0;
    ...
    public double getAmountFamilleArticle(String lg_FAMILLEARTICLE_ID, String dt_start, String dt_end) {
        ...
        try {
            if (!"".equals(dt_start)) {
                ...
                if (!"".equals(dt_end) && !dt_start.equals(dt_end)) {
                    Date dtend = java.sql.Date.valueOf(dt_end);
                    OBJ = this.getOdataManager().getEm().createQuery("SELECT SUM(o.intPRICE)-SUM(o.intPRICEREMISE) FROM TPreenregistrementDetail o WHERE o.lgFAMILLEID.lgFAMILLEARTICLEID.lgFAMILLEARTICLEID =?1 AND o.lgPREENREGISTREMENTID.intPRICE >0 AND o.lgPREENREGISTREMENTID.bISCANCEL=FALSE  AND o.lgPREENREGISTREMENTID.strSTATUT =?2 AND o.dtCREATED BETWEEN ?3 AND ?4  ", Object.class)
                            .setParameter(1, lg_FAMILLEARTICLE_ID)
                            .setParameter(2, commonparameter.statut_is_Closed)
                            .setParameter(3, dtstart)
                            .setParameter(4, dtend)
                            .getSingleResult();
                } else {
                    OBJ = this.getOdataManager().getEm().createQuery("SELECT SUM(o.intPRICE)-SUM(o.intPRICEREMISE) FROM TPreenregistrementDetail o WHERE o.lgFAMILLEID.lgFAMILLEARTICLEID.lgFAMILLEARTICLEID =?1 AND o.lgPREENREGISTREMENTID.intPRICE >0 AND o.lgPREENREGISTREMENTID.bISCANCEL=FALSE AND o.lgPREENREGISTREMENTID.strSTATUT =?2 AND o.dtCREATED >= ?3 ", Object.class)
                            .setParameter(1, lg_FAMILLEARTICLE_ID)
                            .setParameter(2, commonparameter.statut_is_Closed)
                            .setParameter(3, dtstart).getSingleResult();
                }
                if (OBJ != null) {
    ...
    public List<EntityData> getFamillesArticle(String dt_start, String dt_end, String lg_FAMILLE_ARTICLE_ID, String search_value) {
        Set<TFamille> familles = new HashSet<>();
        List<EntityData> datas = new ArrayList<>();
        try {
    ...
    public List<TPreenregistrementDetail> getFamilleArticleVendueData(String dt_start, String dt_end, String lg_FAMILLE_ARTICLE_ID, String search_value) {
        List<TPreenregistrementDetail> listprePreenregistrements = new ArrayList<>();
        ...
        if (!"".equals(dt_start)) {
            ...
            try {
                if (!"".equals(dt_end) && !dt_start.equals(dt_end)) {
                    ...
                    Date dtend = date.formatterMysql.parse(dt_end);
                    //listprePreenregistrements = this.getOdataManager().getEm().createQuery("SELECT o FROM  TPreenregistrementDetail o WHERE o.dtCREATED BETWEEN ?1 AND ?2  AND  o.lgPREENREGISTREMENTID.intPRICE >0 AND  o.lgPREENREGISTREMENTID.bISCANCEL=FALSE  AND o.lgPREENREGISTREMENTID.strSTATUT =?3  AND o.lgFAMILLEID.lgFAMILLEARTICLEID.lgFAMILLEARTICLEID  LIKE ?4  AND (o.lgFAMILLEID.lgFAMILLEARTICLEID.strLIBELLE LIKE ?5 OR o.lgFAMILLEID.lgFAMILLEARTICLEID.strCODEFAMILLE LIKE ?5) ORDER BY o.lgFAMILLEID.lgFAMILLEARTICLEID.strCODEFAMILLE")

                    listprePreenregistrements = this.getOdataManager().getEm().createQuery("SELECT o FROM  TPreenregistrementDetail o  WHERE o.dtCREATED >= ?1 AND   o.dtCREATED <=?2  AND  o.lgPREENREGISTREMENTID.intPRICE >0 AND  o.lgPREENREGISTREMENTID.bISCANCEL=FALSE  AND o.lgPREENREGISTREMENTID.strSTATUT =?3  AND o.lgFAMILLEID.lgFAMILLEARTICLEID.lgFAMILLEARTICLEID  LIKE ?4  AND (o.lgFAMILLEID.lgFAMILLEARTICLEID.strLIBELLE LIKE ?5 OR o.lgFAMILLEID.lgFAMILLEARTICLEID.strCODEFAMILLE LIKE ?5) ORDER BY o.lgFAMILLEID.lgFAMILLEARTICLEID.strCODEFAMILLE")
                            .setParameter(1, dtstart)
                            .setParameter(2, dtend)
                            .setParameter(3, commonparameter.statut_is_Closed)
                            .setParameter(4, "%" + lg_FAMILLE_ARTICLE_ID + "%")
                            .setParameter(5, search_value + "%")
                            .getResultList();
                    ...
                    listprePreenregistrements = this.getOdataManager().getEm().createQuery("SELECT o FROM  TPreenregistrementDetail o  WHERE o.dtCREATED >= ?1   AND o.lgPREENREGISTREMENTID.intPRICE >0 AND o.lgPREENREGISTREMENTID.strSTATUT =?2 AND o.lgPREENREGISTREMENTID.bISCANCEL=FALSE  AND o.lgFAMILLEID.lgFAMILLEID LIKE ?3 AND (o.lgFAMILLEID.lgFAMILLEARTICLEID.strLIBELLE LIKE ?4 OR o.lgFAMILLEID.lgFAMILLEARTICLEID.strCODEFAMILLE LIKE ?4) ORDER BY o.lgFAMILLEID.lgFAMILLEARTICLEID.strCODEFAMILLE ")
                            .setParameter(1, dtstart)
                            .setParameter(2, commonparameter.statut_is_Closed)
                            .setParameter(3, "%" + lg_FAMILLE_ARTICLE_ID + "%")
                            .setParameter(4, search_value + "%")
                            .getResultList();
                    for (TPreenregistrementDetail detail : listprePreenregistrements) {
                        this.refresh(detail);
    ...
    public List<EntityData> getFamillesArticleVendu(String dt_start, String dt_end, String lg_FAMILLE_ARTICLE_ID, String search_value) {
//        Set<TFamillearticle> familles = new HashSet<>();
        List<EntityData> datas = new ArrayList<>();
        try {

            List<TPreenregistrementDetail> listprePreenregistrements = this.getFamilleArticleVendueData(dt_start, dt_end, lg_FAMILLE_ARTICLE_ID, search_value);
//            List<TPreenregistrementDetail> annuler = findPrevente(dt_start, dt_end);
//            Map<TFamillearticle, List<TPreenregistrementDetail>> mapannuler = annuler.stream().collect(Collectors.groupingBy(a -> a.getLgFAMILLEID().getLgFAMILLEARTICLEID()));
            Map<TFamillearticle, List<TPreenregistrementDetail>> map = listprePreenregistrements.stream().collect(Collectors.groupingBy(a -> a.getLgFAMILLEID().getLgFAMILLEARTICLEID()));
            ...
            for (Map.Entry<TFamillearticle, List<TPreenregistrementDetail>> entry : map.entrySet()) {
                ...
                double MONTANT_TTC = 0,
                        MONTANT_HT = 0,
                        MONTANT_ACHAT = 0,
                        MARGE_NET = 0, MARGE_PERCENT = 0,
                        MONTANT_HT_PERCENT = 0,
                        MONTANT_HT_PERCENT_PERIODE = 0,
                        AMOUNTTVA = 0, TOTALTTC = 0;
                ...
                for (TPreenregistrementDetail ODetail : values) {
                    ...
                    if (ODetail.getIntPRICEREMISE() != null) {
                        ...
                        TOTALHT += (ODetail.getIntPRICE() - ODetail.getIntPRICEREMISE()) / (1 + (Double.valueOf(ODetail.getLgFAMILLEID().getLgCODETVAID().getIntVALUE()) / 100));
                    } else {
                        TOTALHT += (ODetail.getIntPRICE()) / (1 + (Double.valueOf(ODetail.getLgFAMILLEID().getLgCODETVAID().getIntVALUE()) / 100));
                    }

                    if (ODetail.getLgFAMILLEID().getLgFAMILLEARTICLEID().getLgFAMILLEARTICLEID().equals(OFamille.getLgFAMILLEARTICLEID())) {
                        double priceremise = 0;
                        ...
                        MONTANT_HT += (ODetail.getIntPRICE() - priceremise) / (1 + (Double.valueOf(ODetail.getLgFAMILLEID().getLgCODETVAID().getIntVALUE()) / 100));
                    }
                ...
                OEntityData.setStr_value7(new BigDecimal(MONTANT_HT_PERCENT_PERIODE).setScale(2, RoundingMode.HALF_UP).toString());
    ...
    private List<TPreenregistrementDetail> findPrevente(String dt_start, String dt_end, String empl) {
        ...
        try {
            ...
            for (TPreenregistrement preenregistrement : tp) {
                TypedQuery<TPreenregistrementDetail> tq = em.createQuery("SELECT o FROM TPreenregistrementDetail o WHERE o.lgPREENREGISTREMENTID=?1 ", TPreenregistrementDetail.class);
    ...
    private List<TPreenregistrement> montantAnnuler(LocalDate dt_start, LocalDate dt_end, String empl) {
        try {
            Query q = this.getOdataManager().getEm().createQuery("SELECT DISTINCT o.preenregistrement FROM  AnnulationSnapshot o WHERE FUNCTION('DATE',o.dateOp)  BETWEEN ?1 AND ?2 AND o.emplacement.lgEMPLACEMENTID=?3 ");
...
//a revoir pour un probale changement de la tva
    public JSONArray getTvaDatas(String dt_start, String dt_end, String empl) {
        ...
        try {
            ...
            Map<String, List<TPreenregistrementDetail>> map = annuler.stream().collect(Collectors.groupingBy(s -> s.getLgFAMILLEID().getLgCODETVAID().getLgCODETVAID()));

            List<TPreenregistrementDetail> listprePreenregistrementsTVA18 = this.getTvaStatisticDatasByTVA(dt_start, dt_end, "2", empl);
            ...
            array.put(json);
//            MONTANTTTC =0;
            List<TPreenregistrementDetail> listprePreenregistrements = this.getTvaStatisticDatasByTVA(dt_start, dt_end, "1", empl);
    ...
    public JSONArray getTvaData(String dt_start, String dt_end) {
        ...
        try {
            ...
            tvalist = this.getOdataManager().getEm().createQuery("SELECT o FROM TCodeTva o WHERE o.strSTATUT =?1 ORDER BY o.intVALUE DESC")
            ...
            for (TCodeTva OCodeTva : tvalist) {
                ...
                for (TPreenregistrementDetail OPreenregistrementDetail : listprePreenregistrements) {
                    ...
                    if (OCodeTva.getIntVALUE() == OPreenregistrementDetail.getLgFAMILLEID().getLgCODETVAID().getIntVALUE()) {
...
//                        MONTANTTTCOTHER += (OPreenregistrementDetail.getIntPRICEOTHER() != null ? OPreenregistrementDetail.getIntPRICEOTHER() : OPreenregistrementDetail.getIntPRICE());
                    }
                }
                ...
                if (OTParameters != null && Integer.parseInt(OTParameters.getStrVALUE()) == 1 && !dt_start.equalsIgnoreCase(dt_end) && OCodeTva.getIntVALUE() != 0) {
...
//                json.put("Total HT", Math.round((OTParameters != null && Integer.parseInt(OTParameters.getStrVALUE()) == 1 && !dt_start.equals(dt_end) && OCodeTva.getIntVALUE() != 0) ? (MONTANTHT2OTHER + P_SORTIECAISSE_ESPECE_FALSE >= 0 ? MONTANTHT2OTHER + P_SORTIECAISSE_ESPECE_FALSE : MONTANTHT2OTHER) : MONTANTHT2));
//                json.put("Total TVA", (OTParameters != null && Integer.parseInt(OTParameters.getStrVALUE()) == 1 && !dt_start.equals(dt_end) && OCodeTva.getIntVALUE() != 0) ? (TVAOTHER + P_SORTIECAISSE_ESPECE_FALSE >= 0 ? TVAOTHER + P_SORTIECAISSE_ESPECE_FALSE : TVAOTHER) : TVA);
//                json.put("Total TTC", (OTParameters != null && Integer.parseInt(OTParameters.getStrVALUE()) == 1 && !dt_start.equals(dt_end) && OCodeTva.getIntVALUE() != 0) ? (MONTANTTTCOTHER + P_SORTIECAISSE_ESPECE_FALSE >= 0 ? MONTANTTTCOTHER + P_SORTIECAISSE_ESPECE_FALSE : MONTANTTTCOTHER) : MONTANTTTC);
                int_AMOUNT_TVA = Math.round((OTParameters != null && Integer.parseInt(OTParameters.getStrVALUE()) == 1 && !dt_start.equals(dt_end) && OCodeTva.getIntVALUE() != 0)
                        ? (TVAOTHER + P_SORTIECAISSE_ESPECE_FALSE >= 0
                                ? TVAOTHER + P_SORTIECAISSE_ESPECE_FALSE
                                : TVAOTHER)
                        : TVA);
                int_AMOUNT_HT = Math.round((OTParameters != null && Integer.parseInt(OTParameters.getStrVALUE()) == 1 && !dt_start.equals(dt_end) && OCodeTva.getIntVALUE() != 0)
                        ? (TVAOTHER + P_SORTIECAISSE_ESPECE_FALSE >= 0
                                ? (int_AMOUNT_TVA * 100) / OCodeTva.getIntVALUE()
                                : MONTANTHT2OTHER)
                        : MONTANTHT2);
    ...
    private List<TGroupeFamille> getAllGroupeFamilles() {
        return this.getOdataManager().getEm().createQuery("SELECT o FROM TGroupeFamille o ORDER BY o.strCODEGROUPEFAMILLE ASC").getResultList();
    }
    ...
    public List<TBonLivraisonDetail> getABonLivraisonDetails(Date dt_start, Date dt_end, String search_value) {
        ...
        try {
            bonLivraisonDetails = this.getOdataManager().getEm().createQuery("SELECT o FROM TBonLivraisonDetail o WHERE o.strSTATUT=?1 AND o.dtCREATED >=?2 AND o.dtCREATED <=?3 AND (o.lgFAMILLEID.strNAME LIKE ?4 OR o.lgGROSSISTEID.strLIBELLE LIKE ?4 OR o.lgFAMILLEID.lgFAMILLEARTICLEID.strCODEFAMILLE LIKE ?4 OR o.lgFAMILLEID.lgFAMILLEARTICLEID.strLIBELLE LIKE ?4 OR o.lgBONLIVRAISONID.lgUSERID.strFIRSTNAME LIKE ?4 OR o.lgBONLIVRAISONID.lgUSERID.strLASTNAME LIKE ?4)")
                    .setParameter(1, commonparameter.statut_is_Closed)
                    .setParameter(2, dt_start)
                    .setParameter(3, dt_end)
                    .setParameter(4, search_value + "%")
                    .getResultList();
    ...
    public JSONObject achatFournisseur(String search_value, Date dt_start, Date dt_end) throws JSONException {
        ...
        for (TBonLivraisonDetail OData : list) {
            ...
            dataarray.put(OData.getLgBONLIVRAISONID().getLgUSERID().getStrFIRSTNAME().substring(0, 1).toUpperCase() + ". " + OData.getLgBONLIVRAISONID().getLgUSERID().getStrLASTNAME());
    ...
    public JSONArray getFamilleCA_Data(String search_value, String periode, String periode_1) {
        ...
        String query = "SELECT  fa.`str_LIBELLE`, fa.`str_CODE_FAMILLE` ,\n"
                + "(SUM(CASE WHEN (YEAR(d.`dt_CREATED`)='" + periode + "' AND MONTH(d.`dt_CREATED`)='01'  ) THEN  (d.`int_PRICE`-(CASE WHEN d.`int_PRICE_REMISE`!= NULL THEN\n"
                + "                 d.`int_PRICE_REMISE` ELSE 0 END))ELSE 0 END))  AS UN,\n"
                + "(SUM(CASE WHEN (YEAR(d.`dt_CREATED`)='" + periode_1 + "' AND MONTH(d.`dt_CREATED`)='01'  ) THEN  (d.`int_PRICE`-(CASE WHEN d.`int_PRICE_REMISE`!= NULL THEN\n"
                + "                 d.`int_PRICE_REMISE` ELSE 0 END))ELSE 0 END))  AS UN_1,\n"
                + "(SUM(CASE WHEN (YEAR(d.`dt_CREATED`)='" + periode + "' AND MONTH(d.`dt_CREATED`)='02'  ) THEN  (d.`int_PRICE`-(CASE WHEN d.`int_PRICE_REMISE`!= NULL THEN\n"
                + "                 d.`int_PRICE_REMISE` ELSE 0 END))ELSE 0 END))  AS DEUX,\n"
                + "(SUM(CASE WHEN (YEAR(d.`dt_CREATED`)='" + periode_1 + "' AND MONTH(d.`dt_CREATED`)='02'  ) THEN  (d.`int_PRICE`-(CASE WHEN d.`int_PRICE_REMISE`!= NULL THEN\n"
                + "                 d.`int_PRICE_REMISE` ELSE 0 END))ELSE 0 END))  AS DEUX_1,\n"
                + "(SUM(CASE WHEN (YEAR(d.`dt_CREATED`)='" + periode + "' AND MONTH(d.`dt_CREATED`)='03'  ) THEN  (d.`int_PRICE`-(CASE WHEN d.`int_PRICE_REMISE`!= NULL THEN\n"
                + "                 d.`int_PRICE_REMISE` ELSE 0 END))ELSE 0 END))  AS TROIS,\n"
                + "(SUM(CASE WHEN (YEAR(d.`dt_CREATED`)='" + periode_1 + "' AND MONTH(d.`dt_CREATED`)='03'  ) THEN  (d.`int_PRICE`-(CASE WHEN d.`int_PRICE_REMISE`!= NULL THEN\n"
                + "                 d.`int_PRICE_REMISE` ELSE 0 END))ELSE 0 END))  AS TROIS_1,\n"
                + "(SUM(CASE WHEN (YEAR(d.`dt_CREATED`)='" + periode + "' AND MONTH(d.`dt_CREATED`)='04'  ) THEN  (d.`int_PRICE`-(CASE WHEN d.`int_PRICE_REMISE`!= NULL THEN\n"
                + "                 d.`int_PRICE_REMISE` ELSE 0 END))ELSE 0 END))  AS QUATRE,\n"
                + "(SUM(CASE WHEN (YEAR(d.`dt_CREATED`)='" + periode_1 + "' AND MONTH(d.`dt_CREATED`)='04'  ) THEN  (d.`int_PRICE`-(CASE WHEN d.`int_PRICE_REMISE`!= NULL THEN\n"
                + "                 d.`int_PRICE_REMISE` ELSE 0 END))ELSE 0 END))  AS QUATRE_1,\n"
                + "(SUM(CASE WHEN (YEAR(d.`dt_CREATED`)='" + periode + "' AND MONTH(d.`dt_CREATED`)='05'  ) THEN  (d.`int_PRICE`-(CASE WHEN d.`int_PRICE_REMISE`!= NULL THEN\n"
                + "                 d.`int_PRICE_REMISE` ELSE 0 END))ELSE 0 END))  AS CINQ,\n"
                + "(SUM(CASE WHEN (YEAR(d.`dt_CREATED`)='" + periode_1 + "' AND MONTH(d.`dt_CREATED`)='05'  ) THEN  (d.`int_PRICE`-(CASE WHEN d.`int_PRICE_REMISE`!= NULL THEN\n"
                + "                 d.`int_PRICE_REMISE` ELSE 0 END))ELSE 0 END))  AS CINQ_1,\n"
                + "(SUM(CASE WHEN (YEAR(d.`dt_CREATED`)='" + periode + "' AND MONTH(d.`dt_CREATED`)='06'  ) THEN  (d.`int_PRICE`-(CASE WHEN d.`int_PRICE_REMISE`!= NULL THEN\n"
                + "                 d.`int_PRICE_REMISE` ELSE 0 END))ELSE 0 END))  AS SIX,\n"
                + "(SUM(CASE WHEN (YEAR(d.`dt_CREATED`)='" + periode_1 + "' AND MONTH(d.`dt_CREATED`)='06'  ) THEN  (d.`int_PRICE`-(CASE WHEN d.`int_PRICE_REMISE`!= NULL THEN\n"
                + "                 d.`int_PRICE_REMISE` ELSE 0 END))ELSE 0 END))  AS SIX_1,\n"
                + "(SUM(CASE WHEN (YEAR(d.`dt_CREATED`)='" + periode + "' AND MONTH(d.`dt_CREATED`)='07'  ) THEN  (d.`int_PRICE`-(CASE WHEN d.`int_PRICE_REMISE`!= NULL THEN\n"
                + "                 d.`int_PRICE_REMISE` ELSE 0 END))ELSE 0 END))  AS SEPT,\n"
                + "(SUM(CASE WHEN (YEAR(d.`dt_CREATED`)='" + periode_1 + "' AND MONTH(d.`dt_CREATED`)='07'  ) THEN  (d.`int_PRICE`-(CASE WHEN d.`int_PRICE_REMISE`!= NULL THEN\n"
                + "                 d.`int_PRICE_REMISE` ELSE 0 END))ELSE 0 END))  AS SEPT_1,\n"
                + "(SUM(CASE WHEN (YEAR(d.`dt_CREATED`)='" + periode + "' AND MONTH(d.`dt_CREATED`)='08'  ) THEN  (d.`int_PRICE`-(CASE WHEN d.`int_PRICE_REMISE`!= NULL THEN\n"
                + "                 d.`int_PRICE_REMISE` ELSE 0 END))ELSE 0 END))  AS HUIT,\n"
                + "(SUM(CASE WHEN (YEAR(d.`dt_CREATED`)='" + periode_1 + "' AND MONTH(d.`dt_CREATED`)='08'  ) THEN  (d.`int_PRICE`-(CASE WHEN d.`int_PRICE_REMISE`!= NULL THEN\n"
                + "                 d.`int_PRICE_REMISE` ELSE 0 END))ELSE 0 END))  AS HUIT_1,\n"
                + "(SUM(CASE WHEN (YEAR(d.`dt_CREATED`)='" + periode + "' AND MONTH(d.`dt_CREATED`)='09'  ) THEN  (d.`int_PRICE`-(CASE WHEN d.`int_PRICE_REMISE`!= NULL THEN\n"
                + "                 d.`int_PRICE_REMISE` ELSE 0 END))ELSE 0 END))  AS NEUF,\n"
                + "(SUM(CASE WHEN (YEAR(d.`dt_CREATED`)='" + periode_1 + "' AND MONTH(d.`dt_CREATED`)='09'  ) THEN  (d.`int_PRICE`-(CASE WHEN d.`int_PRICE_REMISE`!= NULL THEN\n"
                + "                 d.`int_PRICE_REMISE` ELSE 0 END))ELSE 0 END))  AS NEUF_1,\n"
                + "(SUM(CASE WHEN (YEAR(d.`dt_CREATED`)='" + periode + "' AND MONTH(d.`dt_CREATED`)='10'  ) THEN  (d.`int_PRICE`-(CASE WHEN d.`int_PRICE_REMISE`!= NULL THEN\n"
                + "                 d.`int_PRICE_REMISE` ELSE 0 END))ELSE 0 END))  AS DIX,\n"
                + "(SUM(CASE WHEN (YEAR(d.`dt_CREATED`)='" + periode_1 + "' AND MONTH(d.`dt_CREATED`)='10'  ) THEN  (d.`int_PRICE`-(CASE WHEN d.`int_PRICE_REMISE`!= NULL THEN\n"
                + "                 d.`int_PRICE_REMISE` ELSE 0 END))ELSE 0 END))  AS DIX_1,\n"
                + "(SUM(CASE WHEN (YEAR(d.`dt_CREATED`)='" + periode + "' AND MONTH(d.`dt_CREATED`)='11'  ) THEN  (d.`int_PRICE`-(CASE WHEN d.`int_PRICE_REMISE`!= NULL THEN\n"
                + "                 d.`int_PRICE_REMISE` ELSE 0 END))ELSE 0 END))  AS ONZE,\n"
                + "(SUM(CASE WHEN (YEAR(d.`dt_CREATED`)='" + periode_1 + "' AND MONTH(d.`dt_CREATED`)='11'  ) THEN  (d.`int_PRICE`-(CASE WHEN d.`int_PRICE_REMISE`!= NULL THEN\n"
                + "                 d.`int_PRICE_REMISE` ELSE 0 END))ELSE 0 END))  AS ONZE_1,\n"
                + "(SUM(CASE WHEN (YEAR(d.`dt_CREATED`)='" + periode + "' AND MONTH(d.`dt_CREATED`)='12'  ) THEN  (d.`int_PRICE`-(CASE WHEN d.`int_PRICE_REMISE`!= NULL THEN\n"
                + "                 d.`int_PRICE_REMISE` ELSE 0 END))ELSE 0 END))  AS DOUZE,\n"
                + "(SUM(CASE WHEN (YEAR(d.`dt_CREATED`)='" + periode_1 + "' AND MONTH(d.`dt_CREATED`)='12'  ) THEN  (d.`int_PRICE`-(CASE WHEN d.`int_PRICE_REMISE`!= NULL THEN\n"
                ...
                + "AND p.`str_STATUT`='is_Closed' AND YEAR(p.`dt_CREATED`)='" + periode + "' AND MONTH(p.`dt_CREATED`)='01'\n"
                ...
                + "                f.`lg_FAMILLE_ID`=d.`lg_FAMILLE_ID` AND \n"
                + "                fa.`lg_FAMILLEARTICLE_ID`=f.`lg_FAMILLEARTICLE_ID`  \n"
                + "AND p.`str_STATUT`='is_Closed' AND YEAR(p.`dt_CREATED`)='" + periode_1 + "' AND MONTH(p.`dt_CREATED`)='01'\n"
                ...
                + "                f.`lg_FAMILLE_ID`=d.`lg_FAMILLE_ID` AND \n"
                + "                fa.`lg_FAMILLEARTICLE_ID`=f.`lg_FAMILLEARTICLE_ID`  \n"
                + "AND p.`str_STATUT`='is_Closed' AND YEAR(p.`dt_CREATED`)='" + periode + "' AND MONTH(p.`dt_CREATED`)='02'\n"
                ...
                + "                f.`lg_FAMILLE_ID`=d.`lg_FAMILLE_ID` AND \n"
                + "                fa.`lg_FAMILLEARTICLE_ID`=f.`lg_FAMILLEARTICLE_ID`  \n"
                + "AND p.`str_STATUT`='is_Closed' AND YEAR(p.`dt_CREATED`)='" + periode_1 + "' AND MONTH(p.`dt_CREATED`)='02'\n"
                ...
                + "                f.`lg_FAMILLE_ID`=d.`lg_FAMILLE_ID` AND \n"
                + "                fa.`lg_FAMILLEARTICLE_ID`=f.`lg_FAMILLEARTICLE_ID`  \n"
                + "AND p.`str_STATUT`='is_Closed' AND YEAR(p.`dt_CREATED`)='" + periode + "' AND MONTH(p.`dt_CREATED`)='03'\n"
                ...
                + "                f.`lg_FAMILLE_ID`=d.`lg_FAMILLE_ID` AND \n"
                + "                fa.`lg_FAMILLEARTICLE_ID`=f.`lg_FAMILLEARTICLE_ID`  \n"
                + "AND p.`str_STATUT`='is_Closed' AND YEAR(p.`dt_CREATED`)='" + periode_1 + "' AND MONTH(p.`dt_CREATED`)='03'\n"
                ...
                + "                f.`lg_FAMILLE_ID`=d.`lg_FAMILLE_ID` AND \n"
                + "                fa.`lg_FAMILLEARTICLE_ID`=f.`lg_FAMILLEARTICLE_ID`  \n"
                + "AND p.`str_STATUT`='is_Closed' AND YEAR(p.`dt_CREATED`)='" + periode + "' AND MONTH(p.`dt_CREATED`)='04'\n"
                ...
                + "                f.`lg_FAMILLE_ID`=d.`lg_FAMILLE_ID` AND \n"
                + "                fa.`lg_FAMILLEARTICLE_ID`=f.`lg_FAMILLEARTICLE_ID`  \n"
                + "AND p.`str_STATUT`='is_Closed' AND YEAR(p.`dt_CREATED`)='" + periode_1 + "' AND MONTH(p.`dt_CREATED`)='04'\n"
                ...
                + "                f.`lg_FAMILLE_ID`=d.`lg_FAMILLE_ID` AND \n"
                + "                fa.`lg_FAMILLEARTICLE_ID`=f.`lg_FAMILLEARTICLE_ID`  \n"
                + "AND p.`str_STATUT`='is_Closed' AND YEAR(p.`dt_CREATED`)='" + periode + "' AND MONTH(p.`dt_CREATED`)='05'\n"
                ...
                + "                f.`lg_FAMILLE_ID`=d.`lg_FAMILLE_ID` AND \n"
                + "                fa.`lg_FAMILLEARTICLE_ID`=f.`lg_FAMILLEARTICLE_ID`  \n"
                + "AND p.`str_STATUT`='is_Closed' AND YEAR(p.`dt_CREATED`)='" + periode_1 + "' AND MONTH(p.`dt_CREATED`)='05'\n"
                ...
                + "                f.`lg_FAMILLE_ID`=d.`lg_FAMILLE_ID` AND \n"
                + "                fa.`lg_FAMILLEARTICLE_ID`=f.`lg_FAMILLEARTICLE_ID`  \n"
                + "AND p.`str_STATUT`='is_Closed' AND YEAR(p.`dt_CREATED`)='" + periode + "' AND MONTH(p.`dt_CREATED`)='06'\n"
                ...
                + "                f.`lg_FAMILLE_ID`=d.`lg_FAMILLE_ID` AND \n"
                + "                fa.`lg_FAMILLEARTICLE_ID`=f.`lg_FAMILLEARTICLE_ID`  \n"
                + "AND p.`str_STATUT`='is_Closed' AND YEAR(p.`dt_CREATED`)='" + periode_1 + "' AND MONTH(p.`dt_CREATED`)='06'\n"
                ...
                + "                f.`lg_FAMILLE_ID`=d.`lg_FAMILLE_ID` AND \n"
                + "                fa.`lg_FAMILLEARTICLE_ID`=f.`lg_FAMILLEARTICLE_ID`  \n"
                + "AND p.`str_STATUT`='is_Closed' AND YEAR(p.`dt_CREATED`)='" + periode + "' AND MONTH(p.`dt_CREATED`)='07'\n"
                ...
                + "                f.`lg_FAMILLE_ID`=d.`lg_FAMILLE_ID` AND \n"
                + "                fa.`lg_FAMILLEARTICLE_ID`=f.`lg_FAMILLEARTICLE_ID`  \n"
                + "AND p.`str_STATUT`='is_Closed' AND YEAR(p.`dt_CREATED`)='" + periode_1 + "' AND MONTH(p.`dt_CREATED`)='07'\n"
                ...
                + "                f.`lg_FAMILLE_ID`=d.`lg_FAMILLE_ID` AND \n"
                + "                fa.`lg_FAMILLEARTICLE_ID`=f.`lg_FAMILLEARTICLE_ID`  \n"
                + "AND p.`str_STATUT`='is_Closed' AND YEAR(p.`dt_CREATED`)='" + periode + "' AND MONTH(p.`dt_CREATED`)='08'\n"
                ...
                + "                f.`lg_FAMILLE_ID`=d.`lg_FAMILLE_ID` AND \n"
                + "                fa.`lg_FAMILLEARTICLE_ID`=f.`lg_FAMILLEARTICLE_ID`  \n"
                + "AND p.`str_STATUT`='is_Closed' AND YEAR(p.`dt_CREATED`)='" + periode_1 + "' AND MONTH(p.`dt_CREATED`)='08'\n"
                ...
                + "                f.`lg_FAMILLE_ID`=d.`lg_FAMILLE_ID` AND \n"
                + "                fa.`lg_FAMILLEARTICLE_ID`=f.`lg_FAMILLEARTICLE_ID`  \n"
                + "AND p.`str_STATUT`='is_Closed' AND YEAR(p.`dt_CREATED`)='" + periode + "' AND MONTH(p.`dt_CREATED`)='09'\n"
                ...
                + "                f.`lg_FAMILLE_ID`=d.`lg_FAMILLE_ID` AND \n"
                + "                fa.`lg_FAMILLEARTICLE_ID`=f.`lg_FAMILLEARTICLE_ID`  \n"
                + "AND p.`str_STATUT`='is_Closed' AND YEAR(p.`dt_CREATED`)='" + periode_1 + "' AND MONTH(p.`dt_CREATED`)='09'\n"
                ...
                + "                f.`lg_FAMILLE_ID`=d.`lg_FAMILLE_ID` AND \n"
                + "                fa.`lg_FAMILLEARTICLE_ID`=f.`lg_FAMILLEARTICLE_ID`  \n"
                + "AND p.`str_STATUT`='is_Closed' AND YEAR(p.`dt_CREATED`)='" + periode + "' AND MONTH(p.`dt_CREATED`)='10'\n"
                ...
                + "                f.`lg_FAMILLE_ID`=d.`lg_FAMILLE_ID` AND \n"
                + "                fa.`lg_FAMILLEARTICLE_ID`=f.`lg_FAMILLEARTICLE_ID`  \n"
                + "AND p.`str_STATUT`='is_Closed' AND YEAR(p.`dt_CREATED`)='" + periode_1 + "' AND MONTH(p.`dt_CREATED`)='10'\n"
                ...
                + "                f.`lg_FAMILLE_ID`=d.`lg_FAMILLE_ID` AND \n"
                + "                fa.`lg_FAMILLEARTICLE_ID`=f.`lg_FAMILLEARTICLE_ID`  \n"
                + "AND p.`str_STATUT`='is_Closed' AND YEAR(p.`dt_CREATED`)='" + periode + "' AND MONTH(p.`dt_CREATED`)='11'\n"
                ...
                + "                f.`lg_FAMILLE_ID`=d.`lg_FAMILLE_ID` AND \n"
                + "                fa.`lg_FAMILLEARTICLE_ID`=f.`lg_FAMILLEARTICLE_ID`  \n"
                + "AND p.`str_STATUT`='is_Closed' AND YEAR(p.`dt_CREATED`)='" + periode_1 + "' AND MONTH(p.`dt_CREATED`)='11'\n"
                ...
                + "                f.`lg_FAMILLE_ID`=d.`lg_FAMILLE_ID` AND \n"
                + "                fa.`lg_FAMILLEARTICLE_ID`=f.`lg_FAMILLEARTICLE_ID`  \n"
                + "AND p.`str_STATUT`='is_Closed' AND YEAR(p.`dt_CREATED`)='" + periode + "' AND MONTH(p.`dt_CREATED`)='12'\n"
                ...
                + "                f.`lg_FAMILLE_ID`=d.`lg_FAMILLE_ID` AND \n"
                + "                fa.`lg_FAMILLEARTICLE_ID`=f.`lg_FAMILLEARTICLE_ID`  \n"
                + "AND p.`str_STATUT`='is_Closed' AND YEAR(p.`dt_CREATED`)='" + periode_1 + "' AND MONTH(p.`dt_CREATED`)='12'\n"
        ...
        try {
            ...
            double deux = 0, deux_1 = 0, total_deux = 0, total_deux_1 = 0, deux_pr = 0, deux_percent = 0, deux_1_percent = 0;
            double trois = 0, trois_1 = 0, total_trois = 0, total_trois_1 = 0, trois_pr = 0, trois_percent = 0, trois_1_percent = 0;
            double quatre = 0, quatre_1 = 0, total_quatre = 0, total_quatre_1 = 0, quatre_pr = 0, quatre_percent = 0, quatre_1_percent = 0;
            double cinq = 0, cinq_1 = 0, total_cinq = 0, total_cinq_1 = 0, cinq_pr = 0, cinq_percent = 0, cinq_1_percent = 0;
            double six = 0, six_1 = 0, total_six = 0, total_six_1 = 0, six_pr = 0, six_percent = 0, six_1_percent = 0;
            double sept = 0, sept_1 = 0, total_sept = 0, total_sept_1 = 0, sept_pr = 0, sept_percent = 0, sept_1_percent = 0;
            double huit = 0, huit_1 = 0, total_huit = 0, total_huit_1 = 0, huit_pr = 0, huit_percent = 0, huit_1_percent = 0;
            double neuf = 0, neuf_1 = 0, total_neuf = 0, total_neuf_1 = 0, neuf_pr = 0, neuf_percent = 0, neuf_1_percent = 0;
            double dix = 0, dix_1 = 0, total_dix = 0, total_dix_1 = 0, dix_pr = 0, dix_percent = 0, dix_1_percent = 0;
            double onze = 0, onze_1 = 0, total_onze = 0, total_onze_1 = 0, onze_pr = 0, onze_percent = 0, onze_1_percent = 0;
            double douze = 0, douze_1 = 0, total_douze = 0, total_douze_1 = 0, douze_pr = 0, douze_percent = 0, douze_1_percent = 0;
            int count = 0;
            for (Object[] data : ob) {
                JSONObject json = new JSONObject();
                json.put("id", count);
    ...
    public List<EntityData> getAllShopRuptureStocks(String searchvalue, String dt_start, String dt_end) {
        List<EntityData> datas = new ArrayList<>();
        try {
            List<Object[]> list = this.getOdataManager().getEm().createNativeQuery("SELECT o.* FROM v_rp_rupture_stock o WHERE DATE(o.`dt_CREATED`)>='" + dt_start + "' AND DATE(o.`dt_CREATED`)<='" + dt_end + "' AND (o.`str_NAME` LIKE '%" + searchvalue + "%' OR o.`int_CIP` LIKE '%" + searchvalue + "%')")
                    .getResultList();
    ...
    public List<EntityData> getAnalyseVenteStockData(String dt_start, String dt_end, String search_value) {
        List<EntityData> datas = new ArrayList<>();
        try {
            List<Object[]> list = this.getOdataManager().getEm().createNativeQuery("CALL  `proc_analyseventestock`(?1,?2,?3)")
    ...
    public List<EntityData> getAChatProduct(String dt_start, String dt_end, String search_value, int start, int limit) {
        List<EntityData> datas = new ArrayList<>();
        try {
            List<Object[]> list = this.getOdataManager().getEm().createNativeQuery("CALL  `proc_statventeachat`(?1,?2,?3,?4,?5)")
                    .setParameter(1, dt_start)
                    .setParameter(2, dt_end)
                    .setParameter(3, search_value + "%")
    ...
    public List<EntityData> getAChatFournisseurs(String dt_start, String dt_end, String search_value) {
        List<EntityData> datas = new ArrayList<>();
        try {
            List<Object[]> list = this.getOdataManager().getEm().createNativeQuery("CALL  `proc_statachatfournisseur`(?1,?2,?3)")
                    .setParameter(1, dt_start)
                    .setParameter(2, dt_end)
                    .setParameter(3, search_value + "%")
                    .getResultList();
    ...
    public long getVenteSocietesClientCount(String dt_start, String dt_end, String search_value, String type_tierspayant) {
        String query = "SELECT COUNT(*) FROM t_snap_shop_vente_societe o WHERE YEAR(o.`dt_DAY`) >=YEAR('" + dt_start + "') AND YEAR(o.`dt_DAY`)<=YEAR('" + dt_end + "') AND  o.`str_TYPE_TIERS_PAYANT`='" + type_tierspayant + "' AND o.`str_TIERS_PAYANT` LIKE '" + search_value + "%' GROUP BY o.`str_TIERS_PAYANT` ,YEAR(o.`dt_DAY`)";
    ...
    public List<EntityData> getVenteSocietesClientData(String dt_start, String dt_end, String search_value, int start, int limit) {
        List<EntityData> datas = new ArrayList<>();
        try {//*
            List<Object[]> list = this.getOdataManager().getEm().createNativeQuery("CALL  `proc_ventesocietereglement`(?1,?2,?3,?4,?5)")
                    .setParameter(1, dt_start)
                    .setParameter(2, dt_end)
                    .setParameter(3, search_value + "%")
                    .setParameter(4, start)
    ...
    public List<EntityData> getVenteAvoirClientData(String dt_start, String dt_end, String search_value, int start, int limit) {
        List<EntityData> datas = new ArrayList<>();
        try {
            List<Object[]> list = this.getOdataManager().getEm().createNativeQuery("CALL  `proc_venteavoirclient`(?1,?2,?3,?4,?5)")
                    .setParameter(1, dt_start)
                    .setParameter(2, dt_end)
                    .setParameter(3, search_value + "%")
                    .setParameter(4, start)
    ...
    public List<EntityData> getRetrocessionData(String dt_start, String dt_end, String search_value) {
        List<EntityData> datas = new ArrayList<>();
        try {
            List<Object[]> list = this.getOdataManager().getEm().createNativeQuery("CALL  `proc_statretrocession`(?1,?2,?3)")
                    .setParameter(1, dt_start)
                    .setParameter(2, dt_end)
                    .setParameter(3, search_value + "%")
                    .getResultList();
    ...
    public List<EntityData> getRecapReglementByOrganismeData(String dt_start, String dt_end, String lg_tiers_payant_id, String search_value) {
        List<EntityData> datas = new ArrayList<>();
        String req = "CALL proc_recaptulatif_organisme(?1,?2,?3,?4)";
        try {
            List<Object[]> list = this.getOdataManager().getEm().createNativeQuery(req)
                    .setParameter(1, dt_start).setParameter(2, dt_end).setParameter(3, search_value + "%").
    ...
    public List<EntityData> statisticArticleVendue(String search_value, int start, int limit, String dt_start, String dt_end) {
        List<EntityData> datas = new ArrayList<>();
        String query = "SELECT SUM(pd.`int_QUANTITY`)AS QTYVENDU,COUNT(`pd`.`lg_PREENREGISTREMENT_DETAIL_ID`)AS QTYSORTIE,\n"
                ...
                + "AND p.`b_IS_CANCEL`=0 AND DATE(p.`dt_CREATED`)>=DATE('" + dt_start + "')  AND DATE(p.`dt_CREATED`)<=DATE('" + dt_end + "') "
                + "AND p.`int_PRICE`>0 AND p.`b_IS_CANCEL`=0 AND p.`str_STATUT`='is_Closed'\n"
                + "AND (f.`str_NAME` LIKE '" + search_value + "' OR fa.`str_CODE_FAMILLE` LIKE '" + search_value + "' OR fa.`str_LIBELLE` LIKE '" + search_value + "'  OR f.`int_CIP` LIKE '" + search_value + "') AND s.lg_EMPLACEMENT_ID LIKE '" + this.getOTUser().getLgEMPLACEMENTID().getLgEMPLACEMENTID() + "'\n"
    ...
    public long getStatisticVenteCount(String search_value, String dt_start, String dt_end) {
        ...
        try {
            String query = "SELECT  COUNT( DISTINCT f.`lg_FAMILLE_ID`) FROM  t_preenregistrement_detail pd,t_preenregistrement p,t_famille f  ,t_famillearticle fa \n"
                    ...
                    + "AND (f.`str_NAME` LIKE '" + search_value + "' OR fa.`str_CODE_FAMILLE` LIKE '" + search_value + "' OR fa.`str_LIBELLE` LIKE '" + search_value + "' OR f.`int_CIP` LIKE '" + search_value + "')";
    ...
    public long getAChatProductCount(String dt_start, String dt_end, String search_value) {
        ...
        long count = 0l;
        try {
            List list = this.getOdataManager().getEm().createNativeQuery(query)
                    .setParameter(1, dt_start)
                    .setParameter(2, dt_end)
                    .setParameter(3, search_value + "%")
                    .getResultList();
    ...
    public List<EntityData> getVenteSocietesClient(String dt_start, String dt_end, String search_value) {
        ...
        String query = "SELECT o.`str_TIERS_PAYANT`, YEAR(o.`dt_DAY`), (SELECT SUM(p.`int_AMOUNT_SALE`) FROM t_snap_shop_vente_societe p WHERE MONTH (p.`dt_DAY`)='1' \n"
                ...
                + "AND YEAR(p.`dt_DAY`)=YEAR(o.`dt_DAY`) AND p.`str_TIERS_PAYANT`=o.`str_TIERS_PAYANT`)  \n"
                + "AS REGDEC\n"
                + "FROM t_snap_shop_vente_societe o WHERE  o.`dt_DAY`>='" + dt_start + "' AND o.`dt_DAY`<='" + dt_end + "' AND o.`str_TYPE_TIERS_PAYANT`='1' AND o.`str_TIERS_PAYANT` LIKE '" + search_value + "'"
        ...
        try {
            ...
            for (Object[] objects : list) {
                EntityData entityData = new EntityData();
                double _v1 = 0, _r1 = 0, _v2 = 0, _r2 = 0, _v3 = 0, _r3 = 0, _v4 = 0,
                        _r4 = 0, _v5 = 0, _r5 = 0, _v6 = 0, _r6 = 0, _v7 = 0, _r7 = 0, _v8 = 0,
                        _r8 = 0, _v9 = 0, _r9 = 0, _v10 = 0, _r10 = 0, _v11 = 0, _r11 = 0, _v12 = 0, _r12 = 0;

                entityData.setStr_value2(objects[0] + "");
                entityData.setStr_value1(objects[1] + "");
                entityData.setStr_value3(objects[2] != null ? objects[2] + "" : 0 + "_" + objects[3] != null ? objects[3] + "" : "0");
                entityData.setStr_value4(objects[4] != null ? objects[4] + "" : 0 + "_" + objects[5] != null ? objects[5] + "" : "0");
                entityData.setStr_value5(objects[6] != null ? objects[6] + "" : 0 + "_" + objects[7] != null ? objects[7] + "" : "0");
                entityData.setStr_value6(objects[8] != null ? objects[8] + "" : 0 + "_" + objects[9] != null ? objects[9] + "" : "0");
                entityData.setStr_value7(objects[10] != null ? objects[10] + "" : 0 + "_" + objects[11] != null ? objects[11] + "" : "0");
                entityData.setStr_value8(objects[12] != null ? objects[12] + "" : 0 + "_" + objects[13] != null ? objects[13] + "" : "0");
                entityData.setStr_value9(objects[14] != null ? objects[14] + "" : 0 + "_" + objects[15] != null ? objects[15] + "" : "0");
                entityData.setStr_value10(objects[16] != null ? objects[16] + "" : 0 + "_" + objects[17] != null ? objects[17] + "" : "0");
                entityData.setStr_value11(objects[18] != null ? objects[18] + "" : 0 + "_" + objects[19] != null ? objects[19] + "" : "0");
                entityData.setStr_value12(objects[20] != null ? objects[20] + "" : 0 + "_" + objects[21] != null ? objects[21] + "" : "0");
                entityData.setStr_value13(objects[22] != null ? objects[22] + "" : 0 + "_" + objects[23] != null ? objects[23] + "" : "0");
                entityData.setStr_value14(objects[24] != null ? objects[24] + "" : 0 + "_" + objects[25] != null ? objects[25] + "" : "0");
                datas.add(entityData);
    ...
    public long getRecapReglementByOrganismeCount(String dt_start, String dt_end, String lg_tiers_payant_id, String search_value) {
        long count = 0l, result = 0l;
        String req = "SELECT COUNT(t.`str_FULLNAME`) FROM t_dossier_reglement d,t_tiers_payant t,t_type_tiers_payant p WHERE  t.`lg_TIERS_PAYANT_ID`=d.`str_ORGANISME_ID`  AND p.`lg_TYPE_TIERS_PAYANT_ID`=t.`lg_TYPE_TIERS_PAYANT_ID` AND DATE(d.`dt_CREATED`)>=DATE('" + dt_start + "') AND DATE(d.`dt_CREATED`) <=DATE('" + dt_end + "') "
                + " AND t.`lg_TIERS_PAYANT_ID` LIKE '" + lg_tiers_payant_id + "' AND (t.`str_FULLNAME` LIKE '" + search_value + "%' OR p.`str_LIBELLE_TYPE_TIERS_PAYANT` LIKE '" + search_value + "%') GROUP BY t.`str_FULLNAME`";
        try {
            List list = this.getOdataManager().getEm().createNativeQuery(req)
                    .getResultList();
            count = list.size();
    ...
    private long getRecapReglementByOrganismeCount(String lg_tiers_payant_id, String search_value) {
        ...
        String req = "SELECT COUNT(t.`str_FULLNAME`)    from t_preenregistrement_compte_client_tiers_payent pr,\n"
                ...
                + " AND (t.`str_FULLNAME` LIKE '" + search_value + "%' OR tp.`str_LIBELLE_TYPE_TIERS_PAYANT` LIKE '" + search_value + "%' ) AND t.`lg_TIERS_PAYANT_ID` LIKE '" + lg_tiers_payant_id + "' "
    ...
    public List<TPreenregistrementDetail> getTvaStatisticData(String dt_start, String dt_end) {
        ...
        try {
            ...
            listprePreenregistrements = this.getOdataManager().getEm().createQuery("SELECT o FROM  TPreenregistrementDetail o WHERE   FUNCTION('DATE',o.dtCREATED) >= ?1  AND FUNCTION('DATE',o.dtCREATED) <= ?2  AND  o.lgPREENREGISTREMENTID.intPRICE >0 AND o.lgPREENREGISTREMENTID.strSTATUT =?3 AND o.lgPREENREGISTREMENTID.bISCANCEL=FALSE   AND o.lgPREENREGISTREMENTID.lgTYPEVENTEID.lgTYPEVENTEID <> ?4 ")
                    .setParameter(1, dtstart)
                    .setParameter(2, dtend)
                    .setParameter(3, commonparameter.statut_is_Closed)
                    .setParameter(4, Parameter.VENTE_DEPOT_EXTENSION)
                    .getResultList();
    ...
    public long getVenteClientCount(String dt_start, String dt_end, String search_value) {
        ...
        String query = "SELECT COUNT(*) FROM t_snap_shop_vente_client o WHERE YEAR(o.`dt_DAY`) >=YEAR('" + dt_start + "') AND YEAR(o.`dt_DAY`)<=YEAR('" + dt_end + "')  AND o.`lg_CLIENT_ID` LIKE  '" + lgClient + "%' GROUP BY o.`lg_CLIENT_ID` ,YEAR(o.`dt_DAY`)";
    ...
    private TClient findClient(String criteria) {
        ...
        try {
            client = (TClient) this.getOdataManager().getEm().createQuery("SELECT o FROM TClient o WHERE (o.strFIRSTNAME  LIKE ?1 OR o.strLASTNAME  LIKE ?1 OR o.strCODEINTERNE LIKE ?1 OR o.strNUMEROSECURITESOCIAL LIKE ?1 OR CONCAT(o.strFIRSTNAME,' ',o.strLASTNAME) LIKE ?1)    ")
            ...
            for (TCodeTva OCodeTva : tvalist) {
                ...
                for (TPreenregistrementDetail OPreenregistrementDetail : listprePreenregistrements) {
                    ...
                    if (OCodeTva.getIntVALUE() == OPreenregistrementDetail.getLgFAMILLEID().getLgCODETVAID().getIntVALUE()) {
                        ...
                        MONTANTTTC += OPreenregistrementDetail.getIntPRICE();
                        System.out.println("OPreenregistrementDetail " + OPreenregistrementDetail + " @@@@@@@@@ " + OPreenregistrementDetail.getIntPRICEOTHER());
...
//            Join<TPreenregistrementDetail, TFamille> f = root.join("lgFAMILLEID", JoinType.INNER);
    ...
    public List<TPreenregistrementDetail> getTvaStatisticDatas(String dt_start, String dt_end, boolean KEYTAKEINTOACCOUNT) {
        List<TPreenregistrementDetail> listprePreenregistrements = new ArrayList<>();
...
// fonction  a revoir
    ...
    public List<TPreenregistrementDetail> getTvaStatisticDatasByTVA(String dt_start, String dt_end, String tva, String empl) {
        List<TPreenregistrementDetail> listprePreenregistrements = new ArrayList<>();
        ...
        try {
            ...
            predicate = cb.and(predicate, cb.notLike(join.get("lgTYPEVENTEID").get("lgTYPEVENTEID"), Parameter.VENTE_DEPOT_EXTENSION));
            predicate = cb.and(predicate, cb.equal(root.get("lgPREENREGISTREMENTID").get("lgUSERID").get("lgEMPLACEMENTID").get("lgEMPLACEMENTID"), empl));
            Predicate ge = cb.greaterThan(join.get(TPreenregistrement_.intPRICE), 0);
            predicate = cb.and(predicate, ge);
