...
public class ReportDataSource {
   ...
   static final DateFormat DATEFORMATYYYY = new SimpleDateFormat("yyyy-MM-dd");
    ...
    public static boolean generateJSON(String lgFACTURE, String fileName) {
        ...
        Map<TPreenregistrement, List<TPreenregistrementCompteClientTiersPayent>> mapList = clientTiersPayents.stream().sorted((e1, e2) -> e1.getLgCOMPTECLIENTTIERSPAYANTID().getLgCOMPTECLIENTID().getLgCLIENTID().getStrFIRSTNAME().compareToIgnoreCase(e2.getLgCOMPTECLIENTTIERSPAYANTID().getLgCOMPTECLIENTID().getLgCLIENTID().getStrFIRSTNAME())).collect(Collectors.groupingBy(s -> s.getLgPREENREGISTREMENTID()));
        ...
        clientTiersPayents.forEach((ps) -> {
            ...
            try {
                ...
                other = getROPreenregistrement(op.getLgPREENREGISTREMENTID(), ps.getLgPREENREGISTREMENTCOMPTECLIENTPAYENTID());
                ...
                try {
                    ...
                    line.putOnce("SALARIE", (cm.getStrNUMEROSECURITESOCIAL() != null ? cm.getStrNUMEROSECURITESOCIAL() : ""));
...
//                line.put("Date", DATEFORMAT.format(op.getDtUPDATED()));
    ...
    public static Map<String, Object> getParametters(String lg_FACTURE_ID) {
        ...
        try {
            ...
            TTypeMvtCaisse OTypeMvtCaisse = em.find(TTypeMvtCaisse.class, OFacture.getLgTYPEFACTUREID().getLgTYPEFACTUREID());
    ...
    public static TPreenregistrementCompteClientTiersPayent getROPreenregistrement(String idVente, String lgPree) {
        ...
        try {
            EntityManager em = getEntityManager();
            payent = em.createQuery("SELECT o FROM TPreenregistrementCompteClientTiersPayent o WHERE o.lgPREENREGISTREMENTID.lgPREENREGISTREMENTID=?1 AND o.lgPREENREGISTREMENTCOMPTECLIENTPAYENTID <> ?2", TPreenregistrementCompteClientTiersPayent.class)
                    .setParameter(1, idVente).setParameter(2, lgPree).getSingleResult();
        } catch (Exception e) {
//            e.printStackTrace();
        }
        return payent;
