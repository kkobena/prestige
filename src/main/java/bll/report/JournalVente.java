...
public class JournalVente extends bll.bllBase {
    ...
    /*   public List<TCashTransaction> func_GetDataFromCash(Date dt_date_debut, Date dt_date_fin) {
     ...
     .setParameter(3, dt_date_debut).setParameter(4, dt_date_fin).getResultList();
    ...
    public List<TCashTransaction> func_GetDataFromCash(Date dt_date_debut, Date dt_date_fin) {
        ...
        try {
            ...
            // String qry = "SELECT str_RESSOURCE_REF, dt_CREATED, str_TYPE_VENTE, int_AMOUNT_CREDIT, lg_REGLEMENT_ID, lg_MOTIF_REGLEMENT_ID FROM t_cash_transaction t WHERE t.dt_CREATED > '"+OdateDebut+"'  AND t.dt_CREATED <= '"+OdateFin+"'";

            String qry = "SELECT str_RESSOURCE_REF, dt_CREATED, str_TYPE_VENTE, int_AMOUNT_CREDIT, lg_REGLEMENT_ID, lg_MOTIF_REGLEMENT_ID, SUM(int_AMOUNT) AS int_AMOUNT_TOTAL FROM t_cash_transaction t WHERE t.dt_CREATED > '" + OdateDebut + "' AND t.dt_CREATED <= '" + OdateFin + "' GROUP BY str_RESSOURCE_REF ORDER BY str_TYPE_VENTE, dt_CREATED DESC";
            ...
            while (Ojconnexion.get_resultat().next()) {
                ...
                OTCashTransaction.setDtCREATED(this.getKey().stringToDate(Ojconnexion.get_resultat().getString("dt_CREATED")));
                ...
                OTCashTransaction.setIntAMOUNT(Integer.parseInt(Ojconnexion.get_resultat().getString("int_AMOUNT_TOTAL")));

                try {
                    TReglement OTReglement = this.getOdataManager().getEm().find(TReglement.class, Ojconnexion.get_resultat().getString("lg_REGLEMENT_ID"));
                    TMotifReglement OTMotifReglement = this.getOdataManager().getEm().find(TMotifReglement.class, Ojconnexion.get_resultat().getString("lg_MOTIF_REGLEMENT_ID"));
...
//            String qry = "SELECT str_RESSOURCE_REF, dt_CREATED, str_TYPE_VENTE, int_AMOUNT , lg_REGLEMENT_ID, lg_MOTIF_REGLEMENT_ID, SUM(int_AMOUNT_CREDIT) AS  int_AMOUNT_CREDIT   , SUM(int_AMOUNT_DEBIT) AS int_AMOUNT_DEBIT FROM t_cash_transaction t WHERE t.dt_CREATED > '" + OdateDebut + "' AND t.dt_CREATED <= '" + OdateFin + "' AND int_AMOUNT_DEBIT <=0  GROUP BY str_RESSOURCE_REF ORDER BY str_TYPE_VENTE, dt_CREATED DESC";
            String qry = "SELECT str_RESSOURCE_REF, dt_CREATED, str_TYPE_VENTE, int_AMOUNT , lg_REGLEMENT_ID, lg_MOTIF_REGLEMENT_ID, SUM(int_AMOUNT_CREDIT) AS  int_AMOUNT_CREDIT   , SUM(int_AMOUNT_DEBIT) AS int_AMOUNT_DEBIT FROM t_cash_transaction t WHERE t.dt_CREATED > '" + OdateDebut + "' AND t.dt_CREATED <= '" + OdateFin + "' GROUP BY str_RESSOURCE_REF ORDER BY str_TYPE_VENTE, dt_CREATED DESC";
            new logger().OCategory.info(qry);
            Ojconnexion.set_Request(qry);
            ResultSetMetaData rsmddatas = Ojconnexion.get_resultat().getMetaData();
            while (Ojconnexion.get_resultat().next()) {
                ...
                OTCashTransaction.setStrTYPEVENTE(Ojconnexion.get_resultat().getString("str_TYPE_VENTE"));
                OTCashTransaction.setIntAMOUNTCREDIT(Integer.parseInt(Ojconnexion.get_resultat().getString("int_AMOUNT_CREDIT")));
                OTCashTransaction.setIntAMOUNTDEBIT(Integer.parseInt(Ojconnexion.get_resultat().getString("int_AMOUNT_DEBIT")));
    ...
    public List<TCashTransaction> func_GetDataFromCashB(String OdateDebut, String OdateFin) {
        ...
        try {
            ...
            String qry = "SELECT str_RESSOURCE_REF, lg_TYPE_REGLEMENT_ID, lg_USER_ID, dt_CREATED, str_TYPE_VENTE, int_AMOUNT_CREDIT, lg_REGLEMENT_ID, lg_MOTIF_REGLEMENT_ID, SUM(int_AMOUNT_CREDIT) AS int_AMOUNT_TOTAL FROM t_cash_transaction t WHERE t.dt_CREATED > '" + OdateDebut + "' AND t.dt_CREATED <= '" + OdateFin + "' GROUP BY str_RESSOURCE_REF ORDER BY str_TYPE_VENTE, dt_CREATED DESC";
            new logger().OCategory.info(qry);
            Ojconnexion.set_Request(qry);
            ResultSetMetaData rsmddatas = Ojconnexion.get_resultat().getMetaData();
            while (Ojconnexion.get_resultat().next()) {
                if (Integer.parseInt(Ojconnexion.get_resultat().getString("int_AMOUNT_CREDIT")) > 0) {
                    ...
                    try {
                        TReglement OTReglement = this.getOdataManager().getEm().find(TReglement.class, Ojconnexion.get_resultat().getString("lg_REGLEMENT_ID"));
                        TMotifReglement OTMotifReglement = this.getOdataManager().getEm().find(TMotifReglement.class, Ojconnexion.get_resultat().getString("lg_MOTIF_REGLEMENT_ID"));
                        TUser OTUser = this.getOdataManager().getEm().find(TUser.class, Ojconnexion.get_resultat().getString("lg_USER_ID"));
    ...
    public List<TCashTransaction> func_GetDataFromCash(String dt_date_debut, String dt_date_fin, String h_debut, String h_fin) {
...
//            String qry = "select * from t_cash_transaction where (t_cash_transaction.dt_CREATED >= '" + dt_date_debut + "' and t_cash_transaction.dt_CREATED <= '" + dt_date_fin + "') AND (TIME(t_cash_transaction.dt_CREATED) >= '" + h_debut + "' and TIME(t_cash_transaction.dt_CREATED) <= '" + h_fin + "') order by t_cash_transaction.str_TYPE_VENTE,t_cash_transaction.dt_CREATED DESC";
            String qry = "select *, SUM(t_cash_transaction.int_AMOUNT) AS int_AMOUNT_TOTAL from t_cash_transaction where (t_cash_transaction.dt_CREATED >= '" + dt_date_debut + "' and t_cash_transaction.dt_CREATED <= '" + dt_date_fin + "') GROUP BY t_cash_transaction.str_RESSOURCE_REF order by t_cash_transaction.str_TYPE_VENTE,t_cash_transaction.dt_CREATED DESC";
            ...
            while (Ojconnexion.get_resultat().next()) {
                ...
                OTCashTransaction.setLgMOTIFREGLEMENTID(this.getOdataManager().getEm().find(TMotifReglement.class, Ojconnexion.get_resultat().getString("lg_MOTIF_REGLEMENT_ID")));
                OTCashTransaction.setStrTYPEVENTE(Ojconnexion.get_resultat().getString("str_TYPE_VENTE"));
                OTCashTransaction.setStrRESSOURCEREF(Ojconnexion.get_resultat().getString("str_RESSOURCE_REF"));
                OTCashTransaction.setDtCREATED(this.getKey().stringToDate(Ojconnexion.get_resultat().getString("dt_CREATED")));
                OTCashTransaction.setIntAMOUNTCREDIT(Integer.parseInt(Ojconnexion.get_resultat().getString("int_AMOUNT_CREDIT")));
    ...
    public List<TCashTransaction> func_GetDataFromCashBis(String OdateDebut, String OdateFin) {
        ...
        try {
            ...
            Ojconnexion.OpenConnexion();
            // String qry = "SELECT str_RESSOURCE_REF, dt_CREATED, str_TYPE_VENTE, int_AMOUNT_CREDIT, lg_REGLEMENT_ID, lg_MOTIF_REGLEMENT_ID FROM t_cash_transaction t WHERE t.dt_CREATED > '"+OdateDebut+"'  AND t.dt_CREATED <= '"+OdateFin+"'";
            String qry = "SELECT str_RESSOURCE_REF, dt_CREATED, str_TYPE_VENTE, int_AMOUNT_CREDIT, lg_REGLEMENT_ID, lg_MOTIF_REGLEMENT_ID, SUM(int_AMOUNT_CREDIT) AS int_AMOUNT_TOTAL FROM t_cash_transaction t WHERE t.dt_CREATED > '" + OdateDebut + "' AND t.dt_CREATED <= '" + OdateFin + "' GROUP BY str_RESSOURCE_REF ORDER BY str_TYPE_VENTE, dt_CREATED DESC";
            new logger().OCategory.info(qry);
            Ojconnexion.set_Request(qry);
            ResultSetMetaData rsmddatas = Ojconnexion.get_resultat().getMetaData();
            while (Ojconnexion.get_resultat().next()) {
    ...
    public List<TPreenregistrementCompteClientTiersPayent> func_GetDataTiersPayant(TCashTransaction OTCashTransaction, TMotifReglement OTMotifReglement) {
        ...
        if (OTMotifReglement.getLgMOTIFREGLEMENTID().equals("1")) {
            /*new logger().OCategory.info("ref " + OTCashTransaction.getStrRESSOURCEREF());
             new logger().OCategory.info("type vente " + OTCashTransaction.getStrTYPEVENTE());
             new logger().OCategory.info("heure " + date.getTime(OTCashTransaction.getDtCREATED()));
             new logger().OCategory.info("ref " + OTCashTransaction.getStrRESSOURCEREF());
             new logger().OCategory.info("code operateur " + OTUser.getStrFIRSTNAME() + "  " + OTUser.getStrLASTNAME());
             new logger().OCategory.info("ref " + OTCashTransaction.getStrRESSOURCEREF());
             new logger().OCategory.info("int_amount " + OTCashTransaction.getIntAMOUNTCREDIT());*/
            ...
            if (OTCashTransaction.getStrTYPEVENTE().equals("VO")) {
                ...
                try {
                    ...
                    LstTPreenregistrementCompteClientTiersPayent = this.getOdataManager().getEm().createQuery(" SELECT t FROM TPreenregistrementCompteClientTiersPayent t WHERE t.lgPREENREGISTREMENTID.lgPREENREGISTREMENTID LIKE ?1")
                    ...
                    for (TPreenregistrementCompteClientTiersPayent OTPreenregistrementCompteClientTiersPayentFinal : LstTPreenregistrementCompteClientTiersPayent) {
                        if (OTPreenregistrementCompteClientTiersPayentFinal.getLgCOMPTECLIENTTIERSPAYANTID().getBISRO().equals(true)) {
                            new logger().OCategory.info("amount_tp_ro " + OTPreenregistrementCompteClientTiersPayentFinal.getIntPRICE());
                        } else if (OTPreenregistrementCompteClientTiersPayentFinal.getLgCOMPTECLIENTTIERSPAYANTID().getBISRC1().equals(true)) {
                            new logger().OCategory.info("amount_tp_rc1 " + OTPreenregistrementCompteClientTiersPayentFinal.getIntPRICE());
                        } else if (OTPreenregistrementCompteClientTiersPayentFinal.getLgCOMPTECLIENTTIERSPAYANTID().getBISRC1().equals(true)) {
                            new logger().OCategory.info("amount_tp_rc2 " + OTPreenregistrementCompteClientTiersPayentFinal.getIntPRICE());
                        }

                        //new logger().OCategory.info("amount_tp " + OTPreenregistrementCompteClientTiersPayentFinal.getIntPRICE());
                        new logger().OCategory.info("amount_clt " + OTPreenregistrementCompteClientTiersPayentFinal.getLgPREENREGISTREMENTID().getIntPRICE());
                        new logger().OCategory.info("amount_remise " + OTPreenregistrementCompteClientTiersPayentFinal.getLgPREENREGISTREMENTID().getIntPRICEREMISE());
    ...
    public List<TCashTransaction> func_Both_data() {
        ...
        for (TCashTransaction OTCashTransaction : LstT) {
            ...
            OTMotifReglement = this.func_GetMotifReglement(OTCashTransaction.getLgMOTIFREGLEMENTID().getLgMOTIFREGLEMENTID());
    ...
    public List<TCashTransaction> getDataBalanceVenteCash(String dt_date_debut, String dt_date_fin, String h_debut, String h_fin) {
...
//            String qry = "select * from t_cash_transaction where (t_cash_transaction.dt_CREATED >= '" + dt_date_debut + "' and t_cash_transaction.dt_CREATED <= '" + dt_date_fin + "') AND (TIME(t_cash_transaction.dt_CREATED) >= '" + h_debut + "' and TIME(t_cash_transaction.dt_CREATED) <= '" + h_fin + "') order by t_cash_transaction.str_TYPE_VENTE,t_cash_transaction.dt_CREATED DESC";
            ...
            while (Ojconnexion.get_resultat().next()) {
                ...
                OTCashTransaction.setIntAMOUNTDEBIT(Integer.parseInt(Ojconnexion.get_resultat().getString("DETETIERPAYS")));
...
//
////            String qry = "select * from t_cash_transaction where (t_cash_transaction.dt_CREATED >= '" + dt_date_debut + "' and t_cash_transaction.dt_CREATED <= '" + dt_date_fin + "') AND (TIME(t_cash_transaction.dt_CREATED) >= '" + h_debut + "' and TIME(t_cash_transaction.dt_CREATED) <= '" + h_fin + "') order by t_cash_transaction.str_TYPE_VENTE,t_cash_transaction.dt_CREATED DESC";
//            String qry = "SELECT * FROM v_balance_vente_caisse v WHERE v.str_TYPE_VENTE = '"+type_vente+"' AND v.lg_TYPE_REGLEMENT_ID LIKE '"+lg_TYPE_REGLEMENT_ID+"'" ;
//            new logger().OCategory.info("qry -- " + qry);
//            Ojconnexion.set_Request(qry);
//            ResultSetMetaData rsmddatas = Ojconnexion.get_resultat().getMetaData();
//            while (Ojconnexion.get_resultat().next()) {
...
//     
    ...
    public long getTotalFunCash(String dt_date_debut, String dt_date_fin) {
        ...
        try {
            lst = this.getOdataManager().getEm().createQuery("SELECT o FROM TCashTransaction o WHERE o.dtCREATED BETWEEN ?1 AND ?2 AND o.strNUMEROCOMPTE =?3")
                    ...
                    .setParameter(3, Parameter.ID_COMPTABLEFUNCASH)
                    .getResultList();
...
//    public List<EntityData> getJournalVente(String search_value, String lg_PREENGISTREMENT_ID, String dt_Date_Debut, String dt_Date_Fin, String h_debut, String h_fin, String str_TYPE_VENTE) {
//
...
//    }
    public List<EntityData> getJournalVente(String search_value, String lg_PREENGISTREMENT_ID, String dt_Date_Debut, String dt_Date_Fin, String h_debut, String h_fin, String str_TYPE_VENTE) {
        ...
        try {
            ...
            String qry = "SELECT t.*, (SELECT CONCAT(u1.str_FIRST_NAME,' ',u1.str_LAST_NAME) FROM t_user u1 WHERE u1.lg_USER_ID = t.lg_USER_CAISSIER_ID) AS str_FIRST_LAST_NAME_CAISSIER, (SELECT CONCAT(u2.str_FIRST_NAME,' ',u2.str_LAST_NAME) FROM t_user u2 WHERE u2.lg_USER_ID = t.lg_USER_VENDEUR_ID) AS str_FIRST_LAST_NAME_VENDEUR, CONCAT(t.str_FIRST_NAME_CUSTOMER,' ',t.str_LAST_NAME_CUSTOMER) AS str_FIRST_LAST_NAME_CLIENT, CASE WHEN t.int_PRICE > 0 THEN t.int_PRICE - t.int_PRICE_REMISE ELSE t.int_PRICE + ((-1) * t.int_PRICE_REMISE) END AS VENTE_NET,CASE WHEN t.int_PRICE_OTHER > 0 THEN t.int_PRICE_OTHER - t.int_PRICE_REMISE ELSE t.int_PRICE_OTHER + ((-1) * t.int_PRICE_REMISE) END AS VENTE_NET_BIS, (SELECT tp.str_NAME from t_preenregistrement_compte_client_tiers_payent tt, t_compte_client_tiers_payant c, t_tiers_payant tp where tt.lg_COMPTE_CLIENT_TIERS_PAYANT_ID = c.lg_COMPTE_CLIENT_TIERS_PAYANT_ID AND c.lg_TIERS_PAYANT_ID = tp.lg_TIERS_PAYANT_ID AND tt.lg_PREENREGISTREMENT_ID = t.lg_PREENREGISTREMENT_ID AND c.int_PRIORITY = 1 AND tt.str_STATUT = '" + commonparameter.statut_is_Closed + "' GROUP BY t.lg_PREENREGISTREMENT_ID) AS str_FULLNAME, (SELECT tt.int_PRICE from t_preenregistrement_compte_client_tiers_payent tt, t_compte_client_tiers_payant c, t_tiers_payant tp where tt.lg_COMPTE_CLIENT_TIERS_PAYANT_ID = c.lg_COMPTE_CLIENT_TIERS_PAYANT_ID AND c.lg_TIERS_PAYANT_ID = tp.lg_TIERS_PAYANT_ID AND tt.lg_PREENREGISTREMENT_ID = t.lg_PREENREGISTREMENT_ID AND c.int_PRIORITY = 1 GROUP BY t.lg_PREENREGISTREMENT_ID) AS str_TIERS_PAYANT_RO, (SELECT tt2.int_PRICE from t_preenregistrement_compte_client_tiers_payent tt2, t_compte_client_tiers_payant c, t_tiers_payant tp where tt2.lg_COMPTE_CLIENT_TIERS_PAYANT_ID = c.lg_COMPTE_CLIENT_TIERS_PAYANT_ID AND c.lg_TIERS_PAYANT_ID = tp.lg_TIERS_PAYANT_ID AND tt2.lg_PREENREGISTREMENT_ID = t.lg_PREENREGISTREMENT_ID AND c.int_PRIORITY = 2 GROUP BY t.lg_PREENREGISTREMENT_ID) AS str_TIERS_PAYANT_RC1, (SELECT tt3.int_PRICE from t_preenregistrement_compte_client_tiers_payent tt3, t_compte_client_tiers_payant c, t_tiers_payant tp where tt3.lg_COMPTE_CLIENT_TIERS_PAYANT_ID = c.lg_COMPTE_CLIENT_TIERS_PAYANT_ID AND c.lg_TIERS_PAYANT_ID = tp.lg_TIERS_PAYANT_ID AND tt3.lg_PREENREGISTREMENT_ID = t.lg_PREENREGISTREMENT_ID AND c.int_PRIORITY = 3 GROUP BY t.lg_PREENREGISTREMENT_ID) AS str_TIERS_PAYANT_RC2, (SELECT tt4.int_PRICE from t_preenregistrement_compte_client_tiers_payent tt4, t_compte_client_tiers_payant c, t_tiers_payant tp where tt4.lg_COMPTE_CLIENT_TIERS_PAYANT_ID = c.lg_COMPTE_CLIENT_TIERS_PAYANT_ID AND c.lg_TIERS_PAYANT_ID = tp.lg_TIERS_PAYANT_ID AND tt4.lg_PREENREGISTREMENT_ID = t.lg_PREENREGISTREMENT_ID AND c.int_PRIORITY = 4 GROUP BY t.lg_PREENREGISTREMENT_ID) AS str_TIERS_PAYANT_RC3, tv.str_NAME AS str_VENTE_NAME "
                    + "FROM t_preenregistrement t, t_user u, t_type_vente tv WHERE (t.str_REF LIKE '" + search_value + "%' OR t.str_REF_TICKET LIKE '" + search_value + "%') AND t.lg_PREENREGISTREMENT_ID LIKE '" + lg_PREENGISTREMENT_ID + "' AND (t.dt_UPDATED >= '" + dt_Date_Debut + " " + h_debut + "' AND t.dt_UPDATED <= '" + dt_Date_Fin + " " + h_fin + "') AND t.lg_USER_ID LIKE '" + lg_USER_ID + "' AND t.lg_USER_ID = u.lg_USER_ID AND u.lg_EMPLACEMENT_ID LIKE '" + lg_EMPLACEMENT_ID + "' AND t.str_TYPE_VENTE LIKE '" + str_TYPE_VENTE + "' AND t.str_STATUT = '" + commonparameter.statut_is_Closed + "' AND t.lg_TYPE_VENTE_ID = tv.lg_TYPE_VENTE_ID ORDER BY t.dt_UPDATED ASC";
            ...
            while (Ojconnexion.get_resultat().next()) {
                ...
                OEntityData.setStr_value3(Ojconnexion.get_resultat().getString("str_FIRST_LAST_NAME_CAISSIER"));
                OEntityData.setStr_value4(Ojconnexion.get_resultat().getString("str_FIRST_LAST_NAME_VENDEUR"));
//                OEntityData.setStr_value5(Ojconnexion.get_resultat().getString("int_PRICE")); // a decommenter en cas de probleme 22/08/2016
                ...
                OEntityData.setStr_value10(Ojconnexion.get_resultat().getString("str_TYPE_VENTE"));
                OEntityData.setStr_value11(Ojconnexion.get_resultat().getString("str_FIRST_LAST_NAME_CLIENT"));
                // OEntityData.setStr_value12(Ojconnexion.get_resultat().getString("VENTE_NET"));// a decommenter en cas de probleme. 22/08/2016
                // code ajouté 15/08/2016
                if (OTParameters != null && Integer.parseInt(OTParameters.getStrVALUE()) == 1 && Ojconnexion.get_resultat().getString("int_PRICE_OTHER") != null) {
    ...
    public List<EntityData> getJournalVente(String search_value, String lg_PREENGISTREMENT_ID, String dt_Date_Debut, String dt_Date_Fin, String h_debut, String h_fin, String str_TYPE_VENTE, int start, int limit) {
        ...
        try {
            ...
            /*String qry = "SELECT t.*, (SELECT CONCAT(u1.str_FIRST_NAME,' ',u1.str_LAST_NAME) FROM t_user u1 WHERE u1.lg_USER_ID = t.lg_USER_CAISSIER_ID) AS str_FIRST_LAST_NAME_CAISSIER, (SELECT CONCAT(u2.str_FIRST_NAME,' ',u2.str_LAST_NAME) FROM t_user u2 WHERE u2.lg_USER_ID = t.lg_USER_VENDEUR_ID) AS str_FIRST_LAST_NAME_VENDEUR, CONCAT(t.str_FIRST_NAME_CUSTOMER,' ',t.str_LAST_NAME_CUSTOMER) AS str_FIRST_LAST_NAME_CLIENT, CASE WHEN t.int_PRICE > 0 THEN t.int_PRICE - t.int_PRICE_REMISE ELSE t.int_PRICE + ((-1) * t.int_PRICE_REMISE) END AS VENTE_NET,CASE WHEN t.int_PRICE_OTHER > 0 THEN t.int_PRICE_OTHER - t.int_PRICE_REMISE ELSE t.int_PRICE_OTHER + ((-1) * t.int_PRICE_REMISE) END AS VENTE_NET_BIS, (SELECT tp.str_NAME from t_preenregistrement_compte_client_tiers_payent tt, t_compte_client_tiers_payant c, t_tiers_payant tp where tt.lg_COMPTE_CLIENT_TIERS_PAYANT_ID = c.lg_COMPTE_CLIENT_TIERS_PAYANT_ID AND c.lg_TIERS_PAYANT_ID = tp.lg_TIERS_PAYANT_ID AND tt.lg_PREENREGISTREMENT_ID = t.lg_PREENREGISTREMENT_ID AND c.int_PRIORITY = 1 AND tt.str_STATUT = '" + commonparameter.statut_is_Closed + "' GROUP BY t.lg_PREENREGISTREMENT_ID) AS str_FULLNAME, (SELECT tt.int_PRICE from t_preenregistrement_compte_client_tiers_payent tt, t_compte_client_tiers_payant c, t_tiers_payant tp where tt.lg_COMPTE_CLIENT_TIERS_PAYANT_ID = c.lg_COMPTE_CLIENT_TIERS_PAYANT_ID AND c.lg_TIERS_PAYANT_ID = tp.lg_TIERS_PAYANT_ID AND tt.lg_PREENREGISTREMENT_ID = t.lg_PREENREGISTREMENT_ID AND c.int_PRIORITY = 1 GROUP BY t.lg_PREENREGISTREMENT_ID) AS str_TIERS_PAYANT_RO, (SELECT tt2.int_PRICE from t_preenregistrement_compte_client_tiers_payent tt2, t_compte_client_tiers_payant c, t_tiers_payant tp where tt2.lg_COMPTE_CLIENT_TIERS_PAYANT_ID = c.lg_COMPTE_CLIENT_TIERS_PAYANT_ID AND c.lg_TIERS_PAYANT_ID = tp.lg_TIERS_PAYANT_ID AND tt2.lg_PREENREGISTREMENT_ID = t.lg_PREENREGISTREMENT_ID AND c.int_PRIORITY = 2 GROUP BY t.lg_PREENREGISTREMENT_ID) AS str_TIERS_PAYANT_RC1, (SELECT tt3.int_PRICE from t_preenregistrement_compte_client_tiers_payent tt3, t_compte_client_tiers_payant c, t_tiers_payant tp where tt3.lg_COMPTE_CLIENT_TIERS_PAYANT_ID = c.lg_COMPTE_CLIENT_TIERS_PAYANT_ID AND c.lg_TIERS_PAYANT_ID = tp.lg_TIERS_PAYANT_ID AND tt3.lg_PREENREGISTREMENT_ID = t.lg_PREENREGISTREMENT_ID AND c.int_PRIORITY = 3 GROUP BY t.lg_PREENREGISTREMENT_ID) AS str_TIERS_PAYANT_RC2, (SELECT tt4.int_PRICE from t_preenregistrement_compte_client_tiers_payent tt4, t_compte_client_tiers_payant c, t_tiers_payant tp where tt4.lg_COMPTE_CLIENT_TIERS_PAYANT_ID = c.lg_COMPTE_CLIENT_TIERS_PAYANT_ID AND c.lg_TIERS_PAYANT_ID = tp.lg_TIERS_PAYANT_ID AND tt4.lg_PREENREGISTREMENT_ID = t.lg_PREENREGISTREMENT_ID AND c.int_PRIORITY = 4 GROUP BY t.lg_PREENREGISTREMENT_ID) AS str_TIERS_PAYANT_RC3, tv.str_NAME AS str_VENTE_NAME " // a decommenter en cas de probleme 20/11/2016
             + "FROM t_preenregistrement t, t_user u, t_type_vente tv WHERE (t.str_REF LIKE '" + search_value + "%' OR t.str_REF_TICKET LIKE '" + search_value + "%') AND t.lg_PREENREGISTREMENT_ID LIKE '" + lg_PREENGISTREMENT_ID + "' AND (DATE(t.dt_UPDATED) >= '" + dt_Date_Debut + "' AND DATE(t.dt_UPDATED) <= '" + dt_Date_Fin + "') AND (TIME(t.dt_UPDATED) >= '" + h_debut + "' AND TIME(t.dt_UPDATED) <= '" + h_fin + "') AND t.lg_USER_ID LIKE '" + lg_USER_ID + "' AND t.lg_USER_ID = u.lg_USER_ID AND u.lg_EMPLACEMENT_ID LIKE '" + lg_EMPLACEMENT_ID + "' AND t.str_TYPE_VENTE LIKE '" + str_TYPE_VENTE + "' AND t.str_STATUT = '" + commonparameter.statut_is_Closed + "' AND t.lg_TYPE_VENTE_ID = tv.lg_TYPE_VENTE_ID ORDER BY t.dt_CREATED ASC LIMIT " + start + "," + limit;*/
            String qry = "SELECT t.*, (SELECT CONCAT(u1.str_FIRST_NAME,' ',u1.str_LAST_NAME) FROM t_user u1 WHERE u1.lg_USER_ID = t.lg_USER_CAISSIER_ID) AS str_FIRST_LAST_NAME_CAISSIER, (SELECT CONCAT(u2.str_FIRST_NAME,' ',u2.str_LAST_NAME) FROM t_user u2 WHERE u2.lg_USER_ID = t.lg_USER_VENDEUR_ID) AS str_FIRST_LAST_NAME_VENDEUR, CONCAT(t.str_FIRST_NAME_CUSTOMER,' ',t.str_LAST_NAME_CUSTOMER) AS str_FIRST_LAST_NAME_CLIENT, CASE WHEN t.int_PRICE > 0 THEN t.int_PRICE - t.int_PRICE_REMISE ELSE t.int_PRICE + ((-1) * t.int_PRICE_REMISE) END AS VENTE_NET,CASE WHEN t.int_PRICE_OTHER > 0 THEN t.int_PRICE_OTHER - t.int_PRICE_REMISE ELSE t.int_PRICE_OTHER + ((-1) * t.int_PRICE_REMISE) END AS VENTE_NET_BIS, (SELECT tp.str_NAME from t_preenregistrement_compte_client_tiers_payent tt, t_compte_client_tiers_payant c, t_tiers_payant tp where tt.lg_COMPTE_CLIENT_TIERS_PAYANT_ID = c.lg_COMPTE_CLIENT_TIERS_PAYANT_ID AND c.lg_TIERS_PAYANT_ID = tp.lg_TIERS_PAYANT_ID AND tt.lg_PREENREGISTREMENT_ID = t.lg_PREENREGISTREMENT_ID AND c.int_PRIORITY = 1 AND tt.str_STATUT = '" + commonparameter.statut_is_Closed + "' GROUP BY t.lg_PREENREGISTREMENT_ID) AS str_FULLNAME, (SELECT tt.int_PRICE from t_preenregistrement_compte_client_tiers_payent tt, t_compte_client_tiers_payant c, t_tiers_payant tp where tt.lg_COMPTE_CLIENT_TIERS_PAYANT_ID = c.lg_COMPTE_CLIENT_TIERS_PAYANT_ID AND c.lg_TIERS_PAYANT_ID = tp.lg_TIERS_PAYANT_ID AND tt.lg_PREENREGISTREMENT_ID = t.lg_PREENREGISTREMENT_ID AND c.int_PRIORITY = 1 GROUP BY t.lg_PREENREGISTREMENT_ID) AS str_TIERS_PAYANT_RO, (SELECT tt2.int_PRICE from t_preenregistrement_compte_client_tiers_payent tt2, t_compte_client_tiers_payant c, t_tiers_payant tp where tt2.lg_COMPTE_CLIENT_TIERS_PAYANT_ID = c.lg_COMPTE_CLIENT_TIERS_PAYANT_ID AND c.lg_TIERS_PAYANT_ID = tp.lg_TIERS_PAYANT_ID AND tt2.lg_PREENREGISTREMENT_ID = t.lg_PREENREGISTREMENT_ID AND c.int_PRIORITY = 2 GROUP BY t.lg_PREENREGISTREMENT_ID) AS str_TIERS_PAYANT_RC1, (SELECT tt3.int_PRICE from t_preenregistrement_compte_client_tiers_payent tt3, t_compte_client_tiers_payant c, t_tiers_payant tp where tt3.lg_COMPTE_CLIENT_TIERS_PAYANT_ID = c.lg_COMPTE_CLIENT_TIERS_PAYANT_ID AND c.lg_TIERS_PAYANT_ID = tp.lg_TIERS_PAYANT_ID AND tt3.lg_PREENREGISTREMENT_ID = t.lg_PREENREGISTREMENT_ID AND c.int_PRIORITY = 3 GROUP BY t.lg_PREENREGISTREMENT_ID) AS str_TIERS_PAYANT_RC2, (SELECT tt4.int_PRICE from t_preenregistrement_compte_client_tiers_payent tt4, t_compte_client_tiers_payant c, t_tiers_payant tp where tt4.lg_COMPTE_CLIENT_TIERS_PAYANT_ID = c.lg_COMPTE_CLIENT_TIERS_PAYANT_ID AND c.lg_TIERS_PAYANT_ID = tp.lg_TIERS_PAYANT_ID AND tt4.lg_PREENREGISTREMENT_ID = t.lg_PREENREGISTREMENT_ID AND c.int_PRIORITY = 4 GROUP BY t.lg_PREENREGISTREMENT_ID) AS str_TIERS_PAYANT_RC3, tv.str_NAME AS str_VENTE_NAME "
                    + "FROM t_preenregistrement t, t_user u, t_type_vente tv WHERE (t.str_REF LIKE '" + search_value + "%' OR t.str_REF_TICKET LIKE '" + search_value + "%') AND t.lg_PREENREGISTREMENT_ID LIKE '" + lg_PREENGISTREMENT_ID + "' AND (t.dt_UPDATED >= '" + dt_Date_Debut + " " + h_debut + "' AND t.dt_UPDATED <= '" + dt_Date_Fin + " " + h_fin + "') AND t.lg_USER_ID LIKE '" + lg_USER_ID + "' AND t.lg_USER_ID = u.lg_USER_ID AND u.lg_EMPLACEMENT_ID LIKE '" + lg_EMPLACEMENT_ID + "' AND t.str_TYPE_VENTE LIKE '" + str_TYPE_VENTE + "' AND t.str_STATUT = '" + commonparameter.statut_is_Closed + "' AND t.lg_TYPE_VENTE_ID = tv.lg_TYPE_VENTE_ID ORDER BY t.dt_UPDATED ASC LIMIT " + start + "," + limit;
...
//    //fin dernier bon journal de vente
    ...
    public List<EntityData> getFactureSubrogatoire(String search_value, String dt_Date_Debut, String dt_Date_Fin, String h_debut, String h_fin, String lg_TIERS_PAYANT_ID) {
...
//            String qry = "SELECT * FROM v_facture_subrogatoire v WHERE v.int_PRICE > 0 AND v.b_IS_CANCEL = false AND v.lg_EMPLACEMENT_ID LIKE '" + lg_EMPLACEMENT_ID + "' AND (DATE(v.dt_UPDATED) >= '" + dt_Date_Debut + "' AND DATE(v.dt_UPDATED) <= '" + dt_Date_Fin + "') AND (TIME(v.dt_UPDATED) >= '" + h_debut + "' AND TIME(v.dt_UPDATED) <= '" + h_fin + "') AND (v.str_FIRST_NAME_CUSTOMER LIKE '" + search_value + "%' OR v.str_LAST_NAME_CUSTOMER LIKE '" + search_value + "%' OR v.str_FIRST_LAST_NAME LIKE '" + search_value + "%' OR v.str_REF_BON LIKE '" + search_value + "%' OR v.str_REF LIKE '" + search_value + "%' OR v.str_REF_TICKET LIKE '" + search_value + "%') AND v.lg_USER_ID LIKE '" + lg_USER_ID + "' AND v.lg_TIERS_PAYANT_ID LIKE '" + lg_TIERS_PAYANT_ID + "' ORDER BY v.dt_UPDATED ASC"; // a decommenter en cas de probleme 20/11/2016
            qry = "SELECT * FROM v_facture_subrogatoire v WHERE v.int_PRICE > 0 AND v.b_IS_CANCEL = false AND v.lg_EMPLACEMENT_ID LIKE '" + lg_EMPLACEMENT_ID + "' AND (v.dt_UPDATED >= '" + dt_Date_Debut + " " + h_debut + "' AND v.dt_UPDATED <= '" + dt_Date_Fin + " " + h_fin + "') AND (v.str_FIRST_NAME_CUSTOMER LIKE '" + search_value + "%' OR v.str_LAST_NAME_CUSTOMER LIKE '" + search_value + "%' OR v.str_FIRST_LAST_NAME LIKE '" + search_value + "%' OR v.str_REF_BON LIKE '" + search_value + "%' OR v.str_REF LIKE '" + search_value + "%' OR v.str_REF_TICKET LIKE '" + search_value + "%') AND v.lg_USER_ID LIKE '" + lg_USER_ID + "' AND v.lg_TIERS_PAYANT_ID LIKE '" + lg_TIERS_PAYANT_ID + "' GROUP BY v.str_REF ORDER BY v.dt_UPDATED ASC";
            new logger().OCategory.info("qry -- " + qry);
            Ojconnexion.set_Request(qry);
            ResultSetMetaData rsmddatas = Ojconnexion.get_resultat().getMetaData();
            while (Ojconnexion.get_resultat().next()) {
...
//                    new logger().OCategory.info("Debut:" + data.get(0) + ":fin");
    ...
    public List<EntityData> getFactureSubrogatoireOther(String search_value, String dt_Date_Debut, String dt_Date_Fin, String h_debut, String h_fin, String lg_TIERS_PAYANT_ID) {
...
//            String qry = "SELECT * FROM v_facture_subrogatoire v WHERE v.int_PRICE > 0 AND v.b_IS_CANCEL = false AND v.lg_EMPLACEMENT_ID LIKE '" + lg_EMPLACEMENT_ID + "' AND (DATE(v.dt_UPDATED) >= '" + dt_Date_Debut + "' AND DATE(v.dt_UPDATED) <= '" + dt_Date_Fin + "') AND (TIME(v.dt_UPDATED) >= '" + h_debut + "' AND TIME(v.dt_UPDATED) <= '" + h_fin + "') AND (v.str_FIRST_NAME_CUSTOMER LIKE '" + search_value + "%' OR v.str_LAST_NAME_CUSTOMER LIKE '" + search_value + "%' OR v.str_FIRST_LAST_NAME LIKE '" + search_value + "%' OR v.str_REF_BON LIKE '" + search_value + "%' OR v.str_REF LIKE '" + search_value + "%' OR v.str_REF_TICKET LIKE '" + search_value + "%') AND v.lg_USER_ID LIKE '" + lg_USER_ID + "' AND v.lg_TIERS_PAYANT_ID LIKE '" + lg_TIERS_PAYANT_ID + "' ORDER BY v.str_TYPE_TIERS_PAYANT, v.str_NAME, v.dt_UPDATED ASC"; // a decommenter en cas de probleme
            String qry = "SELECT * FROM v_facture_subrogatoire v WHERE v.int_PRICE > 0 AND v.b_IS_CANCEL = false AND v.lg_EMPLACEMENT_ID LIKE '" + lg_EMPLACEMENT_ID + "' AND (v.dt_UPDATED >= '" + dt_Date_Debut + " " + h_debut + "' AND v.dt_UPDATED <= '" + dt_Date_Fin + " " + h_fin + "') AND (v.str_FIRST_NAME_CUSTOMER LIKE '" + search_value + "%' OR v.str_LAST_NAME_CUSTOMER LIKE '" + search_value + "%' OR v.str_FIRST_LAST_NAME LIKE '" + search_value + "%' OR v.str_REF_BON LIKE '" + search_value + "%' OR v.str_REF LIKE '" + search_value + "%' OR v.str_REF_TICKET LIKE '" + search_value + "%') AND v.lg_USER_ID LIKE '" + lg_USER_ID + "' AND v.lg_TIERS_PAYANT_ID LIKE '" + lg_TIERS_PAYANT_ID + "' ORDER BY v.str_TYPE_TIERS_PAYANT, v.str_NAME, v.dt_UPDATED ASC";
    ...
    /* public List<EntityData> getListeCaisse(String dt_date_debut, String dt_date_fin, String h_debut, String h_fin, String lg_USER_ID, String lg_TYPE_REGLEMENT_ID) { // a decommenter en cas de probleme 02/11/2016
     ...
     String qry = "SELECT * FROM v_caisse t WHERE DATE(t.dt_CREATED) >= '" + dt_date_debut + "' AND DATE(t.dt_CREATED) <= '" + dt_date_fin + "'  AND (TIME(t.dt_CREATED) >= '" + h_debut + "' and TIME(t.dt_CREATED) <= '" + h_fin + "') AND t.lg_USER_ID LIKE '" + lg_USER_ID + "' AND t.lg_TYPE_REGLEMENT_ID LIKE '" + lg_TYPE_REGLEMENT_ID + "' AND t.lg_EMPLACEMENT_ID LIKE '" + lg_EMPLACEMENT_ID + "' AND t.bool_CHECKED = true GROUP BY str_RESSOURCE_REF ORDER BY t.dt_CREATED ASC";
     new logger().OCategory.info(qry);
     Ojconnexion.set_Request(qry);
     ResultSetMetaData rsmddatas = Ojconnexion.get_resultat().getMetaData();
     while (Ojconnexion.get_resultat().next()) {
     ...
     //                OEntityData.setStr_value7(Ojconnexion.get_resultat().getString("int_AMOUNT")); //a decommenter en cas de probleme 23/08/2016
     OEntityData.setStr_value7((OTParameters != null && Integer.parseInt(OTParameters.getStrVALUE()) == 1) ? Ojconnexion.get_resultat().getString("int_AMOUNT_OTHER") : Ojconnexion.get_resultat().getString("int_AMOUNT"));
     ...
     public List<EntityData> getListeCaisse(String dt_date_debut, String dt_date_fin, String h_debut, String h_fin, String lg_USER_ID, String lg_TYPE_REGLEMENT_ID, int start, int limit) {
    ...
    public int getTotalListeCaisse(String dt_date_debut, String dt_date_fin, String h_debut, String h_fin, String lg_USER_ID, String lg_TYPE_REGLEMENT_ID) {
        Double result = 0.0;
        String lg_EMPLACEMENT_ID = "";
        privilege Oprivilege = new privilege(this.getOdataManager(), this.getOTUser());
        try {
            ...
            String qry = "SELECT `fn_v_caisse`('" + dt_date_debut + "', '" + dt_date_fin + "', '" + h_debut + "', '" + h_fin + "', '" + lg_USER_ID + "', '" + lg_TYPE_REGLEMENT_ID + "', '" + lg_EMPLACEMENT_ID + "')";
            new logger().OCategory.info(qry);
    ...
    public List<Object[]> getListeCaisse(String dt_date_debut, String dt_date_fin, String h_debut, String h_fin, String lg_USER_ID, String lg_TYPE_REGLEMENT_ID) {
...
//        TParameters OTParameters = null;
        try {
            ...
            String qry = "CALL `proc_v_caisse`('" + dt_date_debut + "', '" + dt_date_fin + "', '" + h_debut + "', '" + h_fin + "', '" + lg_USER_ID + "', '" + lg_TYPE_REGLEMENT_ID + "', '" + lg_EMPLACEMENT_ID + "')";
            new logger().OCategory.info(qry);
    ...
    public List<Object[]> getListeCaisse(String dt_date_debut, String dt_date_fin, String h_debut, String h_fin, String lg_USER_ID, String lg_TYPE_REGLEMENT_ID, int start, int limit) {
...
//        TParameters OTParameters = null;
        try {
            ...
            String qry = "CALL `proc_v_caisse_limit`('" + dt_date_debut + "', '" + dt_date_fin + "', '" + h_debut + "', '" + h_fin + "', '" + lg_USER_ID + "', '" + lg_TYPE_REGLEMENT_ID + "', '" + lg_EMPLACEMENT_ID + "', " + start + ", " + limit + ")";
            new logger().OCategory.info(qry);
            lstEntityData = this.getOdataManager().getEm().createNativeQuery(qry).getResultList();
...
//fin derniere bonne liste des caisses
    public List<EntityData> getCaisses(String dt_date_debut, String dt_date_fin, String lg_USER_ID, String lg_TYPE_REGLEMENT_ID) {
...
//                    + "FROM t_cash_transaction t, t_user u, t_mode_reglement m, t_reglement r, t_type_reglement tr, t_type_mvt_caisse mc WHERE DATE(t.dt_CREATED) >= '"+dt_date_debut+"' AND DATE(t.dt_CREATED) <= '"+dt_date_fin+"' AND t.lg_USER_ID = u.lg_USER_ID AND m.lg_MODE_REGLEMENT_ID = r.lg_MODE_REGLEMENT_ID AND t.lg_REGLEMENT_ID = r.lg_REGLEMENT_ID AND tr.lg_TYPE_REGLEMENT_ID = m.lg_TYPE_REGLEMENT_ID AND mc.str_CODE_COMPTABLE = t.str_NUMERO_COMPTE AND t.lg_USER_ID LIKE '"+lg_USER_ID+"' AND tr.lg_TYPE_REGLEMENT_ID LIKE '"+lg_TYPE_REGLEMENT_ID+"' GROUP BY str_RESSOURCE_REF ORDER BY str_TYPE_VENTE, t.dt_CREATED ASC";
            String qry = "SELECT t.str_RESSOURCE_REF, sum(int_AMOUNT) as AMOUNT, CASE WHEN t.str_TASK = 'VENTE' THEN (SELECT p.str_REF FROM t_preenregistrement p WHERE p.lg_PREENREGISTREMENT_ID = t.str_RESSOURCE_REF) ELSE t.str_RESSOURCE_REF END AS str_RESSOURCE_REF_BIS, CASE WHEN t.str_TASK = 'VENTE' THEN CASE WHEN t.str_TYPE_VENTE = 'VO' THEN (SELECT p.int_CUST_PART FROM t_preenregistrement p WHERE p.lg_PREENREGISTREMENT_ID = t.str_RESSOURCE_REF) ELSE (SELECT CASE WHEN p.int_PRICE > 0 THEN p.int_PRICE - p.int_PRICE_REMISE ELSE p.int_PRICE + ((-1) * p.int_PRICE_REMISE) END FROM t_preenregistrement p WHERE p.lg_PREENREGISTREMENT_ID = t.str_RESSOURCE_REF) END ELSE CASE WHEN t.str_TRANSACTION_REF = 'C' THEN t.int_AMOUNT_CREDIT ELSE (-1) * t.int_AMOUNT_DEBIT END END AS int_AMOUNT, CASE WHEN t.str_NUMERO_COMPTE = '10800000000' THEN (SELECT CONCAT(u1.str_FIRST_NAME,' ',u1.str_LAST_NAME) FROM t_mvt_caisse mm, t_user u1 WHERE mm.P_KEY = u1.lg_USER_ID AND t.str_RESSOURCE_REF = mm.lg_MVT_CAISSE_ID) ELSE CONCAT(u.str_FIRST_NAME,' ',u.str_LAST_NAME) END AS str_FIRST_LAST_NAME, t.dt_CREATED, m.str_NAME, tr.str_NAME AS str_NAME_TYE_REGLEMENT, mc.str_NAME AS str_NAME_TYPE_MVT_CAISSE, (SELECT CONCAT(p.str_FIRST_NAME_CUSTOMER, ' ' , p.str_LAST_NAME_CUSTOMER) from t_preenregistrement p WHERE p.lg_PREENREGISTREMENT_ID = t.str_RESSOURCE_REF) AS str_FIRST_LAST_NAME_CLIENT, t.str_NUMERO_COMPTE "
                    + "FROM t_cash_transaction t, t_user u, t_mode_reglement m, t_reglement r, t_type_reglement tr, t_type_mvt_caisse mc WHERE DATE(t.dt_CREATED) >= '" + dt_date_debut + "' AND DATE(t.dt_CREATED) <= '" + dt_date_fin + "' AND t.lg_USER_ID = u.lg_USER_ID AND m.lg_MODE_REGLEMENT_ID = r.lg_MODE_REGLEMENT_ID AND t.lg_REGLEMENT_ID = r.lg_REGLEMENT_ID AND tr.lg_TYPE_REGLEMENT_ID = m.lg_TYPE_REGLEMENT_ID AND mc.str_CODE_COMPTABLE = t.str_NUMERO_COMPTE AND t.lg_USER_ID LIKE '" + lg_USER_ID + "' AND tr.lg_TYPE_REGLEMENT_ID LIKE '" + lg_TYPE_REGLEMENT_ID + "' GROUP BY str_FIRST_LAST_NAME ORDER BY t.dt_CREATED ASC";
    ...
    public List<EntityData> getBalanceVenteCaisse(String dt_date_debut, String dt_date_fin) {
        ...
        try {
            ...
            /*String qry = "SELECT SUM(t.int_PRICE) AS VENTE_BRUT, SUM(t.int_PRICE_REMISE) AS TOTAL_REMISE, SUM(t.int_PRICE) - SUM(t.int_PRICE_REMISE) AS VENTE_NET, t.str_TYPE_VENTE AS str_TYPE_VENTE, tr.str_NAME AS str_TYPE_REGLEMENT, tr.lg_TYPE_REGLEMENT_ID AS lg_TYPE_REGLEMENT_ID, COUNT(t.lg_PREENREGISTREMENT_ID) AS NB, CASE WHEN t.lg_NATURE_VENTE_ID = '" + Parameter.KEY_NATURE_VENTE_DEPOT + "' THEN 0 ELSE (SUM(t.int_PRICE) - SUM(t.int_PRICE_REMISE)) - SUM(t.int_CUST_PART) END AS PART_TIERSPAYANT, CASE WHEN t.str_TYPE_VENTE = '" + Parameter.KEY_VENTE_ORDONNANCE + "' THEN SUM(t.int_CUST_PART) ELSE SUM(t.int_PRICE) - SUM(t.int_PRICE_REMISE) END AS TOTAL_CAISSE, CASE WHEN t.str_STATUT_VENTE = '" + commonparameter.statut_nondiffere + "' AND t.str_TYPE_VENTE = '" + Parameter.KEY_VENTE_ORDONNANCE + "'	THEN SUM(t.int_CUST_PART) WHEN t.str_STATUT_VENTE = '" + commonparameter.statut_differe + "' AND t.str_TYPE_VENTE = '" + Parameter.KEY_VENTE_ORDONNANCE + "' THEN (SELECT SUM(ct.int_AMOUNT_CREDIT) FROM t_cash_transaction ct, t_preenregistrement t WHERE t.lg_PREENREGISTREMENT_ID = ct.str_RESSOURCE_REF AND t.str_STATUT_VENTE = '" + commonparameter.statut_differe + "' AND ct.int_AMOUNT_CREDIT > 0 AND t.str_TYPE_VENTE = '" + Parameter.KEY_VENTE_ORDONNANCE + "') WHEN t.str_STATUT_VENTE = '" + commonparameter.statut_nondiffere + "' AND t.str_TYPE_VENTE = '" + Parameter.KEY_VENTE_NON_ORDONNANCEE + "' THEN (SUM(t.int_PRICE) - SUM(t.int_PRICE_REMISE)) WHEN t.str_STATUT_VENTE = '" + commonparameter.statut_differe + "' AND t.str_TYPE_VENTE = '" + Parameter.KEY_VENTE_NON_ORDONNANCEE + "' THEN (SELECT SUM(ct.int_AMOUNT_CREDIT) FROM t_cash_transaction ct, t_preenregistrement t WHERE t.lg_PREENREGISTREMENT_ID = ct.str_RESSOURCE_REF AND t.str_STATUT_VENTE = '" + commonparameter.statut_differe + "' AND ct.int_AMOUNT_CREDIT > 0 AND t.str_TYPE_VENTE = '" + Parameter.KEY_VENTE_NON_ORDONNANCEE + "' 	AND (DATE(`t`.`dt_UPDATED`) >= '" + dt_date_debut + "' AND DATE(`t`.`dt_UPDATED`) <= '" + dt_date_fin + "')) ELSE (SELECT SUM(ct.int_AMOUNT_CREDIT) FROM t_cash_transaction ct, t_preenregistrement t WHERE t.lg_PREENREGISTREMENT_ID = ct.str_RESSOURCE_REF AND t.str_STATUT_VENTE = '" + commonparameter.statut_differe + "' AND ct.int_AMOUNT_CREDIT > 0 AND (DATE(`t`.`dt_UPDATED`) >= '" + dt_date_debut + "' AND DATE(`t`.`dt_UPDATED`) <= '" + dt_date_fin + "')) END AS PART_CLIENT, " // a decommenter en cas de probleme. 27/04/2016
             + "CASE WHEN (t.str_STATUT_VENTE = '" + commonparameter.statut_differe + "' AND t.str_TYPE_VENTE = '" + Parameter.KEY_VENTE_NON_ORDONNANCEE + "') THEN (SELECT SUM(pc.int_PRICE_RESTE) FROM t_cash_transaction ct, t_preenregistrement t, t_preenregistrement_compte_client pc WHERE t.lg_PREENREGISTREMENT_ID = ct.str_RESSOURCE_REF AND pc.lg_PREENREGISTREMENT_ID = t.lg_PREENREGISTREMENT_ID AND t.str_STATUT_VENTE = '" + commonparameter.statut_differe + "' AND ct.int_AMOUNT >= 0 AND t.str_TYPE_VENTE = '" + Parameter.KEY_VENTE_NON_ORDONNANCEE + "' AND (DATE(`t`.`dt_UPDATED`) >= '" + dt_date_debut + "' AND DATE(`t`.`dt_UPDATED`) <= '" + dt_date_fin + "')) WHEN (t.str_STATUT_VENTE = '" + commonparameter.statut_differe + "' AND t.str_TYPE_VENTE = '" + Parameter.KEY_VENTE_ORDONNANCE + "') THEN (SELECT SUM(pc.int_PRICE_RESTE) FROM t_cash_transaction ct, t_preenregistrement t, t_preenregistrement_compte_client pc WHERE t.lg_PREENREGISTREMENT_ID = ct.str_RESSOURCE_REF AND pc.lg_PREENREGISTREMENT_ID = t.lg_PREENREGISTREMENT_ID AND t.str_STATUT_VENTE = '" + commonparameter.statut_differe + "' AND ct.int_AMOUNT >= 0 AND t.str_TYPE_VENTE = '" + Parameter.KEY_VENTE_ORDONNANCE + "' AND (DATE(`t`.`dt_UPDATED`) >= '" + dt_date_debut + "' AND DATE(`t`.`dt_UPDATED`) <= '" + dt_date_fin + "')) 	ELSE 0 END AS PART_CLIENT_DETTE "
             + "FROM t_preenregistrement t, t_type_reglement tr, t_mode_reglement mr, t_reglement r, t_emplacement e, t_user u WHERE t.lg_REGLEMENT_ID = r.lg_REGLEMENT_ID AND tr.lg_TYPE_REGLEMENT_ID = mr.lg_TYPE_REGLEMENT_ID AND r.lg_MODE_REGLEMENT_ID = mr.lg_MODE_REGLEMENT_ID AND (DATE(`t`.`dt_UPDATED`) >= '" + dt_date_debut + "' AND DATE(`t`.`dt_UPDATED`) <= '" + dt_date_fin + "') AND t.str_STATUT = '" + commonparameter.statut_is_Closed + "' AND e.lg_EMPLACEMENT_ID = u.lg_EMPLACEMENT_ID AND t.lg_USER_ID = u.lg_USER_ID AND u.lg_EMPLACEMENT_ID LIKE '" + lg_EMPLACEMENT_ID + "' AND (t.int_PRICE > 0 AND t.b_IS_CANCEL = 0) AND t.lg_NATURE_VENTE_ID NOT LIKE '" + Parameter.KEY_NATURE_VENTE_DEPOT + "' GROUP BY t.str_TYPE_VENTE, tr.str_NAME";
             */
            String qry = "SELECT SUM(t.int_PRICE) AS VENTE_BRUT, SUM(t.int_PRICE_OTHER) AS VENTE_BRUT_OTHER, SUM(t.int_PRICE_REMISE) AS TOTAL_REMISE, SUM(t.int_PRICE) - SUM(t.int_PRICE_REMISE) AS VENTE_NET, SUM(t.int_PRICE_OTHER) - SUM(t.int_PRICE_REMISE) AS VENTE_NET_OTHER, t.str_TYPE_VENTE AS str_TYPE_VENTE, tr.str_NAME AS str_TYPE_REGLEMENT, tr.lg_TYPE_REGLEMENT_ID AS lg_TYPE_REGLEMENT_ID, COUNT(t.lg_PREENREGISTREMENT_ID) AS NB, CASE WHEN t.lg_NATURE_VENTE_ID = '" + Parameter.KEY_NATURE_VENTE_DEPOT + "' THEN 0 ELSE (SUM(t.int_PRICE) - SUM(t.int_PRICE_REMISE)) - SUM(t.int_CUST_PART) END AS PART_TIERSPAYANT, CASE WHEN t.lg_NATURE_VENTE_ID = '" + Parameter.KEY_NATURE_VENTE_DEPOT + "' THEN 0 ELSE (SUM(t.int_PRICE_OTHER) - SUM(t.int_PRICE_REMISE)) - SUM(t.int_CUST_PART) END AS PART_TIERSPAYANT_OTHER, CASE WHEN t.str_TYPE_VENTE = '" + Parameter.KEY_VENTE_ORDONNANCE + "' THEN SUM(t.int_CUST_PART) ELSE SUM(t.int_PRICE) - SUM(t.int_PRICE_REMISE) END AS TOTAL_CAISSE, CASE WHEN t.str_TYPE_VENTE = '" + Parameter.KEY_VENTE_ORDONNANCE + "' THEN SUM(t.int_CUST_PART) ELSE SUM(t.int_PRICE_OTHER) - SUM(t.int_PRICE_REMISE) END AS TOTAL_CAISSE_OTHER, CASE WHEN t.str_STATUT_VENTE = '" + commonparameter.statut_nondiffere + "' AND t.str_TYPE_VENTE = '" + Parameter.KEY_VENTE_ORDONNANCE + "'	THEN SUM(t.int_CUST_PART) WHEN t.str_STATUT_VENTE = '" + commonparameter.statut_differe + "' AND t.str_TYPE_VENTE = '" + Parameter.KEY_VENTE_ORDONNANCE + "' THEN (SELECT SUM(ct.int_AMOUNT_CREDIT) FROM t_cash_transaction ct, t_preenregistrement t WHERE t.lg_PREENREGISTREMENT_ID = ct.str_RESSOURCE_REF AND t.str_STATUT_VENTE = '" + commonparameter.statut_differe + "' AND ct.int_AMOUNT_CREDIT >= 0 AND t.str_TYPE_VENTE = '" + Parameter.KEY_VENTE_ORDONNANCE + "' AND (DATE(`t`.`dt_UPDATED`) >= '" + dt_date_debut + "' AND DATE(`t`.`dt_UPDATED`) <= '" + dt_date_fin + "') AND u.lg_EMPLACEMENT_ID LIKE '" + lg_EMPLACEMENT_ID + "' AND t.int_PRICE > 0 AND t.b_IS_CANCEL = 0) WHEN t.str_STATUT_VENTE = '" + commonparameter.statut_nondiffere + "' AND t.str_TYPE_VENTE = '" + Parameter.KEY_VENTE_NON_ORDONNANCEE + "' THEN (SUM(t.int_PRICE) - SUM(t.int_PRICE_REMISE)) WHEN t.str_STATUT_VENTE = '" + commonparameter.statut_differe + "' AND t.str_TYPE_VENTE = '" + Parameter.KEY_VENTE_NON_ORDONNANCEE + "' THEN (SELECT SUM(ct.int_AMOUNT_CREDIT) FROM t_cash_transaction ct, t_preenregistrement t WHERE t.lg_PREENREGISTREMENT_ID = ct.str_RESSOURCE_REF AND t.str_STATUT_VENTE = '" + commonparameter.statut_differe + "' AND ct.int_AMOUNT_CREDIT >= 0 AND t.str_TYPE_VENTE = '" + Parameter.KEY_VENTE_NON_ORDONNANCEE + "' 	AND (DATE(`t`.`dt_UPDATED`) >= '" + dt_date_debut + "' AND DATE(`t`.`dt_UPDATED`) <= '" + dt_date_fin + "') AND u.lg_EMPLACEMENT_ID LIKE '" + lg_EMPLACEMENT_ID + "' AND t.int_PRICE > 0 AND t.b_IS_CANCEL = 0) ELSE (SELECT SUM(ct.int_AMOUNT_CREDIT) FROM t_cash_transaction ct, t_preenregistrement t WHERE t.lg_PREENREGISTREMENT_ID = ct.str_RESSOURCE_REF AND t.str_STATUT_VENTE = '" + commonparameter.statut_differe + "' AND ct.int_AMOUNT_CREDIT > 0 AND (DATE(`t`.`dt_UPDATED`) >= '" + dt_date_debut + "' AND DATE(`t`.`dt_UPDATED`) <= '" + dt_date_fin + "') AND u.lg_EMPLACEMENT_ID LIKE '" + lg_EMPLACEMENT_ID + "') END AS PART_CLIENT, "
                    + "CASE WHEN (t.str_STATUT_VENTE = '" + commonparameter.statut_differe + "' AND t.str_TYPE_VENTE = '" + Parameter.KEY_VENTE_NON_ORDONNANCEE + "') THEN (SELECT SUM(pc.int_PRICE_RESTE) FROM t_cash_transaction ct, t_preenregistrement t, t_preenregistrement_compte_client pc WHERE t.lg_PREENREGISTREMENT_ID = ct.str_RESSOURCE_REF AND pc.lg_PREENREGISTREMENT_ID = t.lg_PREENREGISTREMENT_ID AND t.str_STATUT_VENTE = '" + commonparameter.statut_differe + "' AND ct.int_AMOUNT >= 0 AND t.str_TYPE_VENTE = '" + Parameter.KEY_VENTE_NON_ORDONNANCEE + "' AND (DATE(`t`.`dt_UPDATED`) >= '" + dt_date_debut + "' AND DATE(`t`.`dt_UPDATED`) <= '" + dt_date_fin + "') AND u.lg_EMPLACEMENT_ID LIKE '" + lg_EMPLACEMENT_ID + "') WHEN (t.str_STATUT_VENTE = '" + commonparameter.statut_differe + "' AND t.str_TYPE_VENTE = '" + Parameter.KEY_VENTE_ORDONNANCE + "') THEN (SELECT SUM(pc.int_PRICE_RESTE) FROM t_cash_transaction ct, t_preenregistrement t, t_preenregistrement_compte_client pc WHERE t.lg_PREENREGISTREMENT_ID = ct.str_RESSOURCE_REF AND pc.lg_PREENREGISTREMENT_ID = t.lg_PREENREGISTREMENT_ID AND t.str_STATUT_VENTE = '" + commonparameter.statut_differe + "' AND ct.int_AMOUNT >= 0 AND t.str_TYPE_VENTE = '" + Parameter.KEY_VENTE_ORDONNANCE + "' AND (DATE(`t`.`dt_UPDATED`) >= '" + dt_date_debut + "' AND DATE(`t`.`dt_UPDATED`) <= '" + dt_date_fin + "') AND u.lg_EMPLACEMENT_ID LIKE '" + lg_EMPLACEMENT_ID + "' AND ct.str_TYPE = true) ELSE 0 END AS PART_CLIENT_DETTE "
                    + "FROM t_preenregistrement t, t_type_reglement tr, t_mode_reglement mr, t_reglement r, t_emplacement e, t_user u WHERE t.lg_REGLEMENT_ID = r.lg_REGLEMENT_ID AND tr.lg_TYPE_REGLEMENT_ID = mr.lg_TYPE_REGLEMENT_ID AND r.lg_MODE_REGLEMENT_ID = mr.lg_MODE_REGLEMENT_ID AND (DATE(`t`.`dt_UPDATED`) >= '" + dt_date_debut + "' AND DATE(`t`.`dt_UPDATED`) <= '" + dt_date_fin + "') AND t.str_STATUT = '" + commonparameter.statut_is_Closed + "' AND e.lg_EMPLACEMENT_ID = u.lg_EMPLACEMENT_ID AND t.lg_USER_ID = u.lg_USER_ID AND u.lg_EMPLACEMENT_ID LIKE '" + lg_EMPLACEMENT_ID + "' AND (t.int_PRICE > 0 AND t.b_IS_CANCEL = 0) AND t.lg_TYPE_VENTE_ID NOT LIKE '" + Parameter.VENTE_DEPOT_EXTENSION + "' GROUP BY t.str_TYPE_VENTE, tr.str_NAME";
            ...
            while (Ojconnexion.get_resultat().next()) {
                ...
                /* if (OTParameters != null && Integer.parseInt(OTParameters.getStrVALUE()) == 1) {
                    ...
                    OEntityData.setStr_value10(Ojconnexion.get_resultat().getString("TOTAL_CAISSE_OTHER"));
                } else {*/
    ...
    public long getIntAmountByTypeRegleBalanceVC(List<EntityData> entityDatas, String type_vente, String lg_TYPE_REGLEMENT_ID) {
        long result = 0l;

        for (EntityData OentityData : entityDatas) {
            /*if (OentityData.getStr_value4().equals(type_vente) && OentityData.getStr_value6().equalsIgnoreCase(lg_TYPE_REGLEMENT_ID)) { //a decommenter en cas de probleme
            ...
            if (OentityData.getStr_value4().equals(type_vente) && OentityData.getStr_value6().equalsIgnoreCase(lg_TYPE_REGLEMENT_ID)) {
                if (OentityData.getStr_value4().equals(Parameter.KEY_VENTE_ORDONNANCE)) {
                    result += Integer.valueOf(OentityData.getStr_value9());
                } else if (OentityData.getStr_value4().equals(Parameter.KEY_VENTE_NON_ORDONNANCEE)) {
//                    result += Integer.valueOf(OentityData.getStr_value3()); //ancien bon code. a decommenter en cas de probleme
                    //code ajouté
    ...
    public long getIntAmountDetteByTypeRegleBalanceVC(List<EntityData> entityDatas, String type_vente, String lg_TYPE_REGLEMENT_ID) {
        long result = 0l;
...
//            e.printStackTrace();
    ...
    public List<EntityData> getMouvementCaisse(String dt_date_debut, String dt_date_fin, String lg_USER_ID, String lg_TYPE_REGLEMENT_ID) {
        ...
        try {
            ...
            /*  String qry = "SELECT t.str_RESSOURCE_REF, t.str_TYPE_VENTE, tr.`lg_TYPE_REGLEMENT_ID` ,CASE WHEN t.str_TRANSACTION_REF = 'C' THEN t.int_AMOUNT_CREDIT ELSE (-1) * t.int_AMOUNT_DEBIT END AS int_AMOUNT,r.str_FIRST_LAST_NAME AS CLIENTNAME, CASE WHEN t.str_NUMERO_COMPTE = '10800000000' THEN (SELECT CONCAT(u1.str_FIRST_NAME,' ',u1.str_LAST_NAME) FROM t_mvt_caisse mm, t_user u1 WHERE mm.P_KEY = u1.lg_USER_ID AND t.str_RESSOURCE_REF = mm.lg_MVT_CAISSE_ID) ELSE CONCAT(u.str_FIRST_NAME,' ',u.str_LAST_NAME) END AS str_FIRST_LAST_NAME, t.dt_CREATED, m.str_NAME, tr.str_NAME AS str_NAME_TYE_REGLEMENT, mc.str_NAME AS str_NAME_TYPE_MVT_CAISSE,t.str_NUMERO_COMPTE  " // a decommenter en cas de probleme. 15/07/2015
             + "FROM t_cash_transaction t, t_user u, t_mode_reglement m, t_reglement r, t_type_reglement tr, t_type_mvt_caisse mc WHERE (t.str_TYPE_VENTE NOT LIKE '" + Parameter.KEY_VENTE_NON_ORDONNANCEE + "' AND t.str_TYPE_VENTE NOT LIKE '" + Parameter.KEY_VENTE_ORDONNANCE + "' AND t.str_NUMERO_COMPTE NOT LIKE '"+Parameter.TYPE_NUMCOMPTE_MVTCAISSE_VO+"' AND t.str_NUMERO_COMPTE NOT LIKE '"+Parameter.TYPE_NUMCOMPTE_MVTCAISSE_VNO+"') AND DATE(t.dt_CREATED) >= '" + dt_date_debut + "' AND DATE(t.dt_CREATED) <= '" + dt_date_fin + "' AND t.lg_USER_ID = u.lg_USER_ID AND m.lg_MODE_REGLEMENT_ID = r.lg_MODE_REGLEMENT_ID AND t.lg_REGLEMENT_ID = r.lg_REGLEMENT_ID AND tr.lg_TYPE_REGLEMENT_ID = m.lg_TYPE_REGLEMENT_ID AND mc.str_CODE_COMPTABLE = t.str_NUMERO_COMPTE AND t.lg_USER_ID LIKE '" + lg_USER_ID + "' AND tr.lg_TYPE_REGLEMENT_ID LIKE '" + lg_TYPE_REGLEMENT_ID + "' AND u.lg_EMPLACEMENT_ID LIKE '" + lg_EMPLACEMENT_ID + "' GROUP BY str_RESSOURCE_REF ORDER BY t.dt_CREATED ASC";*/
            String qry = "SELECT t.str_RESSOURCE_REF, t.str_TYPE_VENTE, tr.`lg_TYPE_REGLEMENT_ID` ,CASE WHEN t.str_TRANSACTION_REF = 'C' THEN t.int_AMOUNT_CREDIT ELSE (-1) * t.int_AMOUNT_DEBIT END AS int_AMOUNT,r.str_FIRST_LAST_NAME AS CLIENTNAME, CASE WHEN t.str_NUMERO_COMPTE = '10800000000' THEN (SELECT CONCAT(u1.str_FIRST_NAME,' ',u1.str_LAST_NAME) FROM t_mvt_caisse mm, t_user u1 WHERE mm.P_KEY = u1.lg_USER_ID AND t.str_RESSOURCE_REF = mm.lg_MVT_CAISSE_ID) ELSE CONCAT(u.str_FIRST_NAME,' ',u.str_LAST_NAME) END AS str_FIRST_LAST_NAME, t.dt_CREATED, m.str_NAME, tr.str_NAME AS str_NAME_TYE_REGLEMENT, mc.str_NAME AS str_NAME_TYPE_MVT_CAISSE,t.str_NUMERO_COMPTE  "
                    + "FROM t_cash_transaction t, t_user u, t_mode_reglement m, t_reglement r, t_type_reglement tr, t_type_mvt_caisse mc WHERE (t.str_TYPE_VENTE NOT LIKE '" + Parameter.KEY_VENTE_NON_ORDONNANCEE + "' AND t.str_TYPE_VENTE NOT LIKE '" + Parameter.KEY_VENTE_ORDONNANCE + "' AND t.str_NUMERO_COMPTE NOT LIKE '" + Parameter.TYPE_NUMCOMPTE_MVTCAISSE_VO + "' AND t.str_NUMERO_COMPTE NOT LIKE '" + Parameter.TYPE_NUMCOMPTE_MVTCAISSE_VNO + "') AND DATE(t.dt_CREATED) >= '" + dt_date_debut + "' AND DATE(t.dt_CREATED) <= '" + dt_date_fin + "' AND t.lg_USER_ID = u.lg_USER_ID AND m.lg_MODE_REGLEMENT_ID = r.lg_MODE_REGLEMENT_ID AND t.lg_REGLEMENT_ID = r.lg_REGLEMENT_ID AND tr.lg_TYPE_REGLEMENT_ID = m.lg_TYPE_REGLEMENT_ID AND mc.str_CODE_COMPTABLE = t.str_NUMERO_COMPTE AND t.lg_USER_ID LIKE '" + lg_USER_ID + "' AND tr.lg_TYPE_REGLEMENT_ID LIKE '" + lg_TYPE_REGLEMENT_ID + "' AND u.lg_EMPLACEMENT_ID LIKE '" + lg_EMPLACEMENT_ID + "' AND t.bool_CHECKED = true GROUP BY str_RESSOURCE_REF ORDER BY t.dt_CREATED ASC";
    ...
    public List<EntityData> getMouvementCaisse(String dt_date_debut, String dt_date_fin, String lg_USER_ID, String lg_TYPE_REGLEMENT_ID, boolean bool_CHECKED) {
    ...
    public List<EntityData> getMouvementCaisse(String dt_date_debut, String dt_date_fin, String lg_USER_ID, String lg_TYPE_REGLEMENT_ID, boolean bool_CHECKED, int start, int limit) {
    ...
    public List<EntityData> getAllMouvmentsCaisse(String dt_date_debut, String dt_date_fin) {
        ...
        try {
            ...
            Ojconnexion.initConnexion();
            Ojconnexion.OpenConnexion();
            lg_EMPLACEMENT_ID = (Oprivilege.isColonneStockMachineIsAuthorize(Parameter.P_SHOW_ALL_ACTIVITY) ? "%%" : this.getOTUser().getLgEMPLACEMENTID().getLgEMPLACEMENTID());
//            String qry = "SELECT sum(t.int_PRICE) AS VENTE_BRUT, SUM(t.int_PRICE_REMISE) AS TOTAL_REMISE, sum(t.int_PRICE) - SUM(t.int_PRICE_REMISE) AS VENTE_NET,t.str_TYPE_VENTE AS str_TYPE_VENTE, tr.str_NAME AS str_TYPE_REGLEMENT, tr.lg_TYPE_REGLEMENT_ID AS lg_TYPE_REGLEMENT_ID, COUNT(t.lg_PREENREGISTREMENT_ID) AS NB, (sum(t.int_PRICE) - SUM(t.int_PRICE_REMISE)) - sum(t.int_CUST_PART) AS PART_TIERSPAYANT, sum(t.int_CUST_PART) AS PART_CLIENT , CASE WHEN t.str_TYPE_VENTE = 'VO' THEN sum(t.int_CUST_PART) ELSE sum(t.int_PRICE) - SUM(t.int_PRICE_REMISE) END AS TOTAL_CAISSE "
//                    + "FROM t_preenregistrement t, t_type_reglement tr, t_mode_reglement mr, t_reglement r, t_emplacement e,  t_user u WHERE t.lg_REGLEMENT_ID = r.lg_REGLEMENT_ID AND tr.lg_TYPE_REGLEMENT_ID = mr.lg_TYPE_REGLEMENT_ID AND r.lg_MODE_REGLEMENT_ID = mr.lg_MODE_REGLEMENT_ID AND (DATE(`t`.`dt_CREATED`) >='" + dt_date_debut + "' AND DATE(`t`.`dt_CREATED`) <= '" + dt_date_fin + "') AND t.str_STATUT = '" + commonparameter.statut_is_Closed + "' AND e.lg_EMPLACEMENT_ID = u.lg_EMPLACEMENT_ID AND t.lg_USER_ID = u.lg_USER_ID AND u.lg_EMPLACEMENT_ID LIKE '" + this.getOTUser().getLgEMPLACEMENTID().getLgEMPLACEMENTID() + "' GROUP BY t.str_TYPE_VENTE, tr.str_NAME";
            String qry = "SELECT sum(`o`.`int_AMOUNT`) AS `AMOUNT`,tr.`lg_TYPE_REGLEMENT_ID`, `o`.`lg_TYPE_MVT_CAISSE_ID` ,`o`.`lg_MODE_REGLEMENT_ID` ,`tr`.`str_DESCRIPTION` AS `str_DESCRIPTION`,`tm`.`str_NAME` AS `MOUVMENT`  FROM t_mvt_caisse o,t_type_mvt_caisse tm,t_mode_reglement t,t_type_reglement tr, t_user u WHERE u.lg_USER_ID = o.lg_USER_ID AND u.lg_EMPLACEMENT_ID LIKE '" + lg_EMPLACEMENT_ID + "' AND o.`lg_TYPE_MVT_CAISSE_ID`=tm.`lg_TYPE_MVT_CAISSE_ID` AND o.`lg_MODE_REGLEMENT_ID`=t.`lg_MODE_REGLEMENT_ID` AND t.`lg_TYPE_REGLEMENT_ID`=tr.`lg_TYPE_REGLEMENT_ID` AND DATE(o.`dt_CREATED`) >='" + dt_date_debut + "' AND DATE(o.`dt_CREATED`) <='" + dt_date_fin + "' AND o.bool_CHECKED = true AND o.str_STATUT = '" + commonparameter.statut_enable + "'  GROUP BY tm.`lg_TYPE_MVT_CAISSE_ID`, `tr`.`lg_TYPE_REGLEMENT_ID` ORDER BY tr.`str_DESCRIPTION` ,tm.`str_NAME`";
            new logger().OCategory.info("qry -- " + qry);
            Ojconnexion.set_Request(qry);
            ResultSetMetaData rsmddatas = Ojconnexion.get_resultat().getMetaData();
            while (Ojconnexion.get_resultat().next()) {
    ...
    public void lunchPrinterForTicketCaisse(String dt_Date_Debut, String dt_Date_Fin, String h_debut, String h_fin, String str_TASK, String fileBarecode) {
    ...
    public List<EntityData> generateDataForTicketZ(String dt_Date_Debut,
            String dt_Date_Fin,
            String h_debut, String h_fin,
            String str_TASK) {
        ...
        Date today = new Date();
        try {
            String criteria = ("%%".equals(str_TASK) ? " t.str_TASK <> '" + Parameter.KEY_TASK_ANNULE_VENTE + "' " : "t.str_TASK = '" + str_TASK + "'");
            ...
            String qry = "SELECT t.str_TASK, COUNT(t.int_AMOUNT)"
                    + "AS nbre, SUM(t.int_AMOUNT) AS "
                    + "TOTAL, t.lg_USER_ID, t.str_NAME_TYE_REGLEMENT, t.str_FIRST_LAST_NAME,"
                    + "(SELECT SUM(tt.int_PRICE) "
                    + "FROM t_preenregistrement_compte_client_tiers_payent tt,"
                    + "t_preenregistrement p "
                    + "WHERE tt.lg_PREENREGISTREMENT_ID = p.lg_PREENREGISTREMENT_ID "
                    + "AND p.lg_USER_ID = t.lg_USER_ID "
                    + "AND p.str_STATUT = '" + commonparameter.statut_is_Closed + "' "
                    + "AND (DATE(tt.dt_CREATED) >= '" + dt_Date_Debut + "' "
                    + "AND  DATE(tt.dt_CREATED) <= '" + dt_Date_Fin + "') "
                    + "AND (TIME(tt.dt_CREATED) >= '" + h_debut + "' "
                    + "AND  TIME(tt.dt_CREATED) <= '" + h_fin + "') "
                    ...
                    + "AS int_NUMBER "
                    + "FROM v_caisse t "
                    + "WHERE (DATE(t.dt_CREATED) >= '" + dt_Date_Debut + "' "
                    + "AND DATE(t.dt_CREATED) <= '" + dt_Date_Fin + "') "
                    + "AND (TIME(t.dt_CREATED) >= '" + h_debut + "' "
                    + "AND TIME(t.dt_CREATED) <= '" + h_fin + "') "
                    + "AND ( " + criteria + "  AND t.ETAT_VENTE = 0  ) "
            ...
            while (Ojconnexion1.get_resultat().next()) {
                ...
                OEntityData.setStr_value5((Ojconnexion1.get_resultat().getString("int_AMOUNT_AUTRE") != null) ? Ojconnexion1.get_resultat().getString("int_AMOUNT_AUTRE") : "0");
                ...
                OEntityData.setStr_value8((Ojconnexion1.get_resultat().getString("int_NUMBER") != null) ? Ojconnexion1.get_resultat().getString("int_NUMBER") : "0");
            ...
            if (lstEntityData.size() > 0) {
                for (EntityData OEntityData : lstEntityData) {
                    if (lstString.isEmpty()) {
                        ...
                        lstData.add(int_NUMBER + ";" + str_NAME_TYE_REGLEMENT + ": ;" + conversion.AmountFormat(int_AMOUNT, '.') + "; F CFA;0;1");
                        ...
                        if (lstString.get(0).equalsIgnoreCase(OEntityData.getStr_value3())) {
                            ...
                            new logger().OCategory.info("Total user précédent " + str_FIRST_LAST_NAME + "----" + int_TOTAL + "****" + int_GLOBAL);
                            lstData.add(int_NUMBER_OTHER + ";AUTRES: ;" + conversion.AmountFormat(int_OTHER, '.') + "; F CFA;0;1");
                            lstData.add("TOTAL " + str_FIRST_LAST_NAME + ": ; ;" + conversion.AmountFormat(int_TOTAL, '.') + "; F CFA;1;1");
                            lstData.add(" ; ; ; ; ; ;");
                            lstString.clear();
                            int_TOTAL = 0;
                            lstString.add(OEntityData.getStr_value3());
                ...
                new logger().OCategory.info("Dernier user:" + str_FIRST_LAST_NAME + "----" + int_TOTAL + "****" + int_GLOBAL);
                lstData.add(int_NUMBER_OTHER + ";AUTRES: ;" + conversion.AmountFormat(int_OTHER, '.') + "; F CFA;0;1");
                lstData.add("TOTAL " + str_FIRST_LAST_NAME + ": ; ;" + conversion.AmountFormat(int_TOTAL, '.') + "; F CFA;1;1");
                lstData.add(" ; ; ; ; ; ;");
    ...
    /*public double getTotalBon(List<EntityData> lstEntityData) {// 20/11/2016
     double result = 0.0;
     try {
     for (EntityData OEntityData : lstEntityData) {
     result += Integer.parseInt(OEntityData.getStr_value12());
     }
     } catch (Exception e) {
     }
     return result;
     }*/
    public double getTotalBon(String search_value, String dt_Date_Debut, String dt_Date_Fin, String h_debut, String h_fin, String lg_TIERS_PAYANT_ID) {
        double result = 0.0;
        List<Object[]> lstEntityData = new ArrayList<Object[]>();
        privilege Oprivilege = new privilege(this.getOdataManager(), this.getOTUser());
        String lg_USER_ID = this.getOTUser().getLgUSERID(), lg_EMPLACEMENT_ID = this.getOTUser().getLgEMPLACEMENTID().getLgEMPLACEMENTID();
        try {
            if (Oprivilege.isColonneStockMachineIsAuthorize(commonparameter.str_SHOW_VENTE)) {
                lg_USER_ID = "%%";
            }
            ...
            String qry = "SELECT * FROM v_facture_subrogatoire v WHERE v.int_PRICE > 0 AND v.b_IS_CANCEL = false AND v.lg_EMPLACEMENT_ID LIKE '" + lg_EMPLACEMENT_ID + "' AND (v.dt_UPDATED >= '" + dt_Date_Debut + " " + h_debut + "' AND v.dt_UPDATED <= '" + dt_Date_Fin + " " + h_fin + "') AND (v.str_FIRST_NAME_CUSTOMER LIKE '" + search_value + "%' OR v.str_LAST_NAME_CUSTOMER LIKE '" + search_value + "%' OR v.str_FIRST_LAST_NAME LIKE '" + search_value + "%' OR v.str_REF_BON LIKE '" + search_value + "%' OR v.str_REF LIKE '" + search_value + "%' OR v.str_REF_TICKET LIKE '" + search_value + "%') AND v.lg_USER_ID LIKE '" + lg_USER_ID + "' AND v.lg_TIERS_PAYANT_ID LIKE '" + lg_TIERS_PAYANT_ID + "' GROUP BY v.lg_PREENREGISTREMENT_ID ORDER BY v.str_TYPE_TIERS_PAYANT, v.str_NAME, v.dt_UPDATED ASC";
            lstEntityData = this.getOdataManager().getEm().createNativeQuery(qry).getResultList();
    ...
    /*public int getTotalNbreBon(List<EntityData> lstEntityData) { //a decommenter en cas de probleme 20/11/2016
     int result = 0;
     List<String> data = new ArrayList<String>();
     try {
     for (EntityData OEntityData : lstEntityData) {
     if (data.size() == 0) {
     data.add(OEntityData.getStr_value14());
     result++;
     } else {
     if (!data.get(0).equalsIgnoreCase(OEntityData.getStr_value14())) {
     data.clear();
     result++;
     data.add(OEntityData.getStr_value14());
     }
    ...
    public List<EntityData> getListeVenteInDepotForBalanceVenteCaisse(String dt_date_debut, String dt_date_fin, String lg_TYPE_REGLEMENT_ID, String lg_EMPLACEMENT_ID) {
        ...
        try {
            ...
            String qry = "SELECT * FROM v_caisse t WHERE DATE(t.dt_CREATED) >= '" + dt_date_debut + "' AND DATE(t.dt_CREATED) <= '" + dt_date_fin + "' AND t.lg_TYPE_REGLEMENT_ID LIKE '" + lg_TYPE_REGLEMENT_ID + "' AND t.lg_EMPLACEMENT_ID NOT LIKE '" + commonparameter.PROCESS_SUCCESS + "' AND t.lg_EMPLACEMENT_ID LIKE '" + lg_EMPLACEMENT_ID + "' AND (t.str_TASK LIKE '" + Parameter.KEY_TASK_VENTE + "' OR t.str_TASK LIKE '" + Parameter.KEY_TASK_ANNULE_VENTE + "') GROUP BY str_RESSOURCE_REF ORDER BY t.dt_CREATED ASC";
            new logger().OCategory.info(qry);
            Ojconnexion1.set_Request(qry);
            ResultSetMetaData rsmddatas = Ojconnexion1.get_resultat().getMetaData();
            while (Ojconnexion1.get_resultat().next()) {
    ...
    public Double getTotalAmountVenteInDepotForBalanceVenteCaisse(List<EntityData> lstEntityDatas, String lg_TYPE_REGLEMENT_ID) {
        Double result = 0.0;
    ...
    public TBilletageDetails getTBilletageDetails(String lg_CAISSE_ID) {
        ...
        try {
            OTBilletageDetails = (TBilletageDetails) this.getOdataManager().getEm().createQuery("SELECT t FROM TBilletageDetails t WHERE t.lgBILLETAGEID.ldCAISSEID = ?1").setParameter(1, lg_CAISSE_ID).getSingleResult();
        } catch (Exception e) {
        }
    ...
    public List<String> generateData(TBilletageDetails OTBilletageDetails) {
        ...
        try {
            ...
            datas.add("Opérateur: ;" + OTBilletageDetails.getLgBILLETAGEID().getLgUSERID().getStrFIRSTNAME() + " " + OTBilletageDetails.getLgBILLETAGEID().getLgUSERID().getStrLASTNAME() + "; ");
            datas.add(" ; ; ");
            datas.add("TOTAL ;" + conversion.AmountFormat(OTBilletageDetails.getLgBILLETAGEID().getIntAMOUNT().intValue()) + "; F CFA");
        } catch (Exception e) {
        }
    ...
    public long getMVTAmountByTypeMVT(String lg_TYPE_MVT_CAISSE_ID, String dt_start, String dt_end, String emplacement) {
        long Amount = 0;
        ...
        try {
            ...
            /* String query = "SELECT  SUM(`t_mvt_caisse`.`int_AMOUNT`) AS `MONTANT` FROM `t_mvt_caisse`  INNER JOIN `t_type_mvt_caisse` ON (`t_mvt_caisse`.`lg_TYPE_MVT_CAISSE_ID` = `t_type_mvt_caisse`.`lg_TYPE_MVT_CAISSE_ID`) ";
             query += " WHERE `t_type_mvt_caisse`.`lg_TYPE_MVT_CAISSE_ID` = '" + lg_TYPE_MVT_CAISSE_ID + "' AND ";
             query += " DATE( `t_mvt_caisse`.`dt_CREATED`) >=DATE('" + dt_start + "') AND  DATE( `t_mvt_caisse`.`dt_CREATED`) <=DATE('" + dt_end + "')";
             */
            String query = "SELECT sum(`o`.`int_AMOUNT`) AS `AMOUNT`  FROM t_mvt_caisse o,t_type_mvt_caisse tm,t_mode_reglement t,t_type_reglement tr, t_user u WHERE u.lg_USER_ID = o.lg_USER_ID AND u.lg_EMPLACEMENT_ID LIKE  '" + emplacement + "' AND `o`.`lg_TYPE_MVT_CAISSE_ID` = '" + lg_TYPE_MVT_CAISSE_ID + "' AND  o.`lg_TYPE_MVT_CAISSE_ID`=tm.`lg_TYPE_MVT_CAISSE_ID` AND o.`lg_MODE_REGLEMENT_ID`=t.`lg_MODE_REGLEMENT_ID` AND t.`lg_TYPE_REGLEMENT_ID`=tr.`lg_TYPE_REGLEMENT_ID` AND DATE(o.`dt_CREATED`) >=DATE('" + dt_start + "')  AND DATE(o.`dt_CREATED`) <=DATE('" + dt_end + "')  AND o.bool_CHECKED = true AND o.str_STATUT = '" + commonparameter.statut_enable + "'    GROUP BY tm.`lg_TYPE_MVT_CAISSE_ID`";
...
//            e.printStackTrace();
    ...
    public Object[] getDataForMarge(String dt_BEGIN, String dt_END) {
        try {
            Object[] O = (Object[]) this.getOdataManager().getEm().createNativeQuery("call proc_calcul_marge('" + dt_BEGIN + "','" + dt_END + "')").getSingleResult();
            return O;
        } catch (Exception e) {
            return null;
        }
    ...
    public JSONObject getVenteAnnuler(String dt_start, String dt_end) {
        ...
        try {
            ...
            List<TPreenregistrement> list = em.createQuery("SELECT  o FROM TPreenregistrement o WHERE  FUNCTION('DATE', o.dtANNULER) >=?1 AND   FUNCTION('DATE', o.dtANNULER) <=?2  AND o.lgTYPEVENTEID.lgTYPEVENTEID <> '5' AND o.lgTYPEVENTEID.lgTYPEVENTEID <> '4' AND o.bISCANCEL=TRUE AND  FUNCTION('DATE',o.dtANNULER)>FUNCTION('DATE',o.dtUPDATED)  ")
            ...
            for (TPreenregistrement op : list) {
                ...
                TCashTransaction cs = (TCashTransaction) em.createQuery("SELECT o FROM TCashTransaction o WHERE o.strRESSOURCEREF=?1 AND o.intAMOUNTDEBIT =0 ")
    ...
    public JSONObject getVenteAnnuler2(String dt_start, String dt_end, String typevente) {
        ...
        try {
            EntityManager em = this.getOdataManager().getEm();
            List<TPreenregistrement> list = em.createQuery("SELECT  o FROM TPreenregistrement o WHERE  FUNCTION('DATE', o.dtANNULER) >=?1 AND   FUNCTION('DATE', o.dtANNULER) <=?2  AND o.lgTYPEVENTEID.lgTYPEVENTEID <> '5' AND o.lgTYPEVENTEID.lgTYPEVENTEID <> '4' AND o.bISCANCEL=TRUE AND  FUNCTION('DATE',o.dtANNULER)> FUNCTION('DATE',o.dtUPDATED) AND o.strTYPEVENTE=?3 ")
                    .setParameter(1, java.sql.Date.valueOf(dt_start)).setParameter(2, java.sql.Date.valueOf(dt_end))
            ...
            json.putOpt("montant", montant).putOpt("montantES", montantES)
                    ...
                    .put("cb", cb).put("differe", dif).put("cheques", cheques);
        } catch (Exception e) {
            e.printStackTrace();
        }
        return json;
    ...
    public JSONArray getTicketZData(String dt_start, String lgEmp) {
        ...
        try {
            ...
            Predicate btw = cb.equal(cb.function("DATE", Date.class, root.get(TPreenregistrement_.dtUPDATED)), java.sql.Date.valueOf(dt_start));
            cq.multiselect(cb.sum(root.get(TPreenregistrement_.intPRICE)), cb.sum(root.get(TPreenregistrement_.intPRICEREMISE)), cb.sum(cb.diff(root.get(TPreenregistrement_.intPRICE), root.get(TPreenregistrement_.intPRICEREMISE))), root.get(TPreenregistrement_.strTYPEVENTE),
                    ...
                    .when(cb.equal(root.get(TPreenregistrement_.strTYPEVENTE), "VO"),
                            cb.sum(cb.diff(root.get(TPreenregistrement_.intPRICE), root.get(TPreenregistrement_.intCUSTPART)))).otherwise(0), pu.get(TUser_.lgUSERID), pu.get(TUser_.strFIRSTNAME),
                    pu.get(TUser_.strLASTNAME))
                    .groupBy(root.get(TPreenregistrement_.strTYPEVENTE), pu.get(TUser_.lgUSERID)).orderBy(cb.desc(root.get(TPreenregistrement_.strTYPEVENTE)));
...
//              return t[9].toString().substring(0, 1)+"."+t[10];
            ...
            totaux.put("NB", nb).put("GLOBALESP", totalEs).put("GLOBALCB", totalcb)
                    .put("GLOBALCQ", totalcq).put("GLOBAL", Gbl);
    ...
    public List<String> generateTicketZForPrintMVT(JSONArray lstEntityData) {
        ...
        Integer int_AMOUNTES = 0, int_TOTALENTREECB = 0, int_TOTALENTREECH = 0, int_TOTALENTREEVIR = 0,
                int_TOTALREGLCB = 0, int_TOTALREGLCH = 0, int_TOTALREGLVIR = 0,
                int_TOTALSORTIECB = 0, int_TOTALSORTIECH = 0, int_TOTALSORTIEVIR = 0, TOTALVO = 0;

        try {

            if (lstEntityData.length() > 0) {
                for (int i = 0; i < lstEntityData.length() - 1; i++) {
                    Integer TOTAUSER = 0, TOTAL_CHEQUE = 0, TOTAL_CARTEBANCAIRE = 0, totalRegl = 0, totalSortie = 0, totalEntree = 0;
                    ...
                    if (userOb.optInt("TOTAL_ESPECE") > 0) {
                        ...
                        lstData.add("Espèce(vno/vo):" + ";" + Util.getFormattedIntegerValue(Integer.valueOf(userOb.opt("TOTAL_ESPECE") + "")) + "; F CFA;;0;1");
                    }
                    if (userOb.optInt("PART_TIERSPAYANT") > 0) {
                        TOTALVO += Integer.valueOf(userOb.opt("PART_TIERSPAYANT") + "");
                        lstData.add("Crédit(vo):" + ";" + Util.getFormattedIntegerValue(Integer.valueOf(userOb.opt("PART_TIERSPAYANT") + "")) + "; F CFA;;0;1");
                    }

                    if (userOb.opt("ENTRESP") != null) {
                        TOTAUSER += Integer.valueOf(userOb.opt("ENTRESP") + "");
                        lstData.add("Espèce Entrée:" + ";" + Util.getFormattedIntegerValue(Integer.valueOf(userOb.opt("ENTRESP") + "")) + "; F CFA;;0;1");
                    }
                    if (userOb.opt("SORTIEESP") != null) {
                        TOTAUSER -= Integer.valueOf(userOb.opt("SORTIEESP") + "");
                        lstData.add("Espèce Sortie:" + ";" + Util.getFormattedIntegerValue(Integer.valueOf(userOb.opt("SORTIEESP") + "")) + "; F CFA;;0;1");
                    }
                    if (userOb.opt("REGLTPESP") != null) {
                        TOTAUSER += Integer.valueOf(userOb.opt("REGLTPESP") + "");
                        lstData.add("Espèce Regl:" + ";" + Util.getFormattedIntegerValue(Integer.valueOf(userOb.opt("REGLTPESP") + "")) + "; F CFA;;0;1");
                    }
                    ...
                    if (userOb.opt("TOTAL_CHEQUE") != null) {
                        ...
                        lstData.add("Total Ch (vno/vo): ;" + Util.getFormattedIntegerValue(Integer.valueOf(userOb.opt("TOTAL_CHEQUE") + "")) + ";F CFA;;1;1");
                    }
                    if (userOb.opt("TOTAL_CARTEBANCAIRE") != null) {
                        int_TOTALENTREECB += Integer.valueOf(userOb.opt("TOTAL_CARTEBANCAIRE") + "");
                        lstData.add("Total CB (vno/vo): ;" + Util.getFormattedIntegerValue(Integer.valueOf(userOb.opt("TOTAL_CARTEBANCAIRE") + "")) + ";F CFA;;1;1");
                    }
                    if (userOb.opt("ENTRECH") != null) {
                        int_TOTALENTREECH += Integer.valueOf(userOb.opt("ENTRECH") + "");
                        lstData.add("Entrée Chèque : ;" + Util.getFormattedIntegerValue(Integer.valueOf(userOb.opt("ENTRECH") + "")) + ";F CFA;;1;1");
                    }
                    if (userOb.opt("ENTRECB") != null) {
                        int_TOTALENTREECB += Integer.valueOf(userOb.opt("ENTRECB") + "");
                        lstData.add("Total entrée CB: ;" + Util.getFormattedIntegerValue(Integer.valueOf(userOb.opt("ENTRECB") + "")) + ";F CFA;;1;1");
                    }
                    if (userOb.opt("ENTREVIR") != null) {
                        int_TOTALENTREEVIR += Integer.valueOf(userOb.opt("ENTREVIR") + "");
                        lstData.add("Total entrée.Vir: ;" + Util.getFormattedIntegerValue(Integer.valueOf(userOb.opt("ENTREVIR") + "")) + ";F CFA;;1;1");
                    }
                    if (userOb.opt("REGLTPCH") != null) {
                        int_TOTALENTREECH += Integer.valueOf(userOb.opt("REGLTPCH") + "");
                        lstData.add("Total Regl Ch: ;" + Util.getFormattedIntegerValue(Integer.valueOf(userOb.opt("REGLTPCH") + "")) + ";F CFA;;1;1");
                    }
                    if (userOb.opt("REGLTPCB") != null) {
                        int_TOTALENTREECB += Integer.valueOf(userOb.opt("REGLTPCB") + "");
                        lstData.add("Total Regl CB: ;" + Util.getFormattedIntegerValue(Integer.valueOf(userOb.opt("REGLTPCB") + "")) + ";F CFA;;1;1");
                    }
                    if (userOb.opt("REGLTPVIR") != null) {
                        int_TOTALENTREEVIR += Integer.valueOf(userOb.opt("REGLTPVIR") + "");
                        lstData.add("Total Regl Vir: ;" + Util.getFormattedIntegerValue(Integer.valueOf(userOb.opt("REGLTPVIR") + "")) + ";F CFA;;1;1");
                    }

                    if (userOb.opt("SORTIECH") != null) {
                        int_TOTALENTREECH -= Integer.valueOf(userOb.opt("REGLTPCH") + "");
                        lstData.add("Total Sortie Ch: ;" + Util.getFormattedIntegerValue(Integer.valueOf(userOb.opt("SORTIECH") + "")) + ";F CFA;;1;1");
                    }
                    if (userOb.opt("SORTIECB") != null) {
                        int_TOTALENTREECB -= Integer.valueOf(userOb.opt("REGLTPCB") + "");
                        lstData.add("Total Sortie CB: ;" + Util.getFormattedIntegerValue(Integer.valueOf(userOb.opt("SORTIECB") + "")) + ";F CFA;;1;1");
                    }
                    if (userOb.opt("SORTIEVIR") != null) {
                        int_TOTALENTREEVIR -= Integer.valueOf(userOb.opt("REGLTPVIR") + "");
                        lstData.add("Total Sortie Vir: ;" + Util.getFormattedIntegerValue(Integer.valueOf(userOb.opt("SORTIEVIR") + "")) + ";F CFA;;1;1");
                    }
                    lstData.add(" ; ; ; ; ; ;");
            ...
            if (int_TOTALENTREECH != 0) {
                lstData.add("TOTAL GENERAL CH: ;" + Util.getFormattedIntegerValue(int_TOTALENTREECH) + "; F CFA; ;1;1;G");
            }
            if (int_TOTALENTREECB != 0) {
                lstData.add("TOTAL GENERAL CB: ; " + Util.getFormattedIntegerValue(int_TOTALENTREECB) + "; F CFA;;1;1;G");
            }
            if (int_TOTALENTREEVIR != 0) {
                lstData.add("TOTAL GENERAL VIR: ; " + Util.getFormattedIntegerValue(int_TOTALENTREEVIR) + "; F CFA;;1;1;G");
            }
    ...
    //impression ticket de caisse
    public void ticketCaisse(String dt_Date_Debut, String dt_Date_Fin, String h_debut, String h_fin, boolean all, String fileBarecode) {
        DriverPrinter ODriverPrinter = new DriverPrinter(this.getOdataManager(), this.getOTUser());
        String title;
        ...
        try {
            ...
            List<String> datas= null;//= this.generateTicketZForPrintMVT(controller.getTicketZDatas(dt_Date_Debut, dt_Date_Fin, "1", all));
            ODriverPrinter.setType_ticket(commonparameter.str_TICKETZ);
