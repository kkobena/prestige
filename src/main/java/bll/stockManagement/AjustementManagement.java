...
public class AjustementManagement extends bllBase {
    ...
    public AjustementManagement(dataManager OdataManager, TUser OTuser, StockManager OStockManager, SnapshotManager OSnapshotManager) {
        this.setOTUser(OTuser);
        this.setOdataManager(OdataManager);
        this.checkDatamanager();
...
//            OTAjustement.setLgUSERID(this.getOTUser());
    ...
    public boolean removeAjustement(String lg_AJUSTEMENT_ID) {
        ...
        try {
            ...
            new logger().OCategory.info("Valeur i : " + i + " lstTAjustementDetail size " + lstTAjustementDetail.size());
    ...
    public List<TAjustement> SearchAllOrOneAjustement(String lg_AJUSTEMENT_ID, String lg_USER_ID, Date dtDEBUT, Date dtFin) {
        ...
        try {
            ...
            lstTAjustement = this.getOdataManager().getEm().createQuery("SELECT t FROM TAjustement t WHERE t.lgAJUSTEMENTID LIKE ?1 AND t.strSTATUT = ?2 AND t.lgUSERID.lgUSERID LIKE ?3 AND t.lgUSERID.lgEMPLACEMENTID.lgEMPLACEMENTID LIKE ?4 AND (t.dtCREATED >= ?5 AND t.dtCREATED <=?6)  ORDER BY t.dtCREATED DESC")
                    .setParameter(1, lg_AJUSTEMENT_ID).setParameter(2, commonparameter.statut_enable).setParameter(3, lg_USER_ID).setParameter(4, lg_EMPLACEMENT_ID).setParameter(5, dtDEBUT).setParameter(6, dtFin).getResultList();
    ...
    public List<TAjustementDetail> SearchAllOrOneAjustementDetail(String search_value, String lg_AJUSTEMENT_ID, String lg_USER_ID, String lg_FAMILLE_ID) {
        ...
        try {
            ...
            lstTAjustementDetail = this.getOdataManager().getEm().createQuery("SELECT t FROM TAjustementDetail t WHERE t.lgAJUSTEMENTID.lgAJUSTEMENTID LIKE ?1 AND t.strSTATUT NOT LIKE ?2 AND t.lgAJUSTEMENTID.lgUSERID.lgUSERID LIKE ?3 AND t.lgAJUSTEMENTID.lgUSERID.lgEMPLACEMENTID.lgEMPLACEMENTID = ?4 AND t.lgFAMILLEID.lgFAMILLEID LIKE ?5 AND (t.lgFAMILLEID.strNAME LIKE ?6 OR t.lgFAMILLEID.intCIP LIKE ?6 OR t.lgFAMILLEID.intEAN13 LIKE ?6) ORDER BY t.lgFAMILLEID.strDESCRIPTION ASC")
                    .setParameter(1, lg_AJUSTEMENT_ID).setParameter(2, commonparameter.statut_delete).setParameter(3, lg_USER_ID).setParameter(4, this.getOTUser().getLgEMPLACEMENTID().getLgEMPLACEMENTID()).setParameter(5, lg_FAMILLE_ID).setParameter(6, search_value + "%").getResultList();
    ...
    public List<TAjustementDetail> SearchAllOrOneAjustementDetail(String search_value, String lg_AJUSTEMENT_ID, String lg_USER_ID, String lg_FAMILLE_ID, int start, int limit) {
        List<TAjustementDetail> lstTAjustementDetail = new ArrayList<>();
        try {
            if (search_value.equalsIgnoreCase("") || search_value == null) {
                search_value = "%%";
            ...
            lstTAjustementDetail = this.getOdataManager().getEm().createQuery("SELECT t FROM TAjustementDetail t WHERE t.lgAJUSTEMENTID.lgAJUSTEMENTID LIKE ?1 AND t.strSTATUT NOT LIKE ?2 AND t.lgAJUSTEMENTID.lgUSERID.lgUSERID LIKE ?3 AND t.lgAJUSTEMENTID.lgUSERID.lgEMPLACEMENTID.lgEMPLACEMENTID = ?4 AND t.lgFAMILLEID.lgFAMILLEID LIKE ?5 AND (t.lgFAMILLEID.strNAME LIKE ?6 OR t.lgFAMILLEID.intCIP LIKE ?6 OR t.lgFAMILLEID.intEAN13 LIKE ?6) ORDER BY t.lgFAMILLEID.strDESCRIPTION ASC")
                    .setParameter(1, lg_AJUSTEMENT_ID).setParameter(2, commonparameter.statut_delete).setParameter(3, lg_USER_ID).setParameter(4, this.getOTUser().getLgEMPLACEMENTID().getLgEMPLACEMENTID()).setParameter(5, lg_FAMILLE_ID).setParameter(6, search_value + "%").setFirstResult(start).setMaxResults(limit).getResultList();
    ...
    public TAjustement getAjustement(String lg_AJUSTEMENT_ID) {
        ...
        try {
            ...
            OTAjustement = (TAjustement) this.getOdataManager().getEm().createQuery("SELECT t FROM TAjustement t WHERE t.lgAJUSTEMENTID = ?1")
    ...
    /*public boolean closureAjustement(String lg_AJUSTEMENT_ID, String str_COMMENTAIRE) { // a decommenter en cas de probleme 10/11/2016
     boolean result = false; 
     List<TAjustementDetail> lstTAjustementDetail = new ArrayList<TAjustementDetail>();
     int i = 0;
     try {
     ...
     lstTAjustementDetail = this.SearchAllOrOneAjustementDetail("", OTAjustement.getLgAJUSTEMENTID(), "%%", "%%");
     for (TAjustementDetail OTAjustementDetail : lstTAjustementDetail) {
     if (this.ClosureAjustementDetail(OTAjustementDetail)) {
     i++;
     }
     }
     new logger().OCategory.info("Valeur i " + i + " lstTAjustementDetail size " + lstTAjustementDetail.size());
     ...
     this.do_event_log(commonparameter.ALL, OTAjustement.getStrNAME(), this.getOTUser().getStrFIRSTNAME() + " " + this.getOTUser().getStrLASTNAME(), commonparameter.statut_enable, "TAjustement", "Ajustement de stock", "");
    ...
    public boolean closureAjustement(String lg_AJUSTEMENT_ID, String str_COMMENTAIRE) {
        ...
        try {
            ...
            for (TAjustementDetail OTAjustementDetail : lstTAjustementDetail) {
                ...
                if (((OTFamilleStock.getIntNUMBERAVAILABLE() + OTAjustementDetail.getIntNUMBER()) <= OTFamilleStock.getLgFAMILLEID().getIntSEUILMIN()) && OTFamilleStock.getLgFAMILLEID().getBoolDECONDITIONNE() == 0) {
            ...
            //Ajout du code de traçage
            this.do_event_log(commonparameter.ALL, OTAjustement.getStrNAME(), this.getOTUser().getStrFIRSTNAME() + " " + this.getOTUser().getStrLASTNAME(), commonparameter.statut_enable, "TAjustement", "Ajustement de stock", "Ajustement", this.getOTUser().getLgUSERID());
            //fin du code de traçage
            this.buildSuccesTraceMessage(this.getOTranslate().getValue("SUCCES"));
            result = true;
    ...
    /*public boolean ClosureAjustementDetail(TAjustementDetail OTAjustementDetail) { // a decommenter en cas de probleme 10/11/2016
     boolean result = false;

     try {
     OTAjustementDetail.setDtUPDATED(new Date());
     OTAjustementDetail.setStrSTATUT(commonparameter.statut_enable);
     OTAjustementDetail.setIntNUMBERAFTERSTOCK(OTAjustementDetail.getIntNUMBERCURRENTSTOCK() + OTAjustementDetail.getIntNUMBER());
     this.persiste(OTAjustementDetail);
     result = new StockManager(this.getOdataManager(), this.getOTUser()).UpdateStockByAjustement(OTAjustementDetail.getLgFAMILLEID(), OTAjustementDetail.getIntNUMBER());
     if (result) {
     TFamilleStock OTProductItemStock = new tellerManagement(this.getOdataManager(), this.getOTUser()).getTProductItemStock(OTAjustementDetail.getLgFAMILLEID());
    ...
    public TFamilleStock ClosureAjustementDetail(TAjustementDetail OTAjustementDetail) {
        ...
        try {
            ...
            OTProductItemStock = this.UpdateStockByAjustement(OTAjustementDetail.getLgFAMILLEID(), OTAjustementDetail.getIntNUMBER());
            this.buildSuccesTraceMessage(this.getOTranslate().getValue("SUCCES"));
...
//            }
            OTFamilleStock = new tellerManagement(this.getOdataManager(), this.getOTUser()).getTProductItemStock(OTFamille.getLgFAMILLEID(), this.getOTUser().getLgEMPLACEMENTID().getLgEMPLACEMENTID());
            ...
            if (OSnapshotManager.createSnapshotMouvementArticleAjustement(OTFamille, int_NUMBER, int_NUMBER_STOCK_DEBUT, commonparameter.str_ACTION_AJUSTEMENT, this.getOTUser().getLgEMPLACEMENTID()) != null) {
    ...
    public TAjustementDetail getAjustementDetail(String lg_AJUSTEMENT_ID, String lg_FAMILLE_ID) {
        ...
        try {
            OTAjustementDetail = (TAjustementDetail) this.getOdataManager().getEm().createQuery("SELECT t FROM TAjustementDetail t WHERE t.lgAJUSTEMENTID.lgAJUSTEMENTID = ?1 AND t.lgFAMILLEID.lgFAMILLEID = ?2 AND t.strSTATUT <> ?3")
    ...
    public TAjustementDetail getAjustementDetail(String lg_AJUSTEMENTDETAIL_ID) {
        TAjustementDetail OTAjustementDetail = null;
        try {
            OTAjustementDetail = (TAjustementDetail) this.getOdataManager().getEm().createQuery("SELECT t FROM TAjustementDetail t WHERE t.lgAJUSTEMENTDETAILID = ?1")
    ...
    public TAjustementDetail createOrUpdateAjustementDetail(String lg_AJUSTEMENT_ID, String lg_FAMILLE_ID, int int_NUMBER) {
        TAjustementDetail OTAjustementDetail = null;
        try {
...
//            this.getOdataManager().getEm().close();
    ...
    public TAjustementDetail createAjustementDetail(TAjustement OTAjustement, TFamille OTFamille, int int_NUMBER, TFamilleStock familleStock) {
        TAjustementDetail OTAjustementDetail = null;
    ...
    public TFamilleStock getFamilleStock(String lg_FAMILLE_ID) {
        ...
        try {
            f = this.getOdataManager().getEm().createQuery("SELECT o FROM TFamilleStock o WHERE o.lgFAMILLEID.lgFAMILLEID=?1 AND o.lgEMPLACEMENTID.lgEMPLACEMENTID=?2 ", TFamilleStock.class)
