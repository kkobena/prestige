...
public class StockImpl implements Stock {
    ...
    public List<TOrderDetail> getOrderItemByOrderId(String lg_ORDER_ID) throws Exception {
        TypedQuery<TOrderDetail> query = em.createQuery("SELECT o FROM TOrderDetail o WHERE o.lgORDERID.lgORDERID =?1", TOrderDetail.class);
    ...
    public List<TBonLivraisonDetail> getBonItemByBonId(String lg_BONLIVRAISON_ID) throws Exception {
        TypedQuery<TBonLivraisonDetail> query = em.createQuery("SELECT o FROM TBonLivraisonDetail o WHERE o.lgBONLIVRAISONID.lgBONLIVRAISONID =?1", TBonLivraisonDetail.class);
