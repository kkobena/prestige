...
/**
 * This service provides a set of procedures and functions to perfrom a promotion
 * The Concrete services must keep track of the eligible products for promotions
 * @author JZAGO
 */
...
//   List<TPromotionHasTFamille> getPromotionProducts(final Integer promotionID, String search_value);
    ...
    */
   boolean promoteProductWithDiscount(String productID, int promotionID, int discount, boolean mode, double price) throws Exception;
    ...
    * @return 
     * @throws java.lang.Exception 
    */
   boolean promoteProductWithPackNumber(String productID, int promotionID, int activeAT, int packNumber) throws Exception;
