...
public class FamilleArticleRessource {
    ...
    @GET
    public Response statistiqueFamilleArticles(
    ...
    public Response vingtQuatreVingt(
            @QueryParam(value = "dtStart") String dtStart,
            @QueryParam(value = "dtEnd") String dtEnd,
            @QueryParam(value = "codeFamillle") String codeFamillle,
            @QueryParam(value = "qtyOrCa") boolean qtyOrCa,
            @QueryParam(value = "codeRayon") String codeRayon,
            @QueryParam(value = "codeGrossiste") String codeGrossiste
    ) throws JSONException {
        HttpSession hs = servletRequest.getSession();
    ...
    public Response suggestionvingtQuatreVingt(
            @QueryParam(value = "dtStart") String dtStart,
            @QueryParam(value = "dtEnd") String dtEnd,
            @QueryParam(value = "codeFamillle") String codeFamillle,
            @QueryParam(value = "qtyOrCa") boolean qtyOrCa,
    ...
    public Response statistiqueParGrossistes(
            @QueryParam(value = "dtStart") String dtStart,
            @QueryParam(value = "dtEnd") String dtEnd,
            @QueryParam(value = "codeFamillle") String codeFamillle,
            @QueryParam(value = "query") String query,
    ...
    public Response statistiqueParRayons(
            @QueryParam(value = "dtStart") String dtStart,
            @QueryParam(value = "dtEnd") String dtEnd,
            @QueryParam(value = "codeFamillle") String codeFamillle,
            @QueryParam(value = "query") String query,
