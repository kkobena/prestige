...
@WebServlet(
    name = "ExcelExporter",
    urlPatterns = {"/ExcelExporter"})
public class ExcelExporter extends HttpServlet {

  private static final long serialVersionUID = 1L;
  @EJB private BalanceService balanceService;
  @EJB CaisseService caisseService;
  @EJB ReportUtil reportUtil;
  ...
  private String tableauBordPharmation(
      Params parasm, boolean ratio, boolean monthly, boolean showAll) {
    ...
    reportUtil.buildReportExcelSinglePage(
        parameters, scr_report_file, jdom.scr_report_file, finalFilePath, datas);
